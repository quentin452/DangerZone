...
public class RenderDungeonBeast extends RenderLiving {
    ...
    public void renderDungeonBeast(final DungeonBeast par1EntityDungeonBeast, final double par2, final double par4,
    ...
    protected void preRenderScale(final DungeonBeast par1Entity, final float par2) {
