...
public class MyLeviathan extends EntityMob {
    ...
    public MyLeviathan(final World par1World) {
        super(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        return !(par1EntityLiving instanceof MyLeviathan) && !(par1EntityLiving instanceof EntityZombie)
