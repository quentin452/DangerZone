...
import danger.orespawn.entities.entityinstance.CreepingHorror;
import danger.orespawn.entities.model.ModelCreepingHorror;
...
public class RenderCreepingHorror extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "CreepingHorror.png");
    }
}
