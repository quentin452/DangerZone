...
public class PitchBlack extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
            .setBaseValue((this.getPitchBlackScale() * 30));
    }
    ...
    protected void entityInit() {
        ...
        if (this.worldObj != null) {
            ...
            if (rand.nextInt(32) == 3) {
                t = 3.0f;
            }
            if (rand.nextInt(64) == 4) {
                t = 4.0f;
            }
        }
        if (DangerZone.NightmareSize == 1) {
            t = 0.5f;
        }
        if (DangerZone.NightmareSize == 2) {
            t = 1.0f;
        }
        if (DangerZone.NightmareSize == 3) {
            t = 2.0f;
        }
        if (DangerZone.NightmareSize == 4) {
            t = 3.0f;
        }
        if (DangerZone.NightmareSize == 5) {
            t = 4.0f;
        }
    ...
    public int getTotalArmorValue() {
        return 10 + (int) (2.0f * this.getPitchBlackScale());
    }
    ...
    public int mygetMaxHealth() {
        return (int) (250 * this.getPitchBlackScale());
    }
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityDragon) {
            ...
            if (this.worldObj.rand.nextInt(8) == 1) {
                dr.attackEntityFromPart(
                    dr.dragonPartHead,
                    var5,
                    30 * this.getPitchBlackScale());
            } else {
                dr.attackEntityFromPart(
                    dr.dragonPartBody,
                    var5,
            ...
            var4 = par1Entity.attackEntityFrom(
        ...
        if (this.rand.nextInt(150) == 0
            ...
            for (Block bid = Blocks.stone; bid != Blocks.air && keep_trying > 0; --keep_trying) {
                ...
                this.currentFlightTarget
                    .set((int) this.posX + xdir, (int) this.posY + this.rand.nextInt(11) - 5, (int) this.posZ + zdir);
    ...
    public boolean getCanSpawnHere() {
        ...
        if (this.worldObj.provider.dimensionId == DimensionInitDangerZone.ChaosDimensionId) {
            PitchBlack target = null;
            target = (PitchBlack) this.worldObj
                .findNearestEntityWithinAABB(PitchBlack.class, this.boundingBox.expand(16.0, 16.0, 16.0), this);
            if (target != null) {
                return false;
            }
        }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof CreepingHorrorInstance) {
            return false;
        }
    ...
    private Entity findSomethingToAttack() {
        ...
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(d1, d2, d1));
    ...
    protected Item getDropItem() {
        return ItemInitDangerZone.NightmareScale;
    }
    ...
    private ItemStack dropItemRand(final Item index, final int par1) {
        ...
        var3 = new EntityItem(
            this.worldObj,
            this.posX + rand.nextInt(5) * this.getPitchBlackScale() - rand.nextInt(5) * this.getPitchBlackScale(),
            this.posY + 1.0,
            this.posZ + rand.nextInt(5) * this.getPitchBlackScale() - rand.nextInt(5) * this.getPitchBlackScale(),
            is);
        if (var3 != null) {
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        for (int i = 3 + this.worldObj.rand.nextInt(2 + (int) (5.0f * this.getPitchBlackScale())), var4 = 0; var4
            < i; ++var4) {
        ...
        this.dropItemRand(ItemInitDangerZone.NightmareScale, 1);
        this.dropItemRand(Items.item_frame, 1);
        for (int i = 2 + (int) this.getPitchBlackScale()
            + this.worldObj.rand.nextInt(2 + (int) (5.0f * this.getPitchBlackScale())), var4 = 0; var4 < i; ++var4) {
            this.dropItemRand(ItemInitDangerZone.TheZooKeeper, 1);
        }
    }
}
