...
public class Nastysaurus extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
            .setBaseValue(OreSpawnMain.Nastysaurus_stats.attack);
    }
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (Nastysaurus) this.worldObj
            .findNearestEntityWithinAABB(Nastysaurus.class, this.boundingBox.expand(16.0, 8.0, 16.0), this);
        return target == null;
    }
}
