...
public class ChunkProviderOreSpawn5 implements IChunkProvider {
    ...
    public ChunkProviderOreSpawn5(final World par1World, final long par2, final boolean par4) {
            ...
            for (int iy = 0; iy <= length; ++iy) {
                for (int ix = 0; ix <= width; ++ix) {
                    for (int iz = 0; iz <= width; ++iz) {
                        OreSpawnMain.setBlockIDWithMetadataInChunk(
                            chunk,
                            (int) (rx + ix),
                            (int) ry,
                            (int) (rz + iz),
                            OreSpawnMain.CrystalCrystal,
                            0);
                    }
                }
                ry += dy;
    ...
    public void addCrystalTrees(final World world, final Random random, final int chunkX, final int chunkZ,
        ...
        for (int i = 0; i < howmany; ++i) {
            ...
            int posY = 128;
            while (posY > 40) {
                if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY, posZ) == Blocks.air
                    && OreSpawnMain.getBlockIDInChunk(chunk, posX, posY - 1, posZ) == OreSpawnMain.CrystalGrass) {
                    if (what == 0) {
    ...
    public void ScragglyCrystalTreeWithBranches(final World world, int x, int y, int z, final Chunk chunk) {
        ...
        for (int k = 0; k < i; ++k) {
            ...
            if (k >= 1 && bid != Blocks.air
                && bid != OreSpawnMain.MyCrystalTreeLog
                && bid != OreSpawnMain.MyCrystalLeaves2) {
                return;
            }
    ...
    public void TallCrystalTree(final World world, final int x, int y, final int z, final Chunk chunk) {
        ...
        for (int k = 0; k < i; ++k) {
            ...
            if (k >= 1 && bid != Blocks.air
                && bid != OreSpawnMain.MyCrystalTreeLog
                && bid != OreSpawnMain.MyCrystalLeaves) {
                return;
            }
            OreSpawnMain.setBlockIDWithMetadataInChunk(chunk, x, y + k, z, OreSpawnMain.MyCrystalTreeLog, 0);
        }
        ...
        for (int m = -1; m < 2; ++m) {
            for (int n = -1; n < 2; ++n) {
                if (world.rand.nextInt(2) == 1) {
                    ...
                    if (bid == Blocks.air) {
                        OreSpawnMain
                            .setBlockIDWithMetadataInChunk(chunk, x + m, y, z + n, OreSpawnMain.MyCrystalTreeLog, 0);
                    }
                }
            }
        }
                ...
                if (OreSpawnMain.getBlockIDInChunk(chunk, posX, posY, posZ) == Blocks.air
                    ...
                    if (what == 0) {
                        OreSpawnMain.setBlockIDWithMetadataInChunk(
                            ...
                            posY,
                            posZ,
                            OreSpawnMain.CrystalFlowerRedBlock,
                            0);
                        break;
                    }
                    if (what == 1) {
                        OreSpawnMain.setBlockIDWithMetadataInChunk(
                            ...
                            posY,
                            posZ,
                            OreSpawnMain.CrystalFlowerGreenBlock,
                            0);
                        break;
                    }
                    if (what == 2) {
                        OreSpawnMain.setBlockIDWithMetadataInChunk(
                            ...
                            posY,
                            posZ,
                            OreSpawnMain.CrystalFlowerBlueBlock,
                            0);
                        break;
                    }
                    if (what == 3) {
                        OreSpawnMain.setBlockIDWithMetadataInChunk(
                            ...
                            posY,
                            posZ,
                            OreSpawnMain.CrystalFlowerYellowBlock,
                            0);
                        break;
                    }
                    break;
