...
public class EntityBoneDragon extends DecoyOverworldDragonTameable
{
    ...
    public EntityBoneDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    protected String getLivingSound() {
        return this.isAngry() ? "mob.skeleton.say" : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f) ? "mob.skeleton.say" : "mob.skeleton.say") : "mob.skeleton.say");
    }
    ...
    public EntityBoneDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityBoneDragon entitybirchdragon = new EntityBoneDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityBoneDragon)) {
            return false;
        }
        final EntityBoneDragon entitybirchdragon = (EntityBoneDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityBoneDragon) {
                final EntityBoneDragon entitybirchdragon = (EntityBoneDragon)p_142018_1_;
