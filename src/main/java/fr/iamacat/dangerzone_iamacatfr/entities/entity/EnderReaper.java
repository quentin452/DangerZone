...
public class EnderReaper extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth)
            .setBaseValue(OreSpawnMain.EnderReaper_stats.health);
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
            .setBaseValue(0.37);
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
            .setBaseValue(OreSpawnMain.EnderReaper_stats.attack);
    }
    ...
    protected Entity findPlayerToAttack() {
        ...
        final EntityPlayer entityplayer = this.worldObj.getClosestVulnerablePlayerToEntity(this, 81.0);
    ...
    private boolean shouldAttackPlayer(final EntityPlayer par1EntityPlayer) {
        ...
        final Vec3 vec3 = par1EntityPlayer.getLook(1.0f)
            .normalize();
        Vec3 vec4 = Vec3.createVectorHelper(
    ...
    public void onLivingUpdate() {
        ...
        if (this.lastEntityToAttack != this.entityToAttack) {
            ...
            attributeinstance.removeModifier(EnderReaper.attackingSpeedBoostModifier);
            if (this.entityToAttack != null) {
                attributeinstance.applyModifier(EnderReaper.attackingSpeedBoostModifier);
            }
        }
        ...
        if (this.worldObj.isDaytime() && !this.worldObj.isRemote) {
            ...
            if (f > 0.5f && this.worldObj.canBlockSeeTheSky(
                ...
                MathHelper.floor_double(this.posZ)) && this.rand.nextFloat() * 30.0f < (f - 0.4f) * 2.0f) {
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (EnderReaper) this.worldObj
            .findNearestEntityWithinAABB(EnderReaper.class, this.boundingBox.expand(16.0, 8.0, 16.0), this);
        return target == null;
    }
    ...
    static {
        ...
        attackingSpeedBoostModifier = new AttributeModifier(
            EnderReaper.attackingSpeedBoostModifierUUID,
