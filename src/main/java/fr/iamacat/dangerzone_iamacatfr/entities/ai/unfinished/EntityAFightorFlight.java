...
public class EntityAFightorFlight
{
    ...
    public EntityAFightorFlight setEntity(final EntityGenericCreature par1, final World par2, final float par3, final double par4) {
        this.entity = par1;
        this.worldObj = par2;
    ...
    public EntityAFightorFlight setEntity(final EntityGenericCreature par1, final World par2, final float par3, final double par4, final boolean shouldHop) {
        this.entity = par1;
        this.worldObj = par2;
        this.aggroLevel = par3;
        this.aggroRange = par4;
    ...
    public void updateEntityAFF(final World worldobj, final ArrayList<Item> temptItem) {
        ...
        if (this.entityplayer != null && !temptItem.isEmpty()) {
            ...
            for (int i = 0; i < temptItem.size(); ++i) {
                if (var1 != null && temptItem.get(i) != null && temptItem.get(i).equals(var1.getItem())) {
