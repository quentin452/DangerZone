...
public class EntityAIMoveThroughVillage extends EntityAIBase
{
    ...
    public EntityAIMoveThroughVillage(final EntityGenericCreature p_i1638_1_, final double p_i1638_2_, final boolean p_i1638_4_) {
    ...
    public boolean shouldExecute() {
        ...
        final Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockTowards(this.theEntity, 10, 7, Vec3.createVectorHelper((double)this.doorInfo.posX, (double)this.doorInfo.posY, (double)this.doorInfo.posZ));
        if (vec3 == null) {
            return false;
        }
        this.theEntity.getNavigator().setBreakDoors(false);
    ...
    public boolean continueExecuting() {
        ...
        return this.theEntity.getDistanceSq((double)this.doorInfo.posX, (double)this.doorInfo.posY, (double)this.doorInfo.posZ) > f * f;
    }
    ...
    public void resetTask() {
        if (this.theEntity.getNavigator().noPath() || this.theEntity.getDistanceSq(this.doorInfo.posX, this.doorInfo.posY, (double)this.doorInfo.posZ) < 16.0) {
    ...
    private boolean func_75413_a(final VillageDoorInfo p_75413_1_) {
        for (final VillageDoorInfo villagedoorinfo1 : this.doorList) {
            if (p_75413_1_.posX == villagedoorinfo1.posX && p_75413_1_.posY == villagedoorinfo1.posY && p_75413_1_.posZ == villagedoorinfo1.posZ) {
                return true;
            }
        }
        return false;
