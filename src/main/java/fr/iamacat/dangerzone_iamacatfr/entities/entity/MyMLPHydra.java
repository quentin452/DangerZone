...
public class MyMLPHydra extends EntityMob {
    ...
    public MyMLPHydra(final World par1World) {
        super(par1World);
        ...
        if (this.worldObj.rand.nextInt(5 - this.largemob) == 1) {
            ...
            if (e != null) {
                if (!e.isEntityAlive()) {
                    this.setAttackTarget((EntityLivingBase) null);
                    e = null;
                } else if (e instanceof MyMLPHydra) {
                    this.setAttackTarget((EntityLivingBase) null);
                    e = null;
                }
            }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyMLPHydra) {
            return true;
        }
    ...
    public boolean getCanSpawnHere() {
        ...
        MyMLPHydra target = null;
        target = (MyMLPHydra) this.worldObj.findNearestEntityWithinAABB(
            (Class) MyMLPHydra.class,
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            if (s > 45.0f && !(par1Entity instanceof MyMLPHydra)
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (!par1DamageSource.getDamageType()
            ...
            if (e != null && e instanceof EntityLivingBase && !(e instanceof MyMLPHydra)) {
