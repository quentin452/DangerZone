...
import danger.orespawn.entities.entityinstance.Cassowary;
import danger.orespawn.entities.model.ModelCassowary;
...
public class RenderCassowary extends RenderLiving {
    ...
    public void renderCassowary(final Cassowary par1EntityCassowary, final double par2, final double par4,
    ...
    protected void preRenderScale(final Cassowary par1Entity, final float par2) {
    ...
    static {
        texture = new ResourceLocation("orespawn", "Cassowary.png");
    }
}
