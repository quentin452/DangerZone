...
import fr.iamacat.dangerzone_iamacatfr.entities.model.babydragon.ModelAngelDragon;
...
public class RenderAngelDragon extends RenderLiving {
    ...
    public RenderAngelDragon() {
        super((ModelBase) new ModelAngelDragon(), 0.55f);
    }

    public RenderAngelDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderAngelDragon.texture;
    }
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":textures/entity/babydragon/Telephone.png");
    }
}
