...
public class Peacock extends EntityAnimal {
    ...
    protected Item getDropItem() {
        return ItemInitDangerZone.RawPeacock;
    }

    protected void dropFewItems(final boolean par1, final int par2) {
        this.dropItem(ItemInitDangerZone.RawPeacock, 1);
        if (this.worldObj.rand.nextInt(3) == 1) {
            this.dropItem(ItemInitDangerZone.RawPeacock, 1);
        }
        if (this.worldObj.rand.nextInt(2) == 1) {
            this.dropItem(ItemInitDangerZone.PeacockFeather, 1);
        }
    }
    ...
    protected void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(5000) == 1) {
            this.LayAnEgg(Constants.PeacockSpawnEgg, 1 + this.worldObj.rand.nextInt(3));
        }
    }
