...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.Ghost;
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelGhost;
...
public class RenderGhost extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation(Tags.MODID+":Ghosttexture.png");
    }
}
