...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.RainbowCannon;
import fr.iamacat.dangerzone_iamacatfr.util.Tags;

@SideOnly(Side.CLIENT)
public class RenderRainbowCannon extends Render {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        final RainbowCannon r = (RainbowCannon) entity;
        return RenderRainbowCannon.texturerbc;
    }
