...
public class MyEntityAIDance extends EntityAIBase {
    ...
    private GirlfriendInstance thePet;
    World theWorld;
    public int ticker;
    public int dance_move;
    public int is_dancing;

    public MyEntityAIDance(final GirlfriendInstance par1EntityTameable) {
        this.ticker = 0;
        this.dance_move = 0;
        this.is_dancing = 0;
    ...
    public void updateTask() {
        ...
        final AxisAlignedBB bb = AxisAlignedBB.getBoundingBox(
            ...
            this.thePet.posY + 3.0,
            this.thePet.posZ + 4.0);
        final List var5 = this.theWorld.getEntitiesWithinAABB(GirlfriendInstance.class, bb);
        for (final Object obj : var5) {
            final GirlfriendInstance var7 = (GirlfriendInstance) obj;
