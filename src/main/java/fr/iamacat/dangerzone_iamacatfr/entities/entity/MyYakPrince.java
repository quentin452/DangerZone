...
public class MyYakPrince extends EntityMob {
    ...
    public MyYakPrince(final World par1World) {
        super(par1World);
            ...
            for (int j = -3; j < 3; ++j) {
                for (int i = 0; i < 5; ++i) {
                    ...
                    if (bid == Blocks.mob_spawner) {
                        ...
                        if (s != null && s.equals("MyYakPrince")) {
                            return true;
                        }
                    }
                    if (bid != Blocks.air) {
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyYakPrince) {
            return false;
        }
