...
public class MyWindigo extends EntityMob {
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        apj = spawnCreature(this.worldObj, "MyAJ", this.posX, this.posY + 5.0, this.posZ);
        if (twi != null) {
            tw = (MyTwilicorn) twi;
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        final EntityLivingBase e = (EntityLivingBase) par1Entity;
        final float s = par1Entity.height * par1Entity.width;
        if (s > 50.0f && !(par1Entity instanceof MyMLPHydra)
            && !(par1Entity instanceof MySpikezilla)
    ...
    protected void updateAITasks() {
        ...
        if (this.isEnd != 1) {
            ...
            if (this.worldObj.rand.nextInt(2000) == 0
                ...
                if (e != null) {
                    ...
                    if (this.getDistanceSqToEntity((Entity) e) < 2750.0) {
                        ...
                        if (s > 50.0f && !(e instanceof MyMLPHydra)
                            && !(e instanceof MyWindigo)
                            && !(e instanceof MySpikezilla)
            ...
            if (this.getAttacking() != 0 && this.worldObj.rand.nextInt(75) == 1) {
                ...
                if (as != null) {
                    final MyArcticScorpion atcs = (MyArcticScorpion) as;
                    this.motionX *= 3.0;
                    this.motionZ *= 3.0;
                    atcs.atcgothit = 1;
                    atcs.atcmad = 1;
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof EntityLivingBase) {
            ...
            if (s > 30.0f && !MobUtils.isPony((Entity) enl)
                && !(enl instanceof MyMLPHydra)
                && !(enl instanceof MyUrsaMAJOR)) {
                dm /= 10.0f;
                this.dmgDelay = 20;
                this.hugemob = 1;
            }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (MobUtils.isPony((Entity) par1EntityLiving)) {
            return par1EntityLiving instanceof MyTwilicorn;
        }
        ...
        return par1EntityLiving instanceof EntityVillager || (this.MyCanSee(par1EntityLiving)
            && (par1EntityLiving instanceof EntityHorse || par1EntityLiving instanceof EntityDragon
                || (!(par1EntityLiving instanceof MyArcticScorpion)
                    && (par1EntityLiving instanceof MyMLPHydra || par1EntityLiving instanceof MyUrsaMAJOR
