...
public class EntityAIHurtByTarget extends EntityAITarget
{
    ...
    public EntityAIHurtByTarget(final EntityGenericCreature par1EntityLiving, final boolean shouldCallAllies, final boolean shouldCheckSight) {
    ...
    public void startExecuting() {
        ...
        if (this.shouldCallAllies) {
            final List<EntityLiving> var1 = this.taskOwner.worldObj.getEntitiesWithinAABB((Class)this.taskOwner.getClass(), AxisAlignedBB.getBoundingBox(this.taskOwner.posX, this.taskOwner.posY, this.taskOwner.posZ, this.taskOwner.posX + 1.0, this.taskOwner.posY + 1.0, this.taskOwner.posZ + 1.0).expand((double)this.targetDistance, 4.0, (double)this.targetDistance));
