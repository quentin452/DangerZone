...
public class ThePrinceAdult extends EntityTameable {
    ...
    public ThePrinceAdult(final World par1World) {
        ...
        this.tasks.addTask(1, new MyEntityAIFollowOwner((EntityTameable) this, 1.1f, 12.0f, 2.0f));
        this.tasks.addTask(2, new EntityAITempt(this, 1.25, Items.beef, false));
        this.tasks.addTask(3, new MyEntityAIWander(this, 0.75f));
        this.tasks.addTask(4, new EntityAIWatchClosest(this, EntityLiving.class, 20.0f));
    ...
    protected Item getDropItem() {
        return Constants.ThePrinceSpawnEgg;
    }
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            par1Entity.attackEntityFrom(DamageSource.causeMobDamage(this), iskraken * 100.0f);
    ...
    public void updateAITasks() {
        ...
        if (this.getActivity() == 0 && this.riddenByEntity == null
            && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL
            && this.isTamed()
            && DangerZone.FullPowerKingEnable != 0) {
            ++this.growcounter;
            if (this.growcounter > 288000) {
                Entity ent = null;
                TheKing d = null;
                ent = spawnCreature(this.worldObj, "The King", this.posX, this.posY, this.posZ);
                if (ent != null) {
                    d = (TheKing) ent;
                    d.setFree();
                    this.setDead();
    ...
    public void fly_with_rider() {
        ...
        if (this.worldObj.rand.nextInt(5) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                ...
                } else if (this.getDistanceSqToEntity(e) < 625.0 && !this.isInWater()
    ...
    private EntityLivingBase findSomethingToAttack() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(32.0, 20.0, 32.0));
            ...
            if (e != null) {
                if (this.isTamed() && this.getHealth() / this.mygetMaxHealth() < 0.25f) {
                    ...
                    if (this.getDistanceSqToEntity(e) < (10.0f + e.width / 2.0f) * (10.0f + e.width / 2.0f)) {
                        ...
                        do_new = 1;
                    } else if (this.getDistanceSqToEntity(e) < 600.0 && !this.isInWater()
                        && this.getThePrinceAdultFire() != 0
                        && this.worldObj.rand.nextInt(2) == 1) {
                            this.shoot_something(e.posX, e.posY, e.posZ);
                        }
                }
            } else {
                ...
                if (this.riddenByEntity != null) {
                    ...
                    if (this.fireballticker == 0 && (pp.moveStrafing < -0.001f || pp.moveStrafing > 0.001f)) {
                        ...
                        if (this.which_attack == 1) {
                            ...
                            iceBall.posX -= this.motionX * 3.0;
                            final IceBall iceBall2 = var2;
                            iceBall2.posY -= this.motionY * 3.0;
                            final IceBall iceBall3 = var2;
                            iceBall3.posZ -= this.motionZ * 3.0;
                    ...
                    if (!this.worldObj.isRemote) {
                        list = this.worldObj
                            .getEntitiesWithinAABBExcludingEntity(this, this.boundingBox.expand(6.25, 10.0, 6.25));
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (this.isTamed()) {
            ...
            if (var2 == null && par1EntityPlayer.getDistanceSqToEntity(this) < 36.0) {
                if (!this.worldObj.isRemote) {
