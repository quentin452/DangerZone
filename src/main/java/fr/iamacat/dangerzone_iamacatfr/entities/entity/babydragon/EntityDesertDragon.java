...
public class EntityDesertDragon extends EntityTameable
{
    ...
    public EntityDesertDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(8, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.2, Items.reeds, false));
        this.tasks.addTask(9, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.2, Items.reeds, false));
    ...
    public boolean interact(final EntityPlayer p_70085_1_) {
        ...
        else if (itemstack != null && itemstack.getItem() == Items.reeds && !this.isAngry()) {
            if (!p_70085_1_.capabilities.isCreativeMode) {
    ...
    public EntityDesertDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityDesertDragon entitybirchdragon = new EntityDesertDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityDesertDragon)) {
            return false;
        }
        final EntityDesertDragon entitybirchdragon = (EntityDesertDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityDesertDragon) {
                final EntityDesertDragon entitybirchdragon = (EntityDesertDragon)p_142018_1_;
