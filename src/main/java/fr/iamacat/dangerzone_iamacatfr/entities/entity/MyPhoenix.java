...
public class MyPhoenix extends EntityTameable {
    ...
    public MyPhoenix(final World par1World) {
        super(par1World);
    ...
    public MyPhoenix(final World par1World, final double par2, final double par4, final double par6) {
        this(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyPhoenix) {
            return false;
        }
        if (par1EntityLiving instanceof EntityMob) {
            return true;
        }
        if (par1EntityLiving instanceof MyFlameDragon) {
            return true;
        }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj
            .getEntitiesWithinAABB((Class) EntityLivingBase.class, this.boundingBox.expand(68.0, 34.0, 68.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        MyPhoenix target = null;
        target = (MyPhoenix) this.worldObj.findNearestEntityWithinAABB(
            (Class) MyPhoenix.class,
    ...
    public void onUpdate() {
        ...
        if (this.getActivity() == 1) {
            ...
            if (this.wing_sound > 20) {
                if (!this.worldObj.isRemote) {
                    this.worldObj.playSoundAtEntity((Entity) this, Tags.MODID + ":flap_a", 1.5f, 1.0f);
                }
                this.wing_sound = 0;
            }
        }
