...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.ProjectileApplesInstance;
...
public class ApplesRenderer extends Render {

    private static final ResourceLocation textureapls;
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        final ProjectileApplesInstance r = (ProjectileApplesInstance) entity;
        return ApplesRenderer.textureapls;
    }

    static {
        textureapls = new ResourceLocation(Tags.MODID + ":" + "textures/items/apples.png");
    }
}
