...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.Alosaurus;
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelAlosaurus;
...
public class RenderAlosaurus extends RenderLiving {
    ...
    public void renderAlosaurus(final Alosaurus par1EntityAlosaurus, final double par2, final double par4,
        final double par6, final float par8, final float par9) {
        super.doRender(par1EntityAlosaurus, par2, par4, par6, par8, par9);
    }
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":alosaurus.png");
    }
}
