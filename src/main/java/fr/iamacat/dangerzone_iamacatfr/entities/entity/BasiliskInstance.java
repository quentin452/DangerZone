...
public class BasiliskInstance extends EntityMob {

    private GenericTargetSorter TargetSorter;
    private int hurt_timer;
    private float moveSpeed;

    public BasiliskInstance(final World par1World) {
        super(par1World);
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ItemStack is = null;
        this.dropItemRand(ItemInitDangerZone.BasilicsScale, 1);
        ...
        for (int i = 3 + this.worldObj.rand.nextInt(5), var4 = 0; var4 < i; ++var4) {
            ...
            switch (var5) {
                ...
                case 3: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldSword, 1);
                ...
                case 4: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldShovel, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 5: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldPickaxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 6: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldAxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 7: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldHoe    , 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 8: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldHelmet, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 9: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldChestplate, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 10: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldLeggings, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 11: {
                    is = this.dropItemRand(ItemInitDangerZone.EmeraldBoots, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof BasiliskInstance) {
            return false;
        }
    ...
    private EntityLivingBase findSomethingToAttack() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(24.0, 7.0, 24.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        BasiliskInstance target = null;
        target = (BasiliskInstance) this.worldObj
            .findNearestEntityWithinAABB(BasiliskInstance.class, this.boundingBox.expand(20.0, 6.0, 20.0), this);
        return target == null;
    }
}
