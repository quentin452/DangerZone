...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.EasterBunnyInstance;
...
public class RenderEasterBunny extends RenderLiving {
    ...
    public void renderEasterBunny(final EasterBunnyInstance par1EntityEasterBunny, final double par2, final double par4,
    ...
    public void doRender(final EntityLiving par1EntityLiving, final double par2, final double par4, final double par6,
        ...
        this.renderEasterBunny((EasterBunnyInstance) par1EntityLiving, par2, par4, par6, par8, par9);
    }

    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.renderEasterBunny((EasterBunnyInstance) par1Entity, par2, par4, par6, par8, par9);
    }

    protected void preRenderScale(final EasterBunnyInstance par1Entity, final float par2) {
    ...
    protected void preRenderCallback(final EntityLivingBase par1EntityLiving, final float par2) {
        this.preRenderScale((EasterBunnyInstance) par1EntityLiving, par2);
    }
