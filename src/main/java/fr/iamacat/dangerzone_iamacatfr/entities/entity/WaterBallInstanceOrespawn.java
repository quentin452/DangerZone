...
public class WaterBallInstanceOrespawn extends EntityThrowable {

    private float my_rotation;
    private int my_index;

    public WaterBallInstanceOrespawn(final World par1World) {
        super(par1World);
        this.my_rotation = 0.0f;
        this.my_index = 49;
    }

    public WaterBallInstanceOrespawn(final World par1World, final EntityLivingBase par2EntityLiving) {
        super(par1World, par2EntityLiving);
        this.my_rotation = 0.0f;
        this.my_index = 49;
    }

    public WaterBallInstanceOrespawn(final World worldObj, final double d, final double e, final double f) {
    ...
    protected void onImpact(final MovingObjectPosition par1MovingObjectPosition) {
        if (par1MovingObjectPosition.entityHit != null) {
            ...
            if (this.worldObj.rand.nextInt(10) == 1) {
                par1MovingObjectPosition.entityHit.dropItem(ItemInitDangerZone.WaterBall, 1);
            }
