...
public class EntityAINearestAttackableTarget extends EntityAITarget {
    ...
    public EntityAINearestAttackableTarget(final EntityLiving par1, final EnumSet<EntityStates> setOfValidStates,
        final Class par2, final float par3, final int par4, final boolean par5, final boolean par6,
    ...
    public boolean shouldExecute() {
        ...
        if (this.targetClass == EntityPlayer.class) {
            final EntityPlayer var1 = this.taskOwner.worldObj
                .getClosestVulnerablePlayerToEntity((Entity) this.taskOwner, (double) this.targetDistance);
