...
public class MyLargeFlame extends EntityFX {

    private float flameScale;

    public MyLargeFlame(final World par1World, final double par2, final double par4, final double par6,
        ...
        this.particleScale *= 10.0;
        this.flameScale = this.particleScale;
        final float particleRed = 1.0f;
        this.particleBlue = particleRed;
        this.particleGreen = particleRed;
        this.particleRed = particleRed;
        this.particleMaxAge = (int) (12.0 / (Math.random() * 1.8 + 0.8)) + 12;
