...
public class EntityRiverDragon extends EntityTameable
{
    ...
    public EntityRiverDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    public EntityRiverDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityRiverDragon entityalpsdragon = new EntityRiverDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityRiverDragon)) {
            return false;
        }
        final EntityRiverDragon entityalpsdragon = (EntityRiverDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityRiverDragon) {
                final EntityRiverDragon entityalpsdragon = (EntityRiverDragon)p_142018_1_;
