...
public class TwilightMobInstance extends EntityMob {

    private GenericTargetSorterInstance TargetSorter;
    private float moveSpeed;
    private EntityLivingBase rt;

    public TwilightMobInstance(final World par1World) {
        super(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof TwilightMobInstance) {
            return false;
        }
    ...
    public boolean getCanSpawnHere() {
            ...
            for (byte j = -3; j < 3; ++j) {
                for (byte i = 0; i < 5; ++i) {
                    ...
                    if (bid == Blocks.mob_spawner) {
                        ...
                        if (s != null && s.equals("TwilightMobInstance")) {
                            return true;
                        }
                    }
                }
        ...
        TwilightMobInstance target = null;
        target = (TwilightMobInstance) this.worldObj.findNearestEntityWithinAABB(
