...
public class RedAntInstance extends EntityAnimal {

    public double moveSpeed;
    private static final ResourceLocation texture2;

    public RedAntInstance(final World par1World) {
        super(par1World);
    ...
    public ResourceLocation getTexture(final RedAntInstance a) {
        return RedAntInstance.texture2;
    }
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (par1EntityPlayer.dimension !=DimensionInitDangerZone.MiningDimensionId) {
            MinecraftServer.getServer()
                .getConfigurationManager()
                .transferPlayerToDimension(
                    (EntityPlayerMP) par1EntityPlayer,
                    DimensionInitDangerZone.MiningDimensionId,
                    new SafeTeleporter(
                        MinecraftServer.getServer()
                            .worldServerForDimension(DimensionInitDangerZone.MiningDimensionId),
                        DimensionInitDangerZone.MiningDimensionId,
                        this.worldObj));
        } else {
            MinecraftServer.getServer()
    ...
    private int findBuddies() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(RedAntInstance.class, this.boundingBox.expand(20.0, 10.0, 20.0));
        return var5.size();
    }
