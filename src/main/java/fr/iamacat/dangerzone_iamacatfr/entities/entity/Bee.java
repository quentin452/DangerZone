...
public class Bee extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
            .setBaseValue(OreSpawnMain.Bee_stats.attack);
    }
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        final boolean var4 = par1Entity
            .attackEntityFrom(DamageSource.causeMobDamage(this), (float) OreSpawnMain.Bee_stats.attack);
        if (this.worldObj.rand.nextInt(3) == 1 && par1Entity != null) {
            ((EntityLiving) par1Entity).addPotionEffect(new PotionEffect(Potion.poison.id, 50, 0));
        }
        return var4;
    }
