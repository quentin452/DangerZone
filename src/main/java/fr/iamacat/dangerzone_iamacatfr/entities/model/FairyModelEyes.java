...
public class FairyModelEyes extends ModelBiped {

    public FairyModelEyes() {
        this(0.0F);
    }

    public FairyModelEyes(final float f) {
        this(f, 0.0F);
    }

    public FairyModelEyes(final float f, final float f1) {
        heldItemLeft = 0;
        heldItemRight = 0;
        isSneak = false;
        flymode = false;
