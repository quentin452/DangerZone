...
public class EyeRayInstance extends EntityLiving {
    ...
    public EyeRayInstance(World par1World) {
        super(par1World);
    ...
    public EyeRayInstance(World par1World, double par2, double par4, double par6, double par8, double par10,
        double par12) {
        super(par1World);
        this.setSize(1.0F, 1.0F);
    ...
    public EyeRayInstance(World par1World, EntityLiving par2EntityLiving, double par3, double par5, double par7) {
        super(par1World);
    ...
    public void onUpdate() {
        if (!this.worldObj.isRemote && (this.shootingEntity != null && this.shootingEntity.isDead
            || !this.worldObj.blockExists((int) this.posX, (int) this.posY, (int) this.posZ))) this.setDead();
        else {
            ...
            for (int var8 = 0; var8 < var5.size(); ++var8) {
                ...
                if (var9.canBeCollidedWith() && (!var9.isEntityEqual(this.shootingEntity) || this.ticksInAir >= 25)
                    && !(var9 instanceof EyeRayInstance)
        ...
        if (!this.worldObj.isRemote) {
            if (var1.entityHit != null) {
                ...
                if (foo instanceof EntityPlayer) {
                    ...
                    if (bar.capabilities.isCreativeMode) badIdea = true;
                }
                ...
                if (foo instanceof EntityPlayer && !badIdea) {
                    ...
                    int var2 = Helper.getDifficulty(this.worldObj);

                    int moo;

                    if (var2 != 0) moo = this.rand.nextInt(var2 * 2) + var2 - 1;
                    else moo = 0;
                    ...
                    for (int i = 0; i < moo; i++) {
                        ...
                        if (thing != null) {
                            if (thing.isItemEnchanted()) thing.getTagCompound()
                                .removeTag("ench");
                        }
                    }
                }
