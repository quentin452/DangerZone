...
public class BandPInstance extends EntityMob {
    ...
    public BandPInstance(final World par1World) {
        super(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        return par1EntityLiving instanceof EntityVillager || par1EntityLiving instanceof GirlfriendInstance
    ...
    public boolean getCanSpawnHere() {
        ...
        BandPInstance target = null;
        target = (BandPInstance) this.worldObj
            .findNearestEntityWithinAABB(BandPInstance.class, this.boundingBox.expand(32.0, 12.0, 32.0), this);
        if (target != null) {
            return false;
        }
