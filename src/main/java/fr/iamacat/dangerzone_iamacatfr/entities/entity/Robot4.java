...
public class Robot4 extends EntityMob {
        ...
        if (this.worldObj.isRemote) {
            if (this.rand.nextInt(3) == 1) {
                this.worldObj.spawnParticle(
                    "smoke",
                    this.posX - 1.25 * Math.sin(Math.toRadians(this.rotationYaw + 180.0f)),
                    this.posY + 3.0 + this.worldObj.rand.nextFloat(),
                    this.posZ + 1.25 * Math.cos(Math.toRadians(this.rotationYaw + 180.0f)),
                    0.0,
                    this.worldObj.rand.nextFloat() / 2.0,
                    0.0);
            }
            if (this.getAttacking() != 0) {
                this.worldObj.spawnParticle(
                    "reddust",
                    this.posX - 1.55 * Math.sin(Math.toRadians(this.rotationYaw + 35.0f)),
                    this.posY + 2.25 + this.worldObj.rand.nextFloat(),
                    this.posZ + 1.55 * Math.cos(Math.toRadians(this.rotationYaw + 35.0f)),
                    0.0,
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int var5 = 5 + this.worldObj.rand.nextInt(10), var6 = 0; var6 < var5; ++var6) {
            this.dropItemRand(ItemInitDangerZone.LaserCharge, 4);
        }
        this.dropItemRand(ItemInitDangerZone.ItemRayGun, 1);
                ...
                if (this.getDistanceSqToEntity(e) < 256.0) {
                    if (this.getDistanceSqToEntity(e) < (3.0f + e.width / 2.0f) * (3.0f + e.width / 2.0f)) {
                        ...
                        if (rdd < 0.5) {
                            ...
                            final LaserBallInstance var2 = new LaserBallInstance(
                                this.worldObj,
                                e.posX - this.posX,
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(16.0, 4.0, 16.0));
