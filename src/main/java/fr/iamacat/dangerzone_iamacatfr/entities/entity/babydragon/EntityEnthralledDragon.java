...
public class EntityEnthralledDragon extends DecoyCaveDragonTameable {
    ...
    protected String getLivingSound() {
        return this.isAngry() ? Tags.MODID + ":mob.tinydragon.enthralled"
            : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f)
                ? Tags.MODID + ":mob.tinydragon.enthralled"
                : Tags.MODID + ":mob.tinydragon.enthralled") : Tags.MODID + ":mob.tinydragon.enthralled");
    }
