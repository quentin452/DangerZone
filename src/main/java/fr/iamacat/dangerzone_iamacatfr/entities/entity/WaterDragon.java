...
public class WaterDragon extends EntityTameable {
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ItemStack is = null;
        this.dropItemRand(ItemInitDangerZone.WaterDragonScale, 1);
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        final boolean var4 = par1Entity
            .attackEntityFrom(DamageSource.causeMobDamage(this), (float) 20);
        if (var4) {
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof AttackSquidInstance) {
            return false;
        }
        if (e != null && e instanceof WaterBallInstance) {
            return false;
        }
    ...
    private void watercanon(final EntityLivingBase e) {
        ...
        if (this.stream_count > 0) {
            ...
            final WaterBallInstance var3 = new WaterBallInstance(
                this.worldObj,
                e.posX - this.posX,
                e.posY + 0.75 - (this.posY + yoff),
                e.posZ - this.posZ);
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (WaterDragon) this.worldObj
            .findNearestEntityWithinAABB(WaterDragon.class, this.boundingBox.expand(16.0, 5.0, 16.0), this);
        return target == null;
    }
