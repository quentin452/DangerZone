...
public class MyCockatrice extends EntityTameable {
    ...
    public MyCockatrice(final World par1World) {
        super(par1World);
    ...
    public MyCockatrice(final World par1World, final double par2, final double par4, final double par6) {
        this(par1World);
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof MyCockatrice) {
            return false;
        }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyCockatrice) {
            return false;
        }
