...
public class ModelLizard extends ModelBase {
    ...
    public ModelLizard(final float f1) {
        ...
        (this.BodyBack = new ModelRenderer((ModelBase) this, 92, 48)).addBox(-4.0f, -4.0f, 0.0f, 8, 8, 8);
        ...
        (this.TopBackLeftLeg = new ModelRenderer((ModelBase) this, 54, 32)).addBox(0.0f, -2.0f, -2.0f, 8, 3, 3);
        ...
        (this.TailTip = new ModelRenderer((ModelBase) this, 100, 118)).addBox(-1.0f, -1.0f, 0.0f, 2, 2, 8);
        ...
        (this.BodyFront = new ModelRenderer((ModelBase) this, 92, 16)).addBox(-4.0f, -4.0f, -8.0f, 8, 8, 8);
        ...
        (this.TailBase1 = new ModelRenderer((ModelBase) this, 88, 64)).addBox(-3.0f, -3.0f, 0.0f, 6, 6, 14);
        ...
        (this.Tail2 = new ModelRenderer((ModelBase) this, 95, 84)).addBox(-2.0f, -2.0f, 0.0f, 4, 4, 10);
        this.Tail2.setRotationPoint(0.0f, 17.0f, 19.0f);
        this.Tail2.setTextureSize(64, 32);
        this.Tail2.mirror = true;
        this.setRotation(this.Tail2, -0.5235988f, 0.0f, 0.0f);
        (this.Tail3 = new ModelRenderer((ModelBase) this, 100, 98)).addBox(-1.0f, -1.0f, 0.0f, 2, 2, 8);
        ...
        (this.Tail4 = new ModelRenderer((ModelBase) this, 100, 108)).addBox(-1.0f, -1.0f, 0.0f, 2, 2, 8);
        ...
        (this.Neck = new ModelRenderer((ModelBase) this, 100, 9)).addBox(-3.0f, -2.0f, -2.0f, 6, 5, 2);
        this.Neck.setRotationPoint(0.0f, 12.0f, -16.0f);
        this.Neck.setTextureSize(64, 32);
        this.Neck.mirror = true;
        this.setRotation(this.Neck, 0.0f, 0.0f, 0.0f);
        (this.TopFrontLeftLeg = new ModelRenderer((ModelBase) this, 26, 12)).addBox(0.0f, -2.0f, -2.0f, 8, 3, 3);
        ...
        (this.TopBackRightLeg = new ModelRenderer((ModelBase) this, 26, 32)).addBox(-8.0f, -2.0f, -2.0f, 8, 3, 3);
        ...
        (this.BottomBackRightLeg = new ModelRenderer((ModelBase) this, 25, 26)).addBox(-12.0f, -8.0f, -2.0f, 9, 3, 3);
        ...
        (this.TopFrontRightLeg = new ModelRenderer((ModelBase) this, 54, 12)).addBox(-8.0f, -2.0f, -2.0f, 8, 3, 3);
        ...
        (this.BottomBackLeftLeg = new ModelRenderer((ModelBase) this, 53, 26)).addBox(3.0f, -8.0f, -2.0f, 9, 3, 3);
        ...
        (this.BottomFrontRightLeg = new ModelRenderer((ModelBase) this, 53, 18)).addBox(-12.0f, -8.0f, -2.0f, 9, 3, 3);
        ...
        (this.BottomFrontLeftLeg = new ModelRenderer((ModelBase) this, 25, 18)).addBox(3.0f, -8.0f, -2.0f, 9, 3, 3);
        ...
        (this.BodyCenter = new ModelRenderer((ModelBase) this, 92, 32)).addBox(-4.0f, -4.0f, -4.0f, 8, 8, 8);
        ...
        (this.Toe7 = new ModelRenderer((ModelBase) this, 104, 0)).addBox(10.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.Toe6 = new ModelRenderer((ModelBase) this, 108, 0)).addBox(8.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.BackLeftFoot = new ModelRenderer((ModelBase) this, 20, 0)).addBox(7.0f, 9.0f, -4.0f, 4, 2, 6);
        ...
        (this.Toe4 = new ModelRenderer((ModelBase) this, 80, 0)).addBox(-11.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.Toe5 = new ModelRenderer((ModelBase) this, 84, 0)).addBox(-9.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.BackRightFoot = new ModelRenderer((ModelBase) this, 60, 0)).addBox(-11.0f, 9.0f, -4.0f, 4, 2, 6);
        ...
        (this.Toe8 = new ModelRenderer((ModelBase) this, 100, 0)).addBox(10.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.Toe1 = new ModelRenderer((ModelBase) this, 96, 0)).addBox(8.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.FrontLeftFoot = new ModelRenderer((ModelBase) this, 40, 0)).addBox(7.0f, 9.0f, -4.0f, 4, 2, 6);
        ...
        (this.Toe3 = new ModelRenderer((ModelBase) this, 88, 0)).addBox(-11.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.Toe2 = new ModelRenderer((ModelBase) this, 92, 0)).addBox(-9.0f, 10.0f, -5.0f, 1, 1, 1);
        ...
        (this.FrontRightFoot = new ModelRenderer((ModelBase) this, 0, 0)).addBox(-11.0f, 9.0f, -4.0f, 4, 2, 6);
        ...
        (this.FinRidge7 = new ModelRenderer((ModelBase) this, 0, 99)).addBox(0.0f, -13.0f, 0.0f, 2, 13, 1);
        ...
        (this.FinRidge6 = new ModelRenderer((ModelBase) this, 6, 98)).addBox(0.0f, -13.0f, 0.0f, 2, 13, 1);
        ...
        (this.FinRidge5 = new ModelRenderer((ModelBase) this, 12, 99)).addBox(0.0f, -13.0f, 0.0f, 2, 13, 1);
        ...
        (this.FinRidge4 = new ModelRenderer((ModelBase) this, 6, 114)).addBox(0.0f, -13.0f, 0.0f, 2, 13, 1);
        ...
        (this.FinRidge3 = new ModelRenderer((ModelBase) this, 12, 115)).addBox(0.0f, -13.0f, 0.0f, 2, 13, 1);
        ...
        (this.FinRidge2 = new ModelRenderer((ModelBase) this, 0, 84)).addBox(0.0f, -13.0f, 0.0f, 2, 13, 1);
        ...
        (this.FinRidge1 = new ModelRenderer((ModelBase) this, 0, 114)).addBox(0.0f, -13.0f, 0.0f, 2, 13, 1);
        ...
        (this.Fin10 = new ModelRenderer((ModelBase) this, 0, 58)).addBox(0.0f, -13.0f, -2.0f, 0, 11, 6);
        ...
        (this.Fin9 = new ModelRenderer((ModelBase) this, 7, 84)).addBox(0.0f, -11.0f, 0.0f, 0, 11, 3);
        ...
        (this.Fin8 = new ModelRenderer((ModelBase) this, 12, 34)).addBox(0.0f, -7.0f, -4.0f, 0, 7, 4);
        ...
        (this.Fin7 = new ModelRenderer((ModelBase) this, 12, 46)).addBox(0.0f, -8.0f, -4.0f, 0, 8, 4);
        ...
        (this.Fin6 = new ModelRenderer((ModelBase) this, 0, 31)).addBox(0.0f, -10.0f, -4.0f, 0, 10, 4);
        ...
        (this.Fin5 = new ModelRenderer((ModelBase) this, 30, 59)).addBox(0.0f, -12.0f, -5.0f, 0, 11, 6);
        ...
        (this.Fin3 = new ModelRenderer((ModelBase) this, 14, 60)).addBox(0.0f, -12.0f, -3.0f, 0, 12, 6);
        ...
        (this.Fin2 = new ModelRenderer((ModelBase) this, 14, 79)).addBox(0.0f, -12.0f, -4.0f, 0, 11, 6);
        ...
        (this.Tooth11 = new ModelRenderer((ModelBase) this, 24, 110)).addBox(3.0f, 3.0f, -8.0f, 1, 1, 1);
        ...
        (this.Tooth10 = new ModelRenderer((ModelBase) this, 24, 106)).addBox(3.0f, 3.0f, -10.0f, 1, 1, 1);
        ...
        (this.Tooth8 = new ModelRenderer((ModelBase) this, 28, 95)).addBox(3.0f, 3.0f, -14.0f, 1, 1, 1);
        ...
        (this.Tooth7 = new ModelRenderer((ModelBase) this, 70, 106)).addBox(-4.0f, 3.0f, -10.0f, 1, 1, 1);
        ...
        (this.Tooth6 = new ModelRenderer((ModelBase) this, 70, 102)).addBox(-4.0f, 3.0f, -12.0f, 1, 1, 1);
        ...
        (this.Tooth5 = new ModelRenderer((ModelBase) this, 66, 95)).addBox(-4.0f, 3.0f, -14.0f, 1, 1, 1);
        ...
        (this.Tooth4 = new ModelRenderer((ModelBase) this, 60, 95)).addBox(1.0f, 3.0f, -14.0f, 1, 1, 1);
        ...
        (this.Tooth3 = new ModelRenderer((ModelBase) this, 34, 95)).addBox(-2.0f, 3.0f, -14.0f, 1, 1, 1);
        ...
        (this.Tooth2 = new ModelRenderer((ModelBase) this, 70, 110)).addBox(-4.0f, 3.0f, -8.0f, 1, 1, 1);
        ...
        (this.CenterRightNose = new ModelRenderer((ModelBase) this, 40, 88)).addBox(-4.0f, 0.0f, -14.0f, 1, 1, 1);
        ...
        (this.CenterLeftNose = new ModelRenderer((ModelBase) this, 54, 88)).addBox(3.0f, 0.0f, -14.0f, 1, 1, 1);
        ...
        (this.Tooth1 = new ModelRenderer((ModelBase) this, 24, 102)).addBox(3.0f, 3.0f, -12.0f, 1, 1, 1);
        ...
        (this.BottomNose = new ModelRenderer((ModelBase) this, 40, 90)).addBox(-4.0f, 1.0f, -14.0f, 8, 2, 1);
        ...
        (this.TopNose = new ModelRenderer((ModelBase) this, 40, 84)).addBox(-4.0f, -3.0f, -14.0f, 8, 3, 1);
        ...
        (this.JawTop = new ModelRenderer((ModelBase) this, 28, 97)).addBox(-4.0f, -3.0f, -13.0f, 8, 6, 13);
        ...
        (this.CenterMiddleNose = new ModelRenderer((ModelBase) this, 46, 88)).addBox(-1.0f, 0.0f, -14.0f, 2, 1, 1);
        ...
        (this.RightEye = new ModelRenderer((ModelBase) this, 116, 10)).addBox(-2.0f, -4.0f, -4.0f, 2, 2, 1);
        ...
        (this.LeftEye = new ModelRenderer((ModelBase) this, 94, 10)).addBox(0.0f, -4.0f, -4.0f, 2, 2, 1);
        ...
        (this.Tooth16 = new ModelRenderer((ModelBase) this, 24, 97)).addBox(3.0f, -1.0f, -10.0f, 1, 1, 1);
        ...
        (this.Tooth15 = new ModelRenderer((ModelBase) this, 70, 97)).addBox(-4.0f, -1.0f, -10.0f, 1, 1, 1);
        ...
        (this.Tooth14 = new ModelRenderer((ModelBase) this, 42, 95)).addBox(-2.0f, -1.0f, -10.0f, 1, 1, 1);
        ...
        (this.Tooth13 = new ModelRenderer((ModelBase) this, 52, 95)).addBox(1.0f, -1.0f, -10.0f, 1, 1, 1);
        ...
        (this.Tooth12 = new ModelRenderer((ModelBase) this, 24, 114)).addBox(3.0f, -1.0f, -7.0f, 1, 1, 1);
        ...
        (this.Tooth9 = new ModelRenderer((ModelBase) this, 70, 114)).addBox(-4.0f, -1.0f, -7.0f, 1, 1, 1);
        ...
        (this.BottomJaw = new ModelRenderer((ModelBase) this, 31, 116)).addBox(-4.0f, 0.0f, -10.0f, 8, 2, 10);
        ...
        (this.Hat1 = new ModelRenderer((ModelBase) this, 30, 40)).addBox(-2.0f, -4.0f, -6.0f, 4, 1, 6);
        ...
        (this.Hat2 = new ModelRenderer((ModelBase) this, 30, 40)).addBox(-1.5f, -6.0f, -4.0f, 3, 2, 4);
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3,
        ...
        this.Tail2.rotationPointZ = this.TailBase1.rotationPointZ
            + (float) Math.cos(this.TailBase1.rotateAngleY) * 12.0f;
        this.Tail2.rotationPointX = this.TailBase1.rotationPointX
            + (float) Math.sin(this.TailBase1.rotateAngleY) * 12.0f;
        ...
        if (e instanceof CannonFodderInstance && e.get_is_activated() != 0) {
            this.Hat1.render(f5);
