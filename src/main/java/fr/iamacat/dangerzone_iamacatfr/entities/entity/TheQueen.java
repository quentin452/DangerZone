...
public class TheQueen extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
            .setBaseValue(0.6200000047683716);
        this.attdam =225;
    ...
    private void dropItemRand(final Item index, final int par1) {
        final EntityItem var3 = new EntityItem(
            this.worldObj,
            this.posX + rand.nextInt(20) - rand.nextInt(20),
            this.posY + 12.0,
            this.posZ + rand.nextInt(20) - rand.nextInt(20),
            new ItemStack(index, par1, 0));
        this.worldObj.spawnEntityInWorld(var3);
    }

    protected void dropFewItems(final boolean par1, final int par2) {
        this.dropItemRand(ItemInitDangerZone.royalsword, 1);
        this.dropItemRand(Constants.ThePrinceSpawnEgg, 1);
        spawnCreature(this.worldObj, "The Princess", this.posX, this.posY + 10.0, this.posZ);
        for (int i = 0; i < 56; ++i) {
            this.dropItemRand(ItemInitDangerZone.QueenScale, 1);
            ...
            if (this.worldObj.rand.nextInt(4) == 1) {
                for (int i = 0; i < 10; ++i) {
                    this.worldObj.spawnParticle(
                        ...
                        (this.worldObj.rand.nextGaussian() - this.worldObj.rand.nextGaussian()) / 5.0
                            + this.motionX * 3.0,
                        (this.worldObj.rand.nextGaussian() - this.worldObj.rand.nextGaussian()) / 5.0,
                        (this.worldObj.rand.nextGaussian() - this.worldObj.rand.nextGaussian()) / 5.0
                            + this.motionZ * 3.0);
    ...
    protected void updateAITasks() {
        ...
        if (this.attack_level > 1000) {
            if (this.mood == 1) {
                ...
                for (int i = 0; i < j; ++i) {
                    final Entity ppwr = spawnCreature(
                        this.worldObj,
                        "PurplePower",
                    ...
                    for (int m = 0; m < 25; ++m) {
                        ...
                        while (j < 20) {
                            final Block bid = this.worldObj
                                .getBlock((int) this.posX + i, (int) this.posY + j, (int) this.posZ + k);
                            if (bid == Blocks.grass) {
                                if (this.worldObj
                                    .getBlock((int) this.posX + i, (int) this.posY + j + 1, (int) this.posZ + k)
                                    != Blocks.air) {
                                    break;
                                }
                                ...
                                if (which == 2) {
                                    this.worldObj.setBlock(
                                        ...
                                        (int) this.posY + j + 1,
                                        (int) this.posZ + k,
                                        BlockInitDangerZone.MyFlowerBlueBlock);
                                }
                                if (which == 3) {
                                    this.worldObj.setBlock(
                                        (int) this.posX + i,
                                        (int) this.posY + j + 1,
                                        (int) this.posZ + k,
                                        BlockInitDangerZone.MyFlowerPinkBlock);
                                }
                                if (which == 4) {
                                    this.worldObj.setBlock(
                                        (int) this.posX + i,
                                ...
                                if (bid == Blocks.dirt && this.worldObj
                                    .getBlock((int) this.posX + i, (int) this.posY + j + 1, (int) this.posZ + k)
                                    == Blocks.air) {
                                    this.worldObj.setBlock(
                                        (int) this.posX + i,
                                ...
                                if (bid == Blocks.stone && this.worldObj
                                    .getBlock((int) this.posX + i, (int) this.posY + j + 1, (int) this.posZ + k)
                                    == Blocks.air) {
                                    this.worldObj.setBlock(
                                        (int) this.posX + i,
                                ...
                                if (bid == Blocks.sand && this.worldObj
                                    .getBlock((int) this.posX + i, (int) this.posY + j + 1, (int) this.posZ + k)
                                    == Blocks.air) {
                                    ...
                                    if (bid == Blocks.lava && this.worldObj
                                        .getBlock((int) this.posX + i, (int) this.posY + j + 1, (int) this.posZ + k)
                                        == Blocks.air) {
                                        this.worldObj.setBlock(
                                            (int) this.posX + i,
                                    ...
                                    if (bid == Blocks.flowing_lava && this.worldObj
                                        .getBlock((int) this.posX + i, (int) this.posY + j + 1, (int) this.posZ + k)
                                        == Blocks.air) {
                                        this.worldObj.setBlock(
                                            (int) this.posX + i,
                ...
                for (int m = 0; m < 10; ++m) {
                    ...
                    if (bid == Blocks.air) {
                        if (this.worldObj.rand.nextInt(2) == 0) {
                            newent = (EntityLiving) spawnCreature(
                                this.worldObj,
                                "Butterfly",
                                this.posX + i,
                                this.posY + j,
        ...
        if (this.ticker % 10 == 0) {
        //    this.dataWatcher.updateObject(21, (Object) DangerZone.PlayNicely);
        ...
        if (this.tooFarFromHome() || this.worldObj.rand.nextInt(200) == 0
            ...
            if (this.mood == 0) {
                kinglist = this.worldObj
                    .getEntitiesWithinAABB(TheKing.class, this.boundingBox.expand(64.0, 32.0, 64.0));
                if (kinglist != null) {
                    Collections.sort((List<Object>) kinglist, (Comparator<? super Object>) this.TargetSorter);
                    ...
                    if (var6.hasNext()) {
                        ...
                        this.currentFlightTarget.set(
                            (int) var7.posX + xdir,
                            (int) (var7.posY + (this.worldObj.rand.nextInt(8) - this.worldObj.rand.nextInt(8))),
                            (int) var7.posZ + zdir);
                    }
                }
            }
            ...
            if (e != null) {
                            ...
                            for (int i = -5; i <= 5; i += 5) {
                                for (int j = -5; j <= 5; j += 5) {
                                    Block bid = this.worldObj
                                        .getBlock((int) e.posX + j, (int) this.posY, (int) e.posZ + i);
                                    if (bid != Blocks.air) {
                                        for (int k = 1; k < 20; ++k) {
                                            bid = this.worldObj
                ...
                if (this.worldObj.rand.nextInt(3) == 1) {
                    this.doJumpDamage(dx, this.posY + 10.0, dz, 15.0, 225 / 2, 1);
                }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        final MyUtils oreSpawnUtils2 = DangerZone.OreSpawnUtils;
        return MyUtils.isAttackableNonMob(par1EntityLiving);
    }

    private EntityLivingBase findSomethingToAttack() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(80.0, 60.0, 80.0));
