...
// todo
    ...
    public void onLivingUpdate() {
        ...
        if (this.getAttackTarget() != null && (this.getAttackTarget() instanceof TragicMob || this.getAttackTarget() instanceof TragicBoss)) {
            this.setAttackTarget(null);
        }
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
	{
		...
		if (par1DamageSource.getEntity() != null)
		{
			if (par1DamageSource.getEntity() instanceof EntityPlayer && par2 >= DangerZoneConfig.bossDamageCap)
			{
				...
				if (!player.capabilities.isCreativeMode || !flag) par2 = MathHelper.clamp_float(par2, 0.0F, DangerZoneConfig.bossDamageCap);
			}
