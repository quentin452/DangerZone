...
public class MyToughGuy extends EntityMob {

    private GenericTargetSorter TargetSorter;
    private float moveSpeed;
    private RenderInfo renderdata;

    public MyToughGuy(final World par1World) {
        super(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyToughGuy) {
            return false;
        }
    ...
    public boolean getCanSpawnHere() {
        ...
        MyToughGuy target = null;
        target = (MyToughGuy) this.worldObj.findNearestEntityWithinAABB(
            (Class) MyToughGuy.class,
