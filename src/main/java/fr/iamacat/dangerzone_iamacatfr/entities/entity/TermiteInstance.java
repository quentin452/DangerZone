...
public class TermiteInstance extends EntityAnimal {

    public double moveSpeed;
    private static final ResourceLocation texture5;

    public TermiteInstance(final World par1World) {
        super(par1World);
    ...
    public ResourceLocation getTexture(final TermiteInstance a) {
        return TermiteInstance.texture5;
    }
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (par1EntityPlayer.dimension != DimensionInitDangerZone.CrystalDimensionId) {
            MinecraftServer.getServer()
                .getConfigurationManager()
                .transferPlayerToDimension(
                    (EntityPlayerMP) par1EntityPlayer,
                    DimensionInitDangerZone.CrystalDimensionId,
                  new SafeTeleporter(
                        MinecraftServer.getServer()
                            .worldServerForDimension(DimensionInitDangerZone.CrystalDimensionId),
                      DimensionInitDangerZone.CrystalDimensionId,
                        this.worldObj));
        } else {
            MinecraftServer.getServer()
    ...
    private int findBuddies() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(TermiteInstance.class, this.boundingBox.expand(20.0, 10.0, 20.0));
        return var5.size();
    }
