...
import fr.iamacat.dangerzone_iamacatfr.entities.render.RenderMinotaurInfo;
import fr.iamacat.dangerzone_iamacatfr.util.MobUtils;
import fr.iamacat.dangerzone_iamacatfr.util.Tags;

public class MyIronWill extends EntityMob {

    private GenericTargetSorter TargetSorter;
    private RenderMinotaurInfo renderdata;
    private int force_sync;
    private int dmgDelay;
    private float moveSpeed;

    public MyIronWill(final World par1World) {
        super(par1World);
    ...
    public RenderMinotaurInfo getRenderMinotaurInfo() {
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyIronWill) {
            return false;
        }
