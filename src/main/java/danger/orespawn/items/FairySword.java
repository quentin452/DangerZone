...
import danger.orespawn.entities.entityinstance.Fairy;
...
public class FairySword extends ItemSword {
    ...
    public FairySword(final int par1, final Item.ToolMaterial par2EnumToolMaterial) {
