...
public class CephadromeInstance extends EntityCreature {
    ...
    public CephadromeInstance(final World par1World) {
        super(par1World);
    ...
    public CephadromeInstance(final World par1World, final double par2, final double par4, final double par6) {
        this(par1World);
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int i = 1 + this.worldObj.rand.nextInt(5), var4 = 0; var4 < i; ++var4) {
            ...
            switch (var5) {
                case 0: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubySword, 1);
                    break;
                }
                case 1: {
                ...
                case 2: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.ThunderStaff, 1);
                    break;
                }
                case 3: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubySword, 1);
                ...
                case 4: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyShovel, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 5: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyPickaxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 6: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyAxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 7: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyHoe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 8: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyHelmet, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 9: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyChestplate, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 10: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyLeggings, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 11: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyBoots, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 16:
                case 17: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.RubyIngot, 1);
                    break;
                }
            }
        }
    ...
    public void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(7) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                ...
                } else if (e instanceof Kraken && this.getHorizontalDistanceSqToEntity(e)
                    < (maxdist + e.width / 2.0f) * (maxdist + e.width / 2.0f)) {
                        this.attackEntityAsMob(e);
                    }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof CephadromeInstance) {
            return false;
        }
    ...
    private EntityLivingBase findSomethingToAttack() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(16.0, 20.0, 16.0));
    ...
    public boolean getCanSpawnHere() {
        ...
        CephadromeInstance target = null;
        target = (CephadromeInstance) this.worldObj
            .findNearestEntityWithinAABB(CephadromeInstance.class, this.boundingBox.expand(16.0, 6.0, 16.0), this);
        return target == null;
    }
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (var2 != null
            && (var2.getItem() == Items.beef || var2.getItem() == Items.chicken || var2.getItem() == Items.porkchop)
        ...
        if (var2 == null && par1EntityPlayer.getDistanceSqToEntity(this) < 25.0 && !this.worldObj.isRemote) {
            if (this.wasfed == 0) {
                this.getNavigator()
                    .tryMoveToEntityLiving(par1EntityPlayer, 1.2);
                this.shouldattack = 1;
                return false;
            }
