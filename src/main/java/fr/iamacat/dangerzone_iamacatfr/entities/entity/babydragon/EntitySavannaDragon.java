...
public class EntitySavannaDragon extends EntityTameable
{
    ...
    public EntitySavannaDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    public EntitySavannaDragon createChild(final EntityAgeable p_90011_1_) {
        final EntitySavannaDragon entityalpsdragon = new EntitySavannaDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntitySavannaDragon)) {
            return false;
        }
        final EntitySavannaDragon entityalpsdragon = (EntitySavannaDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntitySavannaDragon) {
                final EntitySavannaDragon entityalpsdragon = (EntitySavannaDragon)p_142018_1_;
