...
import danger.orespawn.entities.entityinstance.Skate;
import danger.orespawn.entities.model.ModelSkate;
...
public class RenderSkate extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "Skatetexture.png");
    }
}
