...
public class EntityAIFollowTwin extends EntityAIBase {
    ...
    public boolean continueExecuting() {
        if (this.entityOwner.isTwinDead() || this.entityOwner.getAttackTarget() != null) return false;
        else {
    ...
    public void updateTask() {
        if (--this.field_75345_d <= 0) {
            ...
            this.entityOwner.getNavigator()
                .tryMoveToEntityLiving(this.entityOwner.getTwin(), this.speed);
        }
    }
}
