...
public class EntityEndDragon extends EntityTameable
{
    ...
    public EntityEndDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    public EntityEndDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityEndDragon entitybirchdragon = new EntityEndDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityEndDragon)) {
            return false;
        }
        final EntityEndDragon entitybirchdragon = (EntityEndDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityEndDragon) {
                final EntityEndDragon entitybirchdragon = (EntityEndDragon)p_142018_1_;
