...
public class EntityRedstoneDragon extends DecoyCaveDragonTameable
{
    ...
    public EntityRedstoneDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    public EntityRedstoneDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityRedstoneDragon entityalpsdragon = new EntityRedstoneDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityRedstoneDragon)) {
            return false;
        }
        final EntityRedstoneDragon entityalpsdragon = (EntityRedstoneDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityRedstoneDragon) {
                final EntityRedstoneDragon entityalpsdragon = (EntityRedstoneDragon)p_142018_1_;
