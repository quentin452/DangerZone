...
public class MagicExplode extends EntityThrowable {
    ...
    public MagicExplode(final World par1World) {
        super(par1World);
        this.my_rotation = 0.0f;
        this.my_index = 50;
    }

    public MagicExplode(final World par1World, final EntityLivingBase par2EntityLiving) {
        super(par1World, par2EntityLiving);
        this.my_rotation = 0.0f;
        this.my_index = 50;
    }

    public MagicExplode(final World worldObj, final double d, final double e, final double f) {
