...
public class RenderExHillsDragon extends RenderLiving {

    private static final ResourceLocation texture;
    private ModelBase scaleAmount;

    public RenderExHillsDragon() {
        super(new ModelTinyDragon(), 0.55f);
    }

    public RenderExHillsDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderExHillsDragon.texture;
    }
