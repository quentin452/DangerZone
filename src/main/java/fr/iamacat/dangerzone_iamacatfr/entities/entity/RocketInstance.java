...
public class RocketInstance extends EntityThrowable {

    public RocketInstance(final World par1World) {
        super(par1World);
    }

    public RocketInstance(final World par1World, final EntityLivingBase par3EntityPlayer) {
        super(par1World, par3EntityPlayer);
    }

    public RocketInstance(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
    }

    public RocketInstance(final World par1World, final double par2, final double par4, final double par6) {
