...
public class MiningChunkProvider implements IChunkProvider {

    private Random rand;
    private ArrayList MyMobList;
    ...
    public MiningChunkProvider(final World par1World, final long par2, final boolean par4) {
        this.MyMobList = null;
        this.MyCritterList = null;
    ...
    public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        if (TerrainGen.populate(
            ...
            par3,
            flag,
            PopulateChunkEvent.Populate.EventType.LAVA) && !flag && this.rand.nextInt(8) == 0) {
            final int k2 = k + this.rand.nextInt(16) + 8;
        ...
        for (doGen = TerrainGen.populate(
            ...
            par3,
            flag,
            PopulateChunkEvent.Populate.EventType.DUNGEON), k2 = 0; doGen && k2 < 8; ++k2) {
            dungeonL2 = k + this.rand.nextInt(16) + 8;
            i2 = this.rand.nextInt(256);
            j2 = l + this.rand.nextInt(16) + 8;
            new WorldGenDungeons().generate(this.worldObj, this.rand, dungeonL2, i2, j2);
        }
        ...
        for (doGen = TerrainGen.populate(
            ...
            par3,
            flag,
            PopulateChunkEvent.Populate.EventType.ICE), k2 = 0; doGen && k2 < 16; ++k2) {
            for (int l2 = 0; l2 < 16; ++l2) {
                i2 = this.worldObj.getPrecipitationHeight(k + k2, l + l2);
                if (this.worldObj.isBlockFreezable(k2 + k, i2 - 1, l2 + l)) {
                    this.worldObj.setBlock(k2 + k, i2 - 1, l2 + l, Blocks.ice, 0, 2);
                }
                if (this.worldObj.func_147478_e(k2 + k, i2, l2 + l, true)) {
                    this.worldObj.setBlock(k2 + k, i2, l2 + l, Blocks.snow_layer, 0, 2);
                }
            }
        }
            ...
            if (par1EnumCreatureType == EnumCreatureType.monster) {
                if (this.MyMobList == null) {
                    this.MyMobList = new ArrayList();
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry(AlosaurusInstance.class, 8, 1, 2));
                        ...
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry(AlienInstance.class, 35, 2, 3));
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry(CaveFisherInstance.class, 35, 4, 8));
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry(CryolophosaurusInstance.class, 26, 4, 7));
                        this.MyMobList.add(new BiomeGenBase.SpawnListEntry(Spyro.class, 5, 1, 2));
                    for (final Object var7 : l) {
                        this.MyMobList.add(var7);
                    }
                }
            ...
            if (par1EnumCreatureType == EnumCreatureType.ambient) {
                if (this.MyAmbientList == null) {
                    this.MyAmbientList = new ArrayList();
                        ...
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(DragonflyInstance.class, 2, 1, 3));
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(CamarasaurusInstance.class, 1, 2, 4));
                        this.MyAmbientList.add(new BiomeGenBase.SpawnListEntry(BaryonyxInstance.class, 2, 4, 8));
                    for (final Object var7 : l) {
                        this.MyAmbientList.add(var7);
                    }
                }
    ...
    public void recreateStructures(final int par1, final int par2) {
        if (this.mapFeaturesEnabled) {
            ...
            this.scatteredFeatureGenerator
                .func_151539_a((IChunkProvider) this, this.worldObj, par1, par2, (Block[]) null);
        }
    }
}
