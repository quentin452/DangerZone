...
public class EntityKleurloos extends EntityTameable
{
    ...
    public EntityKleurloos(final World p_i1696_1_) {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(8, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.2, ItemInitDangerZone.pureRainbowOpalGem, false));
        this.tasks.addTask(9, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.2, ItemInitDangerZone.pureRainbowOpalGem, false));
    ...
    protected String getLivingSound() {
        return this.isAngry() ?   Tags.MODID + ":mob.kleurloos.kleurloos" : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f) ?   Tags.MODID + ":mob.kleurloos.kleurloos" :   Tags.MODID + ":mob.kleurloos.kleurloos") :   Tags.MODID + ":mob.kleurloos.kleurloos");
    }

    protected String getHurtSound() {
        return   Tags.MODID + ":mob.kleurloos.kleurloos";
    }
    ...
    public boolean interact(final EntityPlayer p_70085_1_) {
        ...
        else if (itemstack != null && itemstack.getItem() == ItemInitDangerZone.pureRainbowOpalGem && !this.isAngry()) {
            if (!p_70085_1_.capabilities.isCreativeMode) {
    ...
    public EntityKleurloos createChild(final EntityAgeable p_90011_1_) {
        final EntityKleurloos entityalpsdragon = new EntityKleurloos(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityKleurloos)) {
            return false;
        }
        final EntityKleurloos entityalpsdragon = (EntityKleurloos)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityKleurloos) {
                final EntityKleurloos entityalpsdragon = (EntityKleurloos)p_142018_1_;
