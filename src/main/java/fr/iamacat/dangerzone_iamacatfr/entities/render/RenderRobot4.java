...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.Robot4;
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelRobot4;
...
public class RenderRobot4 extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation(Tags.MODID+":Robot4.png");
    }
}
