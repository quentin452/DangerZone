...
public class BasilikInstance extends EntityMob
{
    public BasilikInstance(final World world) {
        ...
        this.tasks.addTask(3, (EntityAIBase)new EntityAIAttackOnCollide((EntityCreature)this, (Class)EntityVillager.class, 1.0, true));
        ...
        //this.tasks.addTask(9, (EntityAIBase)new EntityAIAvoidEntity((EntityCreature)this, (Class)EntityFungleCrab.class, 6.0f, 1.0, 1.2));
