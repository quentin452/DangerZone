...
public class MyMagic extends EntityThrowable {
    ...
    public MyMagic(final World par1World) {
        super(par1World);
        this.magictype = 0;
        this.myage = 0;
    ...
    public MyMagic(final World par1World, final int par2) {
        super(par1World);
        this.magictype = 0;
        this.myage = 0;
        this.my_rotation = 0.0f;
    ...
    public MyMagic(final World par1World, final EntityLivingBase par2EntityLiving) {
    ...
    public MyMagic(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
        this.magictype = 0;
        this.myage = 0;
        this.my_rotation = 0.0f;
    ...
    public MyMagic(final World par1World, final double par2, final double par4, final double par6) {
