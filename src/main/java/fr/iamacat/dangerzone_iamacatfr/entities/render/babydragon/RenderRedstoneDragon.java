...
public class RenderRedstoneDragon extends RenderLiving
{
    private static final ResourceLocation texture;
    private ModelBase scaleAmount;

    public RenderRedstoneDragon() {
        super((ModelBase)new ModelTinyDragon(), 0.55f);
    }

    public RenderRedstoneDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderRedstoneDragon.texture;
    }
    ...
    static {
        texture = new ResourceLocation(Tags.MODID +":textures/entity/babydragon/redstone.png");
    }
}
