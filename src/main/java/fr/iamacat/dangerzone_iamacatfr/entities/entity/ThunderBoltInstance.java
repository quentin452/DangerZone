...
public class ThunderBoltInstance extends EntityThrowable {

    public ThunderBoltInstance(final World par1World) {
        super(par1World);
    }

    public ThunderBoltInstance(final World par1World, final EntityLivingBase par3EntityPlayer) {
        super(par1World, par3EntityPlayer);
    }

    public ThunderBoltInstance(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
    }

    public ThunderBoltInstance(final World par1World, final double par2, final double par4, final double par6) {
