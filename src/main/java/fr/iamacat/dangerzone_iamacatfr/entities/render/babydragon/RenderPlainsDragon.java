...
public class RenderPlainsDragon extends RenderLiving {
    ...
    public RenderPlainsDragon() {
        super(new ModelTinyDragon(), 0.55f);
    }

    public RenderPlainsDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderPlainsDragon.texture;
    }
