...
public class Rotator extends EntityMob {
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote && this.worldObj.rand.nextInt(10) == 1) {
            this.worldObj.spawnParticle(
                ...
                this.posZ,
                ((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 4.0f),
                ((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 4.0f),
                ((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) / 4.0f));
        }
        this.busy_fighting = 0;
    ...
    protected void updateAITasks() {
        ...
        if (this.rand.nextInt(300) == 0
            ...
            if (e != null) {
                ...
                this.currentFlightTarget
                    .set((int) (e.posX + 2.5 * Math.cos(a)), (int) e.posY, (int) (e.posZ + 2.5 * Math.sin(a)));
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        return !(par1EntityLiving instanceof TermiteInstance) && !(par1EntityLiving instanceof Vortex)
            && !(par1EntityLiving instanceof Rotator)
            && !(par1EntityLiving instanceof DungeonBeastInstance)
            ...
            && !(par1EntityLiving instanceof CloudSharkInstance)
            && !(par1EntityLiving instanceof Mothra)
            && !(par1EntityLiving instanceof BeeInstance)
    ...
    protected Item getDropItem() {
        ...
        if (i == 1) {
            return ItemInitDangerZone.TigersEyeIngot;
        }
        if (i == 2) {
            return Item.getItemFromBlock(BlockInitDangerZone.CrystalCoal);
        }
        if (i == 3) {
