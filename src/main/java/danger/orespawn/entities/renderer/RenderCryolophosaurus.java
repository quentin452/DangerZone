...
import danger.orespawn.entities.entityinstance.Cryolophosaurus;
import danger.orespawn.entities.model.ModelCryolophosaurus;
...
public class RenderCryolophosaurus extends RenderLiving {
    ...
    public void renderCryolophosaurus(final Cryolophosaurus par1EntityCryolophosaurus, final double par2,
    ...
    protected void preRenderScale(final Cryolophosaurus par1Entity, final float par2) {
    ...
    static {
        texture = new ResourceLocation("orespawn", "cryolophosaurus.png");
    }
}
