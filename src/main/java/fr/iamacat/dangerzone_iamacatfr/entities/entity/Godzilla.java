...
public class Godzilla extends EntityMob {
    ...
    protected void updateAITasks() {
      ...
      //  this.dataWatcher.updateObject(21, DangerZone.PlayNicely);
        super.updateAITasks();
        ++this.ticker;
       ...
       /* if (DangerZone.PlayNicely == 0) {
            ...
            if (this.jumped != 0 && this.motionY > -0.1) {
                ...
                this.doJumpDamage(this.posX, this.posY, this.posZ, 10.0, DangerZone.Godzilla_stats.attack * df, 0);
                this.doJumpDamage(this.posX, this.posY, this.posZ, 15.0, DangerZone.Godzilla_stats.attack / 2 * df, 0);
                this.doJumpDamage(this.posX, this.posY, this.posZ, 25.0, DangerZone.Godzilla_stats.attack / 4 * df, 0);
                this.jumped = 0;
            }
        }
        ...
        */
        ...
        if (DangerZone.PlayNicely == 0 && k == 0) {
            this.doJumpDamage(dx, this.posY, dz, 15.0, DangerZone.Godzilla_stats.attack / 2, 1);
        }
    ...
    private EntityLivingBase doJumpDamage(final double X, final double Y, final double Z, final double dist,
        ...
        while (var6.hasNext()) {
            ...
            if (var8 instanceof GhostInstance) {
                continue;
            }
            DamageSource var9;
    ...
    private boolean isCrushable(final Block bid) {
        return bid != null && this.worldObj.getGameRules()
            ...
            && bid != BlockInitDangerZone.UraniumBlock
            && bid != BlockInitDangerZone.TitaniumBlock
            && bid != BlockInitDangerZone.CrystalStone
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            ...
            if (s > 30.0f && !MyUtils.isRoyalty(par1Entity)
                ...
                e.attackEntityFrom(DamageSource.causeMobDamage(this), 175 * 10.0f);
        ...
        if (par1Entity != null && par1Entity instanceof EntityDragon) {
            ...
            if (this.worldObj.rand.nextInt(6) == 1) {
                dr.attackEntityFromPart(dr.dragonPartHead, var21, 175 / 2.0f);
            } else {
                dr.attackEntityFromPart(dr.dragonPartBody, var21, 175 / 2.0f);
            }
        }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int var5 = 50 + this.worldObj.rand.nextInt(30), var6 = 0; var6 < var5; ++var6) {
            this.dropItemRand(ItemInitDangerZone.MobzillaScale, 1);
        }
        ...
        for (int i = 25 + this.worldObj.rand.nextInt(15), var6 = 0; var6 < i; ++var6) {
            ...
            switch (var7) {
                ...
                case 12: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateBow, 1);
                    break;
                }
                case 13: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateAxe, 1);
                    break;
                }
                case 14: {
                ...
                case 15: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimatePickaxe, 1);
                    break;
                }
                case 16: {
                ...
                case 25: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateShovel, 1);
                    break;
                }
                case 26: {
                ...
                case 42: {
                    is = this.dropItemRand(ItemInitDangerZone.ExperienceSword, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.sharpness, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 43: {
                    is = this.dropItemRand(ItemInitDangerZone.ExperienceHelmet, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 44: {
                    is = this.dropItemRand(ItemInitDangerZone.ExperienceChestplate, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 45: {
                    is = this.dropItemRand(ItemInitDangerZone.ExperienceLeggings, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 46: {
                    is = this.dropItemRand(ItemInitDangerZone.ExperienceBoots, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.featherFalling, 5 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(2) == 1) {
                ...
                case 47: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystSword, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.sharpness, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 48: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystShovel, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 49: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystPickaxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 50: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystAxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 51: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystHoe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 52: {
                    is = this.dropItemRand(Item.getItemFromBlock(BlockInitDangerZone.AmethystBlock), 1);
                    break;
                }
                case 53: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystHelmet, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 54: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystChestplate, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 56: {
                    is = this.dropItemRand(ItemInitDangerZone.AmethystBoots, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.featherFalling, 5 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(2) == 1) {
                ...
                case 57: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyHelmet, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 58: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyChestplate, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 59: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyLeggings, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 60: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyBoots, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.featherFalling, 5 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(2) == 1) {
                ...
                case 61: {
                    is = this.dropItemRand(ItemInitDangerZone.RubySword, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.sharpness, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 62: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyShovel, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 63: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyPickaxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 64: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyAxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 65: {
                    is = this.dropItemRand(ItemInitDangerZone.RubyHoe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 66: {
                    is = this.dropItemRand(Item.getItemFromBlock(BlockInitDangerZone.RubyBlock), 1);
                    break;
                }
                case 67: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateHelmet, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 68: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateChestplate, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 69: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateLeggings, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 70: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateBoots, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.featherFalling, 5 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(2) == 1) {
                ...
                case 75: {
                    is = this.dropItemRand(ItemInitDangerZone.UltimateHoe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
