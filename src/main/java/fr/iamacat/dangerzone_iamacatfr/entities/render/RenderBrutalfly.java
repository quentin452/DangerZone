...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.BrutalflyInstance;
...
public class RenderBrutalfly extends RenderLiving {
    ...
    public void renderBrutalfly(final BrutalflyInstance par1Brutalfly, final double par2, final double par4, final double par6,
    ...
    public void doRender(final EntityLiving par1EntityLiving, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.renderBrutalfly((BrutalflyInstance) par1EntityLiving, par2, par4, par6, par8, par9);
    }

    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.renderBrutalfly((BrutalflyInstance) par1Entity, par2, par4, par6, par8, par9);
    }

    protected void preRenderScale(final BrutalflyInstance par1Entity, final float par2) {
        GL11.glScalef(this.scale, this.scale, this.scale);
    }

    protected void preRenderCallback(final EntityLivingBase par1EntityLiving, final float par2) {
        this.preRenderScale((BrutalflyInstance) par1EntityLiving, par2);
    }
