...
public class RandomPositionGenerator {
    ...
    private static Vec3 findRandomTargetBlock(final GenericCreatureInstance par0EntityCreature, final int par1,
        ...
        if (par0EntityCreature.hasHome()) {
            final double var10 = par0EntityCreature.getHomePosition()
                .getDistanceSquared(
                    MathHelper.floor_double(par0EntityCreature.posX),
                    MathHelper.floor_double(par0EntityCreature.posY),
                    MathHelper.floor_double(par0EntityCreature.posZ))
                + 4.0f;
    ...
    private static Vec3 flyToRandomTargetBlockAtHeight(final GenericCreatureInstance entity, final int par1,
        ...
        boolean var12;
        if (entity.hasHome()) {
            final double var10 = entity.getHomePosition()
                .getDistanceSquared(
        ...
        for (int var13 = 0; var13 < 10; ++var13) {
            ...
            int var15;
            if (entity.posY
                > entity.worldObj.getPrecipitationHeight((int) entity.posX, (int) entity.posZ) + heightLevel * 1.25) {
                var15 = var4.nextInt(2 * par2) - par2 * 3 / 2;
            } else if (entity.posY
                < entity.worldObj.getPrecipitationHeight((int) entity.posX, (int) entity.posZ) + heightLevel) {
