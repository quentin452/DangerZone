...
public class AIFollowOwner extends EntityAIBase {
    ...
    public AIFollowOwner(final EntityTameable par1EntityTameable, final float par2, final float par3,
        final float par4) {
    ...
    public boolean shouldExecute() {
        ...
        return !this.thePet.isSitting()
            && ((this.thePet != null && (this.thePet.posY < 60.0 || !this.thePet.worldObj.isDaytime())
                ...
                || this.thePet.getDistanceSqToEntity((Entity) var1) >= this.maxDist * this.maxDist);
    }
    ...
    public void updateTask() {
        ...
        if (!this.thePet.isSitting() && --this.field_75343_h <= 0) {
            ...
            if (!this.petPathfinder.tryMoveToEntityLiving((Entity) this.theOwner, (double) this.field_75336_f)
