...
import danger.orespawn.entities.entityinstance.HerculesBeetle;
import danger.orespawn.entities.model.ModelHerculesBeetle;
...
public class RenderHerculesBeetle extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "Beetletexture.png");
    }
}
