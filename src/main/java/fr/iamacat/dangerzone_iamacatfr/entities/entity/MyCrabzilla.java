...
public class MyCrabzilla extends EntityTameable {
    ...
    public MyCrabzilla(final World par1World) {
        ...
        this.tasks.addTask(2, (EntityAIBase) new AIFollowOwner((EntityTameable) this, 2.0f, 10.0f, 2.0f));
        this.tasks
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj
            .getEntitiesWithinAABB((Class) EntityLivingBase.class, this.boundingBox.expand(64.0, 64.0, 64.0));
