...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.MavisBall;
import fr.iamacat.dangerzone_iamacatfr.util.Tags;

@SideOnly(Side.CLIENT)
public class RenderOrbMavis extends Render {

    public static ResourceLocation texture;

    public void renderBall(final MavisBall par1EntityArrow, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.bindTexture(RenderOrbMavis.texture);
        GL11.glPushMatrix();
    ...
    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.renderBall((MavisBall) par1Entity, par2, par4, par6, par8, par9);
    }

    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderOrbMavis.texture;
    }

    static {
        RenderOrbMavis.texture = new ResourceLocation(Tags.MODID + ":textures/items/mavisorb.png");
    }
}
