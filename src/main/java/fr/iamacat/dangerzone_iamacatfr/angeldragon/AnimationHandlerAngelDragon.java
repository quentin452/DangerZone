...
public class AnimationHandlerAngelDragon extends AnimationHandler
{
    ...
    @Override
    public void fireAnimationEventClientSide(fr.iamacat.dangerzone_iamacatfr.MCACommonLibrary.animation.Channel p0, float p1, float p2) {

    }

    @Override
    public void fireAnimationEventServerSide(fr.iamacat.dangerzone_iamacatfr.MCACommonLibrary.animation.Channel p0, float p1, float p2) {

    }

    static {
        (AnimationHandlerAngelDragon.animChannels = new HashMap<String, Channel>()).put("Living", new ChannelLiving("Living", 1.0f, 4, (byte)1));
