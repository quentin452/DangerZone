...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.ProjectileApples;
import fr.iamacat.dangerzone_iamacatfr.util.Tags;

@SideOnly(Side.CLIENT)
public class RenderApples extends Render {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        final ProjectileApples r = (ProjectileApples) entity;
        return RenderApples.textureapls;
    }
