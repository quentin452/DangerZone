...
public class TwilicornArrow extends EntityThrowable {

    public TwilicornArrow(final World par1World) {
        super(par1World);
        this.setSize(1.1f, 1.1f);
    }

    public TwilicornArrow(final World par1World, final EntityLivingBase par3EntityPlayer) {
        super(par1World, par3EntityPlayer);
    }

    public TwilicornArrow(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
    }

    public TwilicornArrow(final World par1World, final double par2, final double par4, final double par6) {
