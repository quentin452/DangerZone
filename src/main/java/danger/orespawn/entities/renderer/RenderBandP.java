...
import danger.orespawn.entities.entityinstance.BandP;
import danger.orespawn.entities.model.ModelBandP;
...
public class RenderBandP extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "BandPtexture.png");
    }
}
