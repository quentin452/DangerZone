...
public class WindigoPowerInstance extends EntityThrowable {

    public WindigoPowerInstance(final World par1World) {
        super(par1World);
        this.setSize(2.2f, 2.2f);
    }

    public WindigoPowerInstance(final World par1World, final EntityLivingBase par3EntityPlayer) {
        super(par1World, par3EntityPlayer);
    }

    public WindigoPowerInstance(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
    }

    public WindigoPowerInstance(final World par1World, final double par2, final double par4, final double par6) {
        super(par1World, par2, par4, par6);
    }

    protected void onImpact(final MovingObjectPosition par1MovingObjectPosition) {
        if (par1MovingObjectPosition.entityHit != null) {
            if (par1MovingObjectPosition.entityHit instanceof WindigoInstance) {
                return;
            }
