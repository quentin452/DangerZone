...
public class EntityAIVultureFollow extends EntityAIBase
{
    ...
    public EntityAIVultureFollow(final EntityGenericCreature par1EntityLiving, final Class par2Class, final float par3, final boolean par4, final float attackDistanceSq) {
    ...
    public EntityAIVultureFollow(final EntityGenericCreature par1EntityLiving, final Class par2Class, final float par3, final boolean par4) {
    ...
    public EntityAIVultureFollow(final EntityGenericCreature par1EntityLiving, final float par2, final boolean par3, final float attackDistanceSq) {
    ...
    public boolean shouldExecute() {
        ...
        return this.attacker.setTargetPosition(new ChunkCoordinates((int)this.entityTarget.posX, (int)this.entityTarget.posY + this.heightToFollow, (int)this.entityTarget.posZ));
    }
    ...
    public void startExecuting() {
        if (this.attacker.isEntityGrounded()) {
            ...
            this.attacker.setTargetPosition(new ChunkCoordinates((int)this.entityTarget.posX, (int)(this.entityTarget.posY + this.heightToFollow), (int)this.entityTarget.posZ));
        }
