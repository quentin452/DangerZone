    ...
    public void dropBlockAsItemWithChance(final World par1World, final int par2, final int par3, final int par4,
        ...
        if (!par1World.isRemote) {
            if (par1World.rand.nextInt(100) == 1) {
                this.dropBlockAsItem(par1World, par2, par3, par4, new ItemStack(ItemInitDangerZone.CrystalAppleItem));
            }
            if (par1World.rand.nextInt(50) == 1) {
                if (this == BlockInitDangerZone.BlockCrystalLeaves) {
                    this.dropBlockAsItem(
                        par1World,
                        par2,
                        par3,
                        par4,
                        new ItemStack(BlockInitDangerZone.BlockCrystalPlant));
                }
                if (this == BlockInitDangerZone.BlockCrystalLeaves2) {
                    this.dropBlockAsItem(
                        par1World,
                        par2,
                        par3,
                        par4,
                        new ItemStack(BlockInitDangerZone.BlockCrystalPlant2));
                }
                if (this == BlockInitDangerZone.BlockCrystalLeaves3) {
                    this.dropBlockAsItem(
                        par1World,
                        par2,
                        par3,
                        par4,
                        new ItemStack(BlockInitDangerZone.BlockCrystalPlant3));
                }
            }
        }
    }
