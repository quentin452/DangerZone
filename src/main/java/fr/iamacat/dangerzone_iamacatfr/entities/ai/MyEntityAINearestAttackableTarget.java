...
public class MyEntityAINearestAttackableTarget extends MyEntityAITarget {
    ...
    public boolean shouldExecute() {
        ...
        if (this.taskOwner instanceof GirlfriendInstance && !((GirlfriendInstance) this.taskOwner).isTamed()) {
            return false;
        }
        if (this.taskOwner instanceof GirlfriendInstance && ((GirlfriendInstance) this.taskOwner).isSitting()) {
            return false;
        }
