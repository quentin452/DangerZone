...
public class BoyFriendRenderer extends RenderLiving {
    ...
    public BoyFriendRenderer(ModelBiped p_i1257_1_, float p_i1257_2_) {
        this(p_i1257_1_, p_i1257_2_, 1.0F);
    }

    public BoyFriendRenderer(ModelBiped p_i1258_1_, float p_i1258_2_, float p_i1258_3_) {
    ...
    // todo make multiple textures
    private static final ResourceLocation Boyfriend = new ResourceLocation(
