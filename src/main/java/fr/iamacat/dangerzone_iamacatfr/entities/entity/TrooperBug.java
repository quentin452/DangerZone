...
public class TrooperBug extends EntityMob {
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        this.dropItemRand(ItemInitDangerZone.JumpyBugScale, 1);
        this.dropItemRand(Items.item_frame, 1);
        for (int i = 2 + this.worldObj.rand.nextInt(5), var4 = 0; var4 < i; ++var4) {
            this.dropItemRand(ItemInitDangerZone.AmethystIngot, 1);
        }
        for (int i = 1 + this.worldObj.rand.nextInt(5), var4 = 0; var4 < i; ++var4) {
            ...
            switch (var5) {
                case 0: {}
                case 2: {
                    final ItemStack is = this.dropItemRand(Item.getItemFromBlock(BlockInitDangerZone.AmethystBlock), 1);
                    break;
                }
                case 3: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystSword, 1);
                ...
                case 4: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystShovel, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 5: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystPickaxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 6: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystAxe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 7: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystHoe, 1);
                    if (this.worldObj.rand.nextInt(2) == 1) {
                        is.addEnchantment(Enchantment.unbreaking, 2 + this.worldObj.rand.nextInt(4));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 8: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystHelmet, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 9: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystChestplate, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 10: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystLeggings, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
                        is.addEnchantment(Enchantment.protection, 1 + this.worldObj.rand.nextInt(5));
                    }
                    if (this.worldObj.rand.nextInt(6) == 1) {
                ...
                case 11: {
                    final ItemStack is = this.dropItemRand(ItemInitDangerZone.AmethystBoots, 1);
                    if (this.worldObj.rand.nextInt(6) == 1) {
