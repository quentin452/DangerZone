...
public class MyAJ extends EntityTameable {
    ...
    public MyAJ(final World par1World) {
        super(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyDash) {
            return this.ajismad == 1;
        }
        if (par1EntityLiving instanceof MyDashCloud) {
            return this.ajismad == 1;
        }
        if (par1EntityLiving instanceof MyTwilightMagic) {
            return false;
        }
    ...
    public MyAJ spawnBabyAnimal(final EntityAgeable par1EntityAgeable) {
        final MyAJ w = new MyAJ(this.worldObj);
        if (this.isTamed()) {
