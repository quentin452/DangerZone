...
public class MyBlockFlower extends Block implements IPlantable {
    ...
    protected boolean canPlaceBlockOn(final Block par1) {
        return par1 == Blocks.grass || par1 == Blocks.dirt
            ...
            || par1 == BlockInitDangerZone.CrystalGrass;
    }
    ...
    protected final void checkFlowerChange(final World par1World, final int par2, final int par3, final int par4) {
        ...
        t %= 24000L;
        if (t > 12000L) {
            if (this == BlockInitDangerZone.MyFlowerPinkBlock) {
                par1World.setBlock(par2, par3, par4, BlockInitDangerZone.MyFlowerBlackBlock);
            }
            if (this == BlockInitDangerZone.MyFlowerBlueBlock) {
                par1World.setBlock(par2, par3, par4, BlockInitDangerZone.MyFlowerScaryBlock);
            }
        } else {
            if (this == BlockInitDangerZone.MyFlowerBlackBlock) {
                par1World.setBlock(par2, par3, par4, BlockInitDangerZone.MyFlowerPinkBlock);
            }
            if (this == BlockInitDangerZone.MyFlowerScaryBlock) {
                par1World.setBlock(par2, par3, par4, BlockInitDangerZone.MyFlowerBlueBlock);
            }
        }
    }
