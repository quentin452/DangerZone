...
public class BaryonyxInstance extends EntityMob
{
    public BaryonyxInstance(final World par1World) {
        ...
        this.tasks.addTask(1, (EntityAIBase)new EntityAIAttackOnCollide((EntityCreature)this, (Class)MassoInstance.class, 0.4, false));
        ...
        this.targetTasks.addTask(2, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, (Class)MassoInstance.class, 0, true));
    }
