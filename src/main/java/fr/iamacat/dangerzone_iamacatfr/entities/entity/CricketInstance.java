...
public class CricketInstance extends EntityAnimal {

    public double moveSpeed;
    private int singing;
    private int jumpcount;

    public CricketInstance(final World par1World) {
        super(par1World);
    ...
    private int findBuddies() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(CricketInstance.class, this.boundingBox.expand(20.0, 10.0, 20.0));
        return var5.size();
    }
}
