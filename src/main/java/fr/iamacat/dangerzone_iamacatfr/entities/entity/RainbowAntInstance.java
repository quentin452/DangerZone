...
public class RainbowAntInstance extends EntityAnimal {
    ...
    public boolean interact(final EntityPlayer player) {
        ...
        if (targetDimensionId != DimensionInitDangerZone.VillageDimensionId) {
            destinationDimensionId = DimensionInitDangerZone.VillageDimensionId;
        } else {
    ...
    public RainbowAntInstance(World p_i1743_1_) {
        super(p_i1743_1_);
