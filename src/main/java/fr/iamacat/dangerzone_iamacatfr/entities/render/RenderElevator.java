...
import fr.iamacat.dangerzone_iamacatfr.entities.model.HoverboardModel;
...
public class RenderElevator extends Render {
    ...
    public RenderElevator() {
        ...
        this.modelElevator = (ModelBase) new HoverboardModel();
    }

    public void renderElevator(final HoverboardInstance par1EntityElevator, final double par2, final double par4,
    ...
    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6,
        ...
        this.renderElevator((HoverboardInstance) par1Entity, par2, par4, par6, par8, par9);
    }

    protected ResourceLocation getEntityTexture(final Entity entity) {
        final HoverboardInstance a = (HoverboardInstance) entity;
        return a.getTexture();
    }
}
