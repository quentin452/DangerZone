...
public class BasilikInstance extends EntityMob {
    ...
    public BasilikInstance(final World world) {
        ...
        this.tasks.addTask(
            2,
            new EntityAIAttackOnCollide( this, EntityPlayer.class, 1.0, false));
        this.tasks.addTask(
            3,
            new EntityAIAttackOnCollide( this, EntityVillager.class, 1.0, true));
        ...
        this.tasks
            .addTask(7, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0f));
