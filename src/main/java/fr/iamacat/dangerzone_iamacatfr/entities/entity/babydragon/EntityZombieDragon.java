...
public class EntityZombieDragon extends DecoyOverworldDragonTameable
{
    ...
    public EntityZombieDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    protected String getLivingSound() {
        return this.isAngry() ? "mob.zombie.say" : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f) ? "mob.zombie.say" : "mob.zombie.say") : "mob.zombie.say");
    }
    ...
    public EntityZombieDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityZombieDragon entitybirchdragon = new EntityZombieDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityZombieDragon)) {
            return false;
        }
        final EntityZombieDragon entitybirchdragon = (EntityZombieDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityZombieDragon) {
                final EntityZombieDragon entitybirchdragon = (EntityZombieDragon)p_142018_1_;
