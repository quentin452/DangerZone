...
public class SkullBossRenderer extends RenderLiving {
    ...
    public SkullBossRenderer(final SkullofDoomModel par1ModelBase, final float par2, final float par3) {
    ...
    public void renderMySkullBoss(final SkullBossInstance par1EntityCockatrice, final double par2, final double par4,
    ...
    public void doRenderLiving(final EntityLiving par1EntityLiving, final double par2, final double par4,
        final double par6, final float par8, final float par9) {
        this.renderMySkullBoss((SkullBossInstance) par1EntityLiving, par2, par4, par6, par8, par9);
    }

    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.renderMySkullBoss((SkullBossInstance) par1Entity, par2, par4, par6, par8, par9);
    }

    protected void preRenderScale(final SkullBossInstance par1Entity, final float par2) {
        GL11.glScalef(this.scale, this.scale, this.scale);
    }

    protected void preRenderCallback(final EntityLivingBase par1EntityLiving, final float par2) {
        this.preRenderScale((SkullBossInstance) par1EntityLiving, par2);
    }

    protected ResourceLocation getEntityTexture(final Entity entity) {
        return SkullBossRenderer.textureskullb;
    }
