...
public class DarkCrystalRenderer extends Render {
    ...
    private ResourceLocation texture = new ResourceLocation(Tags.MODID + "textures/entity/DarkCrystal.png");
    public ModelBase model;

    public DarkCrystalRenderer() {
        super();
        this.model = new DarkCrystalModel();
    }

    @Override
    public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
        float p_76986_9_) {
        this.doRender((DarkCrystalInstance) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }

    public void doRender(DarkCrystalInstance entity, double par2, double par3, double par4, float par5, float par6) {
        float f = 1.425F;
        float f1 = 0.025F;
        GL11.glPushMatrix();
