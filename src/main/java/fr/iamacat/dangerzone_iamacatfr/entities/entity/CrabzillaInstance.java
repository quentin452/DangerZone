...
public class CrabzillaInstance extends EntityTameable {
    ...
    public CrabzillaInstance(final World par1World) {
        super(par1World);
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof CrabzillaInstance) {
            return false;
        }
        if (this.dmgDelay <= 0) {
        ...
        if (e != null && e instanceof EntityLiving) {
            if (e instanceof CrabzillaInstance) {
                return false;
            }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving) {
        ...
        if (par1EntityLiving instanceof CrabzillaInstance) {
            return false;
        }
    ...
    private EntityLivingBase PinchHarder(final double X, final double Y, final double Z, final double dist,
        ...
        while (var6.hasNext()) {
            var7 = (Entity) var6.next();
            var8 = (EntityLivingBase) var7;
            if (var8 != null && var8 != this && var8.isEntityAlive() && !(var8 instanceof CrabzillaInstance)) {
                DamageSource var9;
    ...
    public CrabzillaInstance spawnBabyAnimal(final EntityAgeable par1EntityAgeable) {
        return null;
    }
