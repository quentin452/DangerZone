...
import danger.orespawn.entities.entityinstance.CaterKiller;
import danger.orespawn.entities.model.ModelCaterKiller;
...
public class RenderCaterKiller extends RenderLiving {
    ...
    protected void preRenderScale(final CaterKiller par1Entity, final float par2) {
