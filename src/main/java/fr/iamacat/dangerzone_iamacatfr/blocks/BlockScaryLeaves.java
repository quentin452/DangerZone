                ...
                for (int var9 = -var7; var9 <= 0; ++var9) {
                    for (int var10 = -var7; var10 <= var7; ++var10) {
                        ...
                        if (totaldist <= 3) {
                            ...
                            if (bid != null
                                && bid.canSustainLeaves(par1World, par2 + var8, par3 + var9, par4 + var10)) {
                                long t = par1World.getWorldTime();
                                t %= 24000L;
                                if (this == BlockInitDangerZone.BlockScaryLeaves && t < 12000L) {
                                    DangerZone.setBlockFast(
                                        par1World,
                                        par2,
                                        par3,
                                        par4,
                                        BlockInitDangerZone.BlockAppleLeaves,
                                        0,
                                        3);
                                }
