...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.Beaver;
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelBeaver;
...
public class RenderBeaver extends RenderLiving {
    ...
    public void renderBeaver(final Beaver par1EntityBeaver, final double par2, final double par4, final double par6,
    ...
    protected void preRenderScale(final Beaver par1Entity, final float par2) {
