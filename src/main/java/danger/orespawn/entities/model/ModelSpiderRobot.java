...
public class ModelSpiderRobot extends ModelBase {
    ...
    public ModelSpiderRobot(final float f1) {
        ...
        (this.Leg1p1 = new ModelRenderer((ModelBase) this, 0, 149)).addBox(-2.0f, -2.0f, 0.0f, 4, 4, 100);
        ...
        (this.Leg1p2 = new ModelRenderer((ModelBase) this, 0, 149)).addBox(-1.5f, -1.5f, 0.0f, 3, 3, 100);
        ...
        (this.Leg1p3 = new ModelRenderer((ModelBase) this, 0, 149)).addBox(-1.0f, -1.0f, 0.0f, 2, 2, 100);
        ...
        (this.Foot = new ModelRenderer((ModelBase) this, 0, 28)).addBox(-3.0f, -3.0f, 93.0f, 6, 6, 6);
        ...
        (this.FootSpike1 = new ModelRenderer((ModelBase) this, 29, 27)).addBox(2.0f, 2.0f, 99.0f, 1, 1, 5);
        ...
        (this.FootSpike2 = new ModelRenderer((ModelBase) this, 29, 34)).addBox(-3.0f, 2.0f, 99.0f, 1, 1, 5);
        ...
        (this.FootSpike3 = new ModelRenderer((ModelBase) this, 43, 27)).addBox(2.0f, -3.0f, 99.0f, 1, 1, 5);
        ...
        (this.FootSpike4 = new ModelRenderer((ModelBase) this, 43, 34)).addBox(-3.0f, -3.0f, 99.0f, 1, 1, 5);
        ...
        (this.AnkleSpike1 = new ModelRenderer((ModelBase) this, 1, 42)).addBox(3.0f, -10.0f, 92.0f, 1, 20, 1);
        ...
        (this.AnkleSpike2 = new ModelRenderer((ModelBase) this, 7, 42)).addBox(-4.0f, -10.0f, 92.0f, 1, 20, 1);
        ...
        (this.AnkleSpike3 = new ModelRenderer((ModelBase) this, 14, 42)).addBox(-10.0f, 3.0f, 92.0f, 20, 1, 1);
        ...
        (this.AnkleSpike4 = new ModelRenderer((ModelBase) this, 14, 46)).addBox(-10.0f, -4.0f, 92.0f, 20, 1, 1);
        ...
        (this.LowerKnee = new ModelRenderer((ModelBase) this, 14, 49)).addBox(-1.5f, -1.5f, -1.0f, 3, 3, 15);
        ...
        (this.UpperKnee = new ModelRenderer((ModelBase) this, 0, 69)).addBox(-2.5f, -2.5f, 81.0f, 5, 5, 20);
        ...
        (this.LegBump1 = new ModelRenderer((ModelBase) this, 52, 50)).addBox(-0.5f, -2.0f, 80.0f, 1, 1, 1);
        ...
        (this.LegBump2 = new ModelRenderer((ModelBase) this, 52, 54)).addBox(-0.5f, -2.0f, 70.0f, 1, 1, 1);
        ...
        (this.LowerKnee2 = new ModelRenderer((ModelBase) this, 0, 96)).addBox(-2.5f, -2.5f, -1.0f, 5, 5, 15);
        ...
        (this.UpperKnee2 = new ModelRenderer((ModelBase) this, 0, 119)).addBox(-3.0f, -3.0f, 81.0f, 6, 6, 20);
        ...
        (this.HipJoint = new ModelRenderer((ModelBase) this, 0, 149)).addBox(-4.0f, -4.0f, 0.0f, 8, 8, 16);
        ...
        (this.BodyCenter = new ModelRenderer((ModelBase) this, 0, 321)).addBox(-18.0f, -12.0f, -21.0f, 36, 24, 51);
        ...
        (this.Abdomen = new ModelRenderer((ModelBase) this, 0, 398)).addBox(-24.0f, -30.0f, 29.0f, 48, 40, 73);
        ...
        (this.Head = new ModelRenderer((ModelBase) this, 0, 256)).addBox(-15.0f, -16.0f, -57.0f, 30, 26, 36);
        this.Head.setRotationPoint(0.0f, -4.0f, 0.0f);
        this.Head.setTextureSize(64, 32);
        this.Head.mirror = true;
        this.setRotation(this.Head, 0.0f, 0.0f, 0.0f);
        (this.Ljaw1 = new ModelRenderer((ModelBase) this, 75, 26)).addBox(-4.0f, 0.0f, -4.0f, 8, 3, 8);
        ...
        (this.Rjaw1 = new ModelRenderer((ModelBase) this, 75, 26)).addBox(-4.0f, 0.0f, -4.0f, 8, 3, 8);
        ...
        (this.Ljaw2 = new ModelRenderer((ModelBase) this, 63, 40)).addBox(0.0f, 1.0f, -3.0f, 21, 2, 6);
        ...
        (this.Rjaw2 = new ModelRenderer((ModelBase) this, 63, 40)).addBox(0.0f, 1.0f, -3.0f, 21, 2, 6);
        ...
        (this.Ljaw3 = new ModelRenderer((ModelBase) this, 0, 18)).addBox(11.0f, 2.0f, 14.0f, 23, 1, 4);
        ...
        (this.Rjaw3 = new ModelRenderer((ModelBase) this, 0, 18)).addBox(11.0f, 2.0f, -17.0f, 23, 1, 4);
        ...
        (this.Tail = new ModelRenderer((ModelBase) this, 130, 0)).addBox(-5.0f, -5.0f, -5.0f, 10, 10, 49);
        this.Tail.setRotationPoint(0.0f, -32.0f, 69.0f);
        this.Tail.setTextureSize(64, 32);
        this.Tail.mirror = true;
        this.setRotation(this.Tail, 0.0f, 0.0f, 0.0f);
        (this.HeadSpike1 = new ModelRenderer((ModelBase) this, 74, 0)).addBox(-1.0f, -1.0f, -10.0f, 2, 2, 21);
        ...
        (this.HeadSpike2 = new ModelRenderer((ModelBase) this, 74, 0)).addBox(-1.0f, -1.0f, -10.0f, 2, 2, 21);
        ...
        (this.Hip1 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
        ...
        (this.Hip2 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
        ...
        (this.Hip3 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
        ...
        (this.Hip4 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
        ...
        (this.Hip5 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
        ...
        (this.Hip6 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
        ...
        (this.Hip7 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
        ...
        (this.Hip8 = new ModelRenderer((ModelBase) this, 70, 60)).addBox(0.0f, 0.0f, 0.0f, 10, 10, 10);
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3,
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            leg1p3.rotateAngleY = rotateAngleY;
            leg1p2.rotateAngleY = rotateAngleY;
            leg1p1.rotateAngleY = rotateAngleY;
            ...
            this.Leg1p2.rotationPointY = this.Leg1p1.rotationPointY
                - (float) Math.sin(this.Leg1p1.rotateAngleX) * 99.0f;
            this.Leg1p2.rotationPointZ = this.Leg1p1.rotationPointZ
                + (float) Math.cos(this.Leg1p1.rotateAngleX) * (float) Math.cos(this.Leg1p1.rotateAngleY) * 99.0f;
            this.Leg1p2.rotationPointX = this.Leg1p1.rotationPointX
                + (float) Math.cos(this.Leg1p1.rotateAngleX) * (float) Math.sin(this.Leg1p1.rotateAngleY) * 99.0f;
            ...
            this.Leg1p3.rotationPointY = this.Leg1p2.rotationPointY
                - (float) Math.sin(this.Leg1p2.rotateAngleX) * 99.0f;
            this.Leg1p3.rotationPointZ = this.Leg1p2.rotationPointZ
                + (float) Math.cos(this.Leg1p2.rotateAngleX) * (float) Math.cos(this.Leg1p2.rotateAngleY) * 99.0f;
            this.Leg1p3.rotationPointX = this.Leg1p2.rotationPointX
                + (float) Math.cos(this.Leg1p2.rotateAngleX) * (float) Math.sin(this.Leg1p2.rotateAngleY) * 99.0f;
