...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.MagicInstance;
import fr.iamacat.dangerzone_iamacatfr.util.Tags;

@SideOnly(Side.CLIENT)
public class MagicTextureRenderer extends Render {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        final MagicInstance r = (MagicInstance) entity;
        if (r.getRockType() == 1) {
            return MagicTextureRenderer.texture1;
        }
        if (r.getRockType() == 2) {
            return MagicTextureRenderer.texture2;
        }
        if (r.getRockType() == 3) {
            return MagicTextureRenderer.texture3;
        }
        if (r.getRockType() == 4) {
            return MagicTextureRenderer.texture4;
        }
        if (r.getRockType() == 5) {
            return MagicTextureRenderer.texture5;
        }
        if (r.getRockType() == 6) {
            return MagicTextureRenderer.texture6;
        }
        if (r.getRockType() == 7) {
            return MagicTextureRenderer.texture7;
        }
        if (r.getRockType() == 8) {
            return MagicTextureRenderer.texture8;
        }
        if (r.getRockType() == 9) {
            return MagicTextureRenderer.texture9;
        }
        if (r.getRockType() == 10) {
            return MagicTextureRenderer.texture10;
        }
        if (r.getRockType() == 11) {
            return MagicTextureRenderer.texture11;
        }
        if (r.getRockType() == 12) {
            return MagicTextureRenderer.texture12;
        }
        return MagicTextureRenderer.texture1;
    }
