...
public class RenderNetherDragon extends RenderLiving
{
    private static final ResourceLocation texture;
    private ModelBase scaleAmount;

    public RenderNetherDragon() {
        super((ModelBase)new ModelTinyDragon(), 0.55f);
    }

    public RenderNetherDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderNetherDragon.texture;
    }
    ...
    static {
        texture = new ResourceLocation(Tags.MODID +":textures/entity/babydragon/nether.png");
    }
}
