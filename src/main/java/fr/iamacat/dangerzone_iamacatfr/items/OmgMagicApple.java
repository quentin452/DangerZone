...
public class OmgMagicApple extends Item {
    ...
    public OmgMagicApple() {
        ...
        this.chestContentsList = new WeightedRandomChestContent[] {
            ...
            // new WeightedRandomChestContent(ItemInitDangerZone.CageEmpty, 0, 1, 10, 7), todo
            // new WeightedRandomChestContent(DangerZone.CagedGirlfriend, 0, 1, 2, 6), todo
            new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 10, 16),
            new WeightedRandomChestContent(Items.gold_ingot, 0, 1, 6, 16),
            new WeightedRandomChestContent(ItemInitDangerZone.UraniumIngot, 0, 1, 6, 6),
            new WeightedRandomChestContent(ItemInitDangerZone.TitaniumIngot, 0, 1, 4, 6),
            ...
            new WeightedRandomChestContent(ItemInitDangerZone.SunFish, 0, 1, 4, 6),
            new WeightedRandomChestContent(ItemInitDangerZone.FireFish, 0, 1, 8, 6),
            new WeightedRandomChestContent(ItemInitDangerZone.PopCornBag, 0, 1, 4, 16),
    ...
    private Boolean isBoringBlock(final World world, final int x, final int y, final int z) {
        ...
        if (var1 == BlockInitDangerZone.BlockStrawberry) {
            return true;
        }
        if (var1 == BlockInitDangerZone.BlockAppleLeaves) {
            return true;
        }
                                ...
                                if (tree_type >= 0) {
                                    ...
                                    if (this.rand.nextInt(20) == 1) {
                                        if (this.rand.nextInt(3) != 0) {
                                            ...
                                            if (ilt == 0) {
                                                local_leaf_type = BlockInitDangerZone.UraniumBlock;
                                            }
                                            if (ilt == 1) {
                                                local_leaf_type = BlockInitDangerZone.TitaniumBlock;
                                            }
                                            if (ilt == 2) {
                                                local_leaf_type = BlockInitDangerZone.RubyBlock;
                                            }
                                            if (ilt == 3) {
                                                local_leaf_type = BlockInitDangerZone.AmethystBlock;
                                            }
                                        }
                                    }
    ...
    public void MakeBigSquareTree(final World world, final int x, final int y, final int z, final Block ID,
        ...
        if (this.isBoringBaseBlock(world, x, current_y, z)) {
            ...
            if (stepID == BlockInitDangerZone.AmethystBlock) {
                Entity var8;
    ...
    public void FastSetBlock(final World world, final int ix, final int iy, final int iz, final Block id, final int im,
        ...
        DangerZone.setBlockSuperFast(world, ix, iy, iz, id, im, 2, chunk);
    }
