...
public class CrabInstance extends EntityMob {
    ...
    public CrabInstance(final World par1World) {
        super(par1World);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
            .setBaseValue((24 * this.getCrabScale()));
    }
    ...
    public int mygetMaxHealth() {
        return (int) (180 * this.getCrabScale());
    }

    public int getTotalArmorValue() {
        return 16 + (int) (2.0f * this.getCrabScale());
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int var6 = 0; var6 < var5; ++var6) {
            this.dropItemRand(ItemInitDangerZone.CrabMeat, 1);
        }
    }
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        final boolean var4 = par1Entity
            .attackEntityFrom(DamageSource.causeMobDamage(this), 24 * this.getCrabScale());
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof CrabInstance) {
            return false;
        }
    ...
    private int findBuddies() {
        final List var5 = this.worldObj.getEntitiesWithinAABB(CrabInstance.class, this.boundingBox.expand(24.0, 8.0, 24.0));
        return var5.size();
    }
