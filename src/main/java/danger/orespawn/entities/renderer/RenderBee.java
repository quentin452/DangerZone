...
import danger.orespawn.entities.model.ModelBee;
...
public class RenderBee extends RenderLiving {
    ...
    public RenderBee(final ModelBee par1ModelBase, final float par2, final float par3) {
    ...
    protected void preRenderScale(final Bee par1Entity, final float par2) {
    ...
    static {
        texture = new ResourceLocation("orespawn", "Beetexture.png");
    }
}
