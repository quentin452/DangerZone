...
public class ModelCreepingHorror extends ModelBase {
    ...
    public ModelCreepingHorror() {
        ...
        (this.body = new ModelRenderer((ModelBase) this, 0, 30)).addBox(-4.0f, -5.0f, -4.0f, 8, 8, 8);
        this.body.setRotationPoint(0.0f, 20.0f, 0.0f);
        this.body.setTextureSize(128, 128);
        this.body.mirror = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        (this.leg1 = new ModelRenderer((ModelBase) this, 65, 0)).addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2);
        ...
        (this.leg1part2 = new ModelRenderer((ModelBase) this, 37, 5)).addBox(13.01f, -1.01f, -1.0f, 2, 5, 2);
        ...
        (this.leg2 = new ModelRenderer((ModelBase) this, 65, 0)).addBox(-1.0f, -1.0f, -1.0f, 16, 2, 2);
        ...
        (this.leg2part2 = new ModelRenderer((ModelBase) this, 37, 5)).addBox(13.01f, -1.01f, -1.0f, 2, 5, 2);
        ...
        (this.leg3 = new ModelRenderer((ModelBase) this, 28, 0)).addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2);
        ...
        (this.leg3part2 = new ModelRenderer((ModelBase) this, 28, 5)).addBox(-15.01f, -1.01f, -1.0f, 2, 5, 2);
        ...
        (this.leg4 = new ModelRenderer((ModelBase) this, 28, 0)).addBox(-15.0f, -1.0f, -1.0f, 16, 2, 2);
        ...
        (this.leg4part2 = new ModelRenderer((ModelBase) this, 28, 5)).addBox(-15.01f, -1.01f, -1.0f, 2, 5, 2);
        ...
        (this.tailseg1 = new ModelRenderer((ModelBase) this, 0, 13)).addBox(-2.0f, -1.0f, 0.0f, 4, 2, 7);
        ...
        (this.tailseg2 = new ModelRenderer((ModelBase) this, 0, 0)).addBox(-1.0f, 3.0f, 7.0f, 2, 1, 11);
        ...
        (this.tailseg3 = new ModelRenderer((ModelBase) this, 0, 24)).addBox(-1.5f, 1.0f, 6.0f, 3, 2, 2);
        ...
        (this.pincer1 = new ModelRenderer((ModelBase) this, 26, 30)).addBox(-0.5f, -0.5f, -5.0f, 1, 1, 5);
        ...
        (this.pincer1part2 = new ModelRenderer((ModelBase) this, 26, 30)).addBox(-0.5f, -0.5f, -5.01f, 2, 1, 0);
        ...
        (this.pincer2 = new ModelRenderer((ModelBase) this, 26, 30)).addBox(-0.5f, -0.5f, -5.0f, 1, 1, 5);
        ...
        (this.pincer2part2 = new ModelRenderer((ModelBase) this, 26, 28)).addBox(-1.5f, -0.5f, -5.01f, 2, 1, 0);
        ...
        (this.spike1 = new ModelRenderer((ModelBase) this, 26, 13)).addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6);
        ...
        (this.spike2 = new ModelRenderer((ModelBase) this, 26, 13)).addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6);
        ...
        (this.spike3 = new ModelRenderer((ModelBase) this, 26, 13)).addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6);
        ...
        (this.spike4 = new ModelRenderer((ModelBase) this, 26, 13)).addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6);
        ...
        (this.spike5 = new ModelRenderer((ModelBase) this, 26, 13)).addBox(-0.5f, -0.5f, 0.0f, 1, 1, 6);
        ...
        (this.insides1 = new ModelRenderer((ModelBase) this, 0, 30)).addBox(-2.0f, -3.0f, -3.0f, 4, 4, 0);
        ...
        (this.insides2 = new ModelRenderer((ModelBase) this, -1, 29)).addBox(-2.0f, -3.0f, -4.0f, 4, 0, 1);
        ...
        (this.insides3 = new ModelRenderer((ModelBase) this, -1, 29)).addBox(-2.0f, 1.0f, -4.0f, 4, 0, 1);
        ...
        (this.insides4 = new ModelRenderer((ModelBase) this, 0, 29)).addBox(-2.0f, -3.0f, -4.0f, 0, 4, 1);
        ...
        (this.insides5 = new ModelRenderer((ModelBase) this, 0, 29)).addBox(2.0f, -3.0f, -4.0f, 0, 4, 1);
