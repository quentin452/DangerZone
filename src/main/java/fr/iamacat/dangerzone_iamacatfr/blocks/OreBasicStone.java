...
public class OreBasicStone extends Block {
    ...
    public void onBlockDestroyedByPlayer(final World par1World, final int par2, final int par3, final int par4,
        final int par5) {
        if (!par1World.isRemote && this == BlockInitDangerZone.CrystalRat) {
        ...
        if (!par1World.isRemote && this == BlockInitDangerZone.CrystalFairy) {
        ...
        if (!par1World.isRemote && this == BlockInitDangerZone.TrollBlock1) {
        ...
        if (!par1World.isRemote && this == BlockInitDangerZone.TermiteTroll) {
            for (int num = 15 + par1World.rand.nextInt(6), i = 0; i < num; ++i) {
                spawnCreature(
                    par1World,
                    0,
    ...
    public boolean isOpaqueCube() {
        return DangerZone.current_dimension == DimensionInitDangerZone.CrystalDimensionId;
    }
