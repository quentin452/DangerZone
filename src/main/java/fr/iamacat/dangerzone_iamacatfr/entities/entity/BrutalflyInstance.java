...
public class BrutalflyInstance extends EntityMob {
    ...
    public BrutalflyInstance(final World par1World) {
        super(par1World);
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof BrutalflyInstance) {
            return false;
        }
    ...
    public boolean getCanSpawnHere() {
        ...
        BrutalflyInstance target;
        target = (BrutalflyInstance) this.worldObj
            .findNearestEntityWithinAABB(BrutalflyInstance.class, this.boundingBox.expand(64.0, 32.0, 64.0), this);
        return target == null;
    }
