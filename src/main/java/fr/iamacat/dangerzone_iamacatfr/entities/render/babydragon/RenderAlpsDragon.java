...
public class RenderAlpsDragon extends RenderLiving {
    ...
    public RenderAlpsDragon() {
        super(new ModelTinyDragon(), 0.55f);
    }

    public RenderAlpsDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderAlpsDragon.texture;
    }
