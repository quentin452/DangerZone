...
public class RenderDiamondDragon extends RenderLiving {
    ...
    public RenderDiamondDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderDiamondDragon.texture;
    }
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":textures/entity/babydragon/diamond.png");
    }
}
