...
public class MyFlameDragon extends EntityTameable {
    ...
    public MyFlameDragon(final World par1World) {
        super(par1World);
    ...
    public MyFlameDragon(final World par1World, final double par2, final double par4, final double par6) {
        this(par1World);
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof MyFlameDragon) {
            return false;
        }
