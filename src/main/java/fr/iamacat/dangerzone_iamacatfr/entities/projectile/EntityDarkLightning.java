...
public class EntityDarkLightning extends EntityProjectile {
	...
	protected void onImpact(MovingObjectPosition var1) {
		...
		{
			if (var1.entityHit != null && !(var1.entityHit instanceof BeeInstance) && !(var1.entityHit instanceof EntityDarkCrystal) && !(var1.entityHit instanceof EntityDarkLightning))
			{
