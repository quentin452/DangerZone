...
public class EntityAngelDragon extends DecoySkyDragonTameable
{
    ...
    protected String getLivingSound() {
        return this.isAngry() ? Tags.MODID + ":mob.angeldragon.ad" : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f) ? Tags.MODID + ":mob.angeldragon.ad" : Tags.MODID + ":mob.angeldragon.tinydragon") : Tags.MODID + ":mob.angeldragon.ad");
    }
        ...
        if (this.isWet()) {
            ...
            if (this.timeWolfIsShaking > 0.4f) {
                ...
                for (int i = (int)(MathHelper.sin((this.timeWolfIsShaking - 0.4f) * 3.1415927f) * 7.0f), j = 0; j < i; ++j) {
                    ...
                    this.worldObj.spawnParticle("splash", this.posX + f2, f + 0.8f, this.posZ + f3, this.motionX, this.motionY, this.motionZ);
                }
            }
        }
    }
