...
public class LaserBallInstance extends EntityThrowable {
    ...
    public LaserBallInstance(final World par1World) {
        super(par1World);
    ...
    public LaserBallInstance(final World par1World, final int par2) {
        super(par1World);
        this.my_rotation = 0.0f;
        this.my_index = 81;
        this.is_special = 0;
    ...
    public LaserBallInstance(final World par1World, final EntityLivingBase par2EntityLiving) {
    ...
    public LaserBallInstance(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
        this.my_rotation = 0.0f;
        this.my_index = 81;
        this.is_special = 0;
    ...
    public LaserBallInstance(final World par1World, final double par2, final double par4, final double par6) {
    ...
    protected void onImpact(final MovingObjectPosition par1MovingObjectPosition) {
        if (par1MovingObjectPosition.entityHit != null) {
            ...
            if (par1MovingObjectPosition.entityHit instanceof DragonInstance && this.is_acid == 0) {
                final DragonInstance d = (DragonInstance) par1MovingObjectPosition.entityHit;
            ...
            this.dropItem(ItemInitDangerZone.ItemIrukandji, 1);
        }
        if (this.is_acid == 0) {
            int mx = 10;
