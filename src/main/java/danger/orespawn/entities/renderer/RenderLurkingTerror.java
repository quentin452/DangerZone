...
import danger.orespawn.entities.entityinstance.LurkingTerror;
import danger.orespawn.entities.model.ModelLurkingTerror;
...
public class RenderLurkingTerror extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "LurkingTerror.png");
    }
}
