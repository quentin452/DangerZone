...
public class TwilightCannon extends EntityThrowable {

    private float my_rotation;
    private int my_index;

    public TwilightCannon(final World par1World) {
        super(par1World);
        this.my_rotation = 0.0f;
        this.my_index = 50;
    }

    public TwilightCannon(final World par1World, final EntityLivingBase par2EntityLiving) {
        super(par1World, par2EntityLiving);
        this.my_rotation = 0.0f;
        this.my_index = 50;
    }

    public TwilightCannon(final World worldObj, final double d, final double e, final double f) {
