...
public class TwilyMagic extends EntityThrowable {

    public TwilyMagic(final World par1World) {
        super(par1World);
        this.setSize(2.0f, 2.0f);
    }

    public TwilyMagic(final World par1World, final EntityLivingBase par3EntityPlayer) {
        super(par1World, par3EntityPlayer);
    }

    public TwilyMagic(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
    }

    public TwilyMagic(final World par1World, final double par2, final double par4, final double par6) {
    ...
    protected void onImpact(final MovingObjectPosition par1MovingObjectPosition) {
        ...
        if (par1MovingObjectPosition.entityHit instanceof TwilyMagic) {
            return;
        }
        if (par1MovingObjectPosition.entityHit instanceof TwilicornArrow) {
            return;
        }
