...
public class Kraken extends EntityMob {
    ...
    public void onUpdate() {
      ...
      /*  if (this.weather_set > 0 && DangerZone.PlayNicely == 0) {
            --this.weather_set;
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ItemStack is = null;
        this.dropItemRand(ItemInitDangerZone.KrakenTooth, 1);
    ...
    protected void updateAITasks() {
       ...
       /* if (this.worldObj.rand.nextInt(400) == 1 && DangerZone.PlayNicely == 0) {
            this.worldObj
        ...
        */
        ...
        } else if (this.caught == null && this.worldObj.rand.nextInt(8) == 1) {
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof AttackSquidInstance) {
            return false;
        }
        ...
        if (par1EntityLiving instanceof DragonInstance) {
            final DragonInstance c = (DragonInstance) par1EntityLiving;
            return c.riddenByEntity == null;
        }
        if (par1EntityLiving instanceof CephadromeInstance) {
            final CephadromeInstance c2 = (CephadromeInstance) par1EntityLiving;
        ...
        return !(par1EntityLiving instanceof EntityChicken) && !(par1EntityLiving instanceof ChipMunkInstance)
