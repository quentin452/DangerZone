...
{
    private static final ResourceLocation cockatriceTextures = new ResourceLocation(Tags.MODID + ":textures/entity/Alosaurus.png");
    ...
    public void renderCockatrice(AlosaurusInstance entity, double par2, double par4, double par6, float par8, float par9)
    {
