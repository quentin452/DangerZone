...
public class EntityAIAttackOnCollide extends EntityAIBase
{
    ...
    public EntityAIAttackOnCollide(final EntityGenericCreature par1EntityLiving, final Class par2Class, final float par3, final boolean par4, final float attackDistanceSq) {
        this.attackTick = 0;
    ...
    public EntityAIAttackOnCollide(final EntityGenericCreature par1EntityLiving, final Class par2Class, final float par3, final boolean par4) {
    ...
    public EntityAIAttackOnCollide(final EntityGenericCreature par1EntityLiving, final float par2, final boolean par3, final float attackDistanceSq) {
