...
public class EmperorScorpion extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
            .setBaseValue(OreSpawnMain.EmperorScorpion_stats.attack);
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int i = 4 + this.worldObj.rand.nextInt(5), var4 = 0; var4 < i; ++var4) {
            this.dropItemRand(Item.getItemFromBlock(Blocks.obsidian), 1);
        }
        ...
        for (int i = 1 + this.worldObj.rand.nextInt(5), var4 = 0; var4 < i; ++var4) {
            ...
            switch (var5) {
                case 0: {
                    final ItemStack is = this.dropItemRand(OreSpawnMain.MyUltimateSword, 1);
                    break;
                }
                case 1: {
                ...
                case 12: {
                    final ItemStack is = this.dropItemRand(OreSpawnMain.MyUltimateBow, 1);
                    break;
                }
            }
        }
        ...
        if (super.attackEntityAsMob(par1Entity)) {
            if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
                ...
                if (this.worldObj.rand.nextInt(3) == 1) {
                    ((EntityLiving) par1Entity).addPotionEffect(new PotionEffect(Potion.poison.id, var2 * 15, 0));
                }
    ...
    public boolean getCanSpawnHere() {
        ...
        target = (EmperorScorpion) this.worldObj
            .findNearestEntityWithinAABB(EmperorScorpion.class, this.boundingBox.expand(20.0, 6.0, 20.0), this);
        return target == null;
    }
}
