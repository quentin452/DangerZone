...
public class ModelDragonfly extends ModelBase {
    ...
    public ModelDragonfly(final float f1) {
        ...
        (this.Shape1 = new ModelRenderer((ModelBase) this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 5, 4, 7);
        this.Shape1.setRotationPoint(0.0f, 16.0f, 0.0f);
        this.Shape1.setTextureSize(64, 64);
        this.Shape1.mirror = true;
        this.setRotation(this.Shape1, 0.0f, 0.0f, 0.0f);
        (this.lfwing = new ModelRenderer((ModelBase) this, 0, 33)).addBox(0.0f, 0.0f, 0.0f, 10, 1, 3);
        ...
        (this.ljaw = new ModelRenderer((ModelBase) this, 5, 27)).addBox(0.0f, 0.0f, 0.0f, 1, 3, 1);
        ...
        (this.tail1 = new ModelRenderer((ModelBase) this, 25, 0)).addBox(-1.0f, 0.0f, 0.0f, 3, 3, 7);
        this.tail1.setRotationPoint(2.0f, 16.0f, 7.0f);
        this.tail1.setTextureSize(64, 64);
        this.tail1.mirror = true;
        this.setRotation(this.tail1, 0.0f, 0.0f, 0.0f);
        (this.tail2 = new ModelRenderer((ModelBase) this, 25, 11)).addBox(0.0f, 0.0f, 0.0f, 1, 2, 9);
        this.tail2.setRotationPoint(2.0f, 16.0f, 14.0f);
        this.tail2.setTextureSize(64, 64);
        this.tail2.mirror = true;
        this.setRotation(this.tail2, 0.0f, 0.0f, 0.0f);
        (this.Shape10 = new ModelRenderer((ModelBase) this, 23, 0)).addBox(-1.0f, 0.0f, 0.0f, 1, 4, 1);
        ...
        (this.Shape11 = new ModelRenderer((ModelBase) this, 40, 0)).addBox(0.0f, 0.0f, -4.0f, 1, 1, 4);
        this.Shape11.setRotationPoint(-1.0f, 21.0f, 0.0f);
        this.Shape11.setTextureSize(64, 64);
        this.Shape11.mirror = true;
        this.setRotation(this.Shape11, 0.0f, 0.0f, 0.0f);
        (this.Shape12 = new ModelRenderer((ModelBase) this, 18, 12)).addBox(-1.0f, 0.0f, 0.0f, 1, 3, 1);
        ...
        (this.Shape13 = new ModelRenderer((ModelBase) this, 18, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 4, 1);
        ...
        (this.Shape14 = new ModelRenderer((ModelBase) this, 51, 0)).addBox(0.0f, 0.0f, -4.0f, 1, 1, 4);
        this.Shape14.setRotationPoint(5.0f, 21.0f, 0.0f);
        this.Shape14.setTextureSize(64, 64);
        this.Shape14.mirror = true;
        this.setRotation(this.Shape14, 0.0f, 0.0f, 0.0f);
        (this.Shape15 = new ModelRenderer((ModelBase) this, 13, 12)).addBox(0.0f, 0.0f, 0.0f, 1, 3, 1);
        ...
        (this.Shape16 = new ModelRenderer((ModelBase) this, 9, 53)).addBox(0.0f, 0.0f, 0.0f, 3, 1, 1);
        ...
        (this.Shape17 = new ModelRenderer((ModelBase) this, 0, 56)).addBox(0.0f, 0.0f, 0.0f, 1, 3, 1);
        ...
        (this.Shape18 = new ModelRenderer((ModelBase) this, 0, 53)).addBox(-3.0f, 0.0f, 0.0f, 3, 1, 1);
        ...
        (this.Shape19 = new ModelRenderer((ModelBase) this, 5, 56)).addBox(-1.0f, 0.0f, 0.0f, 1, 3, 1);
        ...
        (this.Shape20 = new ModelRenderer((ModelBase) this, 9, 61)).addBox(0.0f, 0.0f, 0.0f, 3, 1, 1);
        ...
        (this.Shape21 = new ModelRenderer((ModelBase) this, 0, 61)).addBox(0.0f, 0.0f, 0.0f, 3, 1, 1);
        ...
        (this.Shape22 = new ModelRenderer((ModelBase) this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 3, 1);
        ...
        (this.Shape23 = new ModelRenderer((ModelBase) this, 0, 13)).addBox(0.0f, 0.0f, 0.0f, 1, 3, 1);
        ...
        (this.lrwing = new ModelRenderer((ModelBase) this, 0, 38)).addBox(0.0f, 0.0f, -3.0f, 10, 1, 3);
        ...
        (this.rfwing = new ModelRenderer((ModelBase) this, 0, 48)).addBox(-10.0f, 0.0f, 0.0f, 10, 1, 3);
        ...
        (this.rrwing = new ModelRenderer((ModelBase) this, 0, 43)).addBox(-10.0f, 0.0f, -3.0f, 10, 1, 3);
