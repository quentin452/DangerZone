...
public class SpiderRobotKit extends Item {

    public SpiderRobotKit() {
        this.maxStackSize = 1;
        this.setCreativeTab(CreativeTabs.tabTools);
        if (ItemInitDangerZone.SpiderRobotKit != null) {
    ...
    public boolean onItemUse(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final World par3World,
        ...
        String name;
        name = "Robot Spider";
        if (par1ItemStack.getItem() == ItemInitDangerZone.RedAntRobotKit) {
            name = "Robot Red Ant";
        }
        ...
        if (ent != null) {
            ...
            if (ent instanceof RedAntRobotInstance) {
                final RedAntRobotInstance a = (RedAntRobotInstance) ent;
                a.setOwned();
            }
        }
