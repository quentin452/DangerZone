...
public class RockBase extends EntityLiving {
    ...
    public void onDeath(final DamageSource par1DamageSource) {
        this.setDead();
        if (this.rock_type == 1) {
            this.dropItemRand(ItemInitDangerZone.MySmallRock, 1);
        }
        if (this.rock_type == 2) {
            this.dropItemRand(ItemInitDangerZone.MyRock, 1);
        }
        if (this.rock_type == 3) {
            this.dropItemRand(ItemInitDangerZone.MyRedRock, 1);
        }
        if (this.rock_type == 4) {
            this.dropItemRand(ItemInitDangerZone.MyGreenRock, 1);
        }
        if (this.rock_type == 5) {
            this.dropItemRand(ItemInitDangerZone.MyBlueRock, 1);
        }
        if (this.rock_type == 6) {
            this.dropItemRand(ItemInitDangerZone.MyPurpleRock, 1);
        }
        if (this.rock_type == 7) {
            this.dropItemRand(ItemInitDangerZone.MySpikeyRock, 1);
        }
        if (this.rock_type == 8) {
            this.dropItemRand(ItemInitDangerZone.MyTNTRock, 1);
        }
        if (this.rock_type == 9) {
            this.dropItemRand(ItemInitDangerZone.MyCrystalRedRock, 1);
        }
        if (this.rock_type == 10) {
            this.dropItemRand(ItemInitDangerZone.MyCrystalGreenRock, 1);
        }
        if (this.rock_type == 11) {
            this.dropItemRand(ItemInitDangerZone.MyCrystalBlueRock, 1);
        }
        if (this.rock_type == 12) {
            this.dropItemRand(ItemInitDangerZone.MyCrystalTNTRock, 1);
        }
    }
    ...
    private ItemStack dropItemRand(final Item index, final int par1) {
        ...
        var3 = new EntityItem(
            this.worldObj,
            this.posX + (rand.nextFloat() - rand.nextFloat()) / 3.0f,
            this.posY + 0.25,
            this.posZ + (rand.nextFloat() - rand.nextFloat()) / 3.0f,
            is);
        if (var3 != null) {
