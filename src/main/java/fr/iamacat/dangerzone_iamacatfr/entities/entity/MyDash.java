...
public class MyDash extends EntityTameable {
    ...
    public MyDash(final World par1World) {
        super(par1World);
        this.stream_count = 0;
    ...
    public MyDash(final World par1World, final double par2, final double par4, final double par6) {
        this(par1World);
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityDragon) {
            ...
            if (par1Entity instanceof MyLeviathan) {
                iskraken = 4.0f;
            }
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof MyPhoenix) {
            return false;
        }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyAJ) {
            return false;
        }
        if (par1EntityLiving instanceof EntityMob) {
            return !(par1EntityLiving instanceof MyTwilightMagic);
        }
        return !(par1EntityLiving instanceof MyDash) && !(par1EntityLiving instanceof MyTwilightMagic)
    ...
    public void onUpdate() {
        ...
        if (this.getActivity() == 1) {
            ...
            if (this.wing_sound > 20) {
                if (!this.worldObj.isRemote) {
                    this.worldObj.playSoundAtEntity((Entity) this, Tags.MODID + ":flap_a", 0.8f, 1.0f);
                }
                this.wing_sound = 0;
            }
        }
    ...
    private EntityLivingBase doRainboomDamage(final double X, final double Y, final double Z, final double dist,
        ...
        while (var6.hasNext()) {
            ...
            if (this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && var8 != null
                ...
                && !(var8 instanceof MyTwilicorn)
                && !(var8 instanceof MyAJ)
                && !(var8 instanceof MyDashCloud)
                && !(var8 instanceof MyTwilightMagic)
    ...
    private void RainbowAtk(final EntityLivingBase e) {
        ...
        if (this.stream_count > 0) {
            ...
            if (this.rand.nextInt(15) == 1) {
                final RainbowCannon var2 = new RainbowCannon(
                    this.worldObj,
                    e.posX - this.posX,
    ...
    public static class RenderTheMob23 extends RenderLiving {
        ...
        static {
            dashtexture = new ResourceLocation(Tags.MODID + ":" + "textures/entity/dash.png");
        }
    }
}
