...
public class MyMavis extends EntityTameable {
    ...
    public MyMavis(final World par1World) {
        super(par1World);
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof MyMavis) {
            return false;
        }
        if (dm > 75.0f) {
            dm = 75.0f;
        }
        if (e != null && e instanceof MavisBall) {
            return false;
        }
        if (this.dmgDelay <= 0) {
        ...
        if (e != null && e instanceof EntityLiving) {
            if (e instanceof MyTwilicorn) {
                return false;
            }
            if (e instanceof MyMavis) {
                return false;
            }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyMavis) {
            return false;
        }
    ...
    public MyMavis spawnBabyAnimal(final EntityAgeable par1EntityAgeable) {
        final MyMavis w = new MyMavis(this.worldObj);
        if (this.isTamed()) {}
        return w;
    }
