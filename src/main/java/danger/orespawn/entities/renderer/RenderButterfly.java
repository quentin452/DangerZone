...
import danger.orespawn.entities.entityinstance.EntityButterfly;
import danger.orespawn.entities.entityinstance.EntityLunaMoth;
import danger.orespawn.entities.entityinstance.Mothra;
import danger.orespawn.entities.model.ModelButterfly;
...
public class RenderButterfly extends RenderLiving {
    ...
    protected void preRenderScale(final EntityButterfly par1Entity, final float par2) {
