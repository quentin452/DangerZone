...
public class FairyModelProps2 extends ModelBiped {

    public FairyModelProps2() {
        this(0.0F);
    }

    public FairyModelProps2(final float f) {
        this(f, 0.0F);
    }

    public FairyModelProps2(final float f, final float f1) {
        heldItemLeft = 0;
        heldItemRight = 0;
        isSneak = false;
        flymode = false;
        ...
        rogueHead.setTextureOffset(0, 0)
            .addBox(-3F, -5.7F, -3F, 6, 6, 6, f + 0.4F);
        rogueHead.mirror = true;
        rogueHead.setTextureOffset(0, 0)
            .addBox(-3F, -6.0F, -3F, 6, 6, 6, f + 0.125F);
        rogueHead.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
        rogueBody = new ModelRenderer(this);
        rogueBody.setTextureOffset(0, 19)
            .addBox(-2F, 0.0F, -1F, 4, 6, 2, f + 0.375F);
        rogueBody.setTextureOffset(12, 19)
            .addBox(-2F, 1.0F, -2F, 4, 2, 1, f + 0.375F);
