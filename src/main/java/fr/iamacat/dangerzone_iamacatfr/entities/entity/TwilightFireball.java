...
public class TwilightFireball extends EntityFireball {
    ...
    public TwilightFireball(final World par1World) {
        super(par1World);
        this.e = -1;
        this.f = -1;
        this.g = -1;
    ...
    public TwilightFireball(final World par1World, final EntityLivingBase par2EntityLiving, final double par3,
    ...
    public void onUpdate() {
        ...
        if (!this.worldObj.isRemote && ((this.a != null && this.a.isDead)
            ...
            for (int var28 = 0; var28 < var19.size(); ++var28) {
                ...
                if (var21 instanceof TwilightFireball) {
                    var17 = null;
                    break;
                }
    ...
    protected void onImpact(final MovingObjectPosition par1MovingObjectPosition) {
        if (!this.worldObj.isRemote) {
            if (par1MovingObjectPosition.entityHit != null) {
                if (par1MovingObjectPosition.entityHit instanceof TwilightFireball) {
                    return;
                }
                ...
                if (this.tiny && par1MovingObjectPosition.entityHit instanceof MyKingbowser) {
                    this.setDead();
                    return;
                }
