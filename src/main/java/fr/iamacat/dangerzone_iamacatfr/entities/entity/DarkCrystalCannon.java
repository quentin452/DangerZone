...
public class DarkCrystalCannon extends EntityThrowable {

    public DarkCrystalCannon(final World par1World) {
        super(par1World);
        this.setSize(1.2f, 1.2f);
    }

    public DarkCrystalCannon(final World par1World, final EntityLivingBase par3EntityPlayer) {
        super(par1World, par3EntityPlayer);
    }

    public DarkCrystalCannon(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
    }

    public DarkCrystalCannon(final World par1World, final double par2, final double par4, final double par6) {
