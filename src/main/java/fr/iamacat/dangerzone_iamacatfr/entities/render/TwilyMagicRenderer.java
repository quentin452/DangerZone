...
public class TwilyMagicRenderer extends Render {

    private static final ResourceLocation texturetwim;
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        ...
        return TwilyMagicRenderer.texturetwim;
    }

    static {
        texturetwim = new ResourceLocation(Tags.MODID + ":" + "textures/items/twilightstar.png");
    }
}
