...
public class ModelRobot4 extends ModelBase {
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3,
        ...
        final double newposy = (float) (this.leftsholder.rotationPointY
            + Math.cos(this.leftupperarm.rotateAngleX) * 14.0);
        final double newposz = (float) (this.leftsholder.rotationPointZ
            + Math.sin(this.leftupperarm.rotateAngleX) * 14.0);
