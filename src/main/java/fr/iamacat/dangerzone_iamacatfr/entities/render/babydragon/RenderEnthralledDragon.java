...
public class RenderEnthralledDragon extends RenderLiving {

    private static final ResourceLocation texture;
    private ModelBase scaleAmount;

    public RenderEnthralledDragon() {
        super((ModelBase) new ModelTinyDragon(), 0.55f);
    }

    public RenderEnthralledDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderEnthralledDragon.texture;
    }
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":textures/entity/babydragon/enthralled.png");
    }
}
