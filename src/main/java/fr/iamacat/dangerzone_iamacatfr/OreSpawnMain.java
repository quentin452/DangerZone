...
public class OreSpawnMain {
    ...
    public void preInit(final FMLPreInitializationEvent event) {
        ...
        MyPizzaItem = new ItemPizza(BaseItemID + 204, MyPizzaBlock).setMaxStackSize(1)
            .setCreativeTab(CreativeTabs.tabFood)
            .setUnlocalizedName("pizza");
        MyDuctTapeBlock = new BlockDuctTape(BaseBlockID + 198).setBlockName("ducttape");
        MyDuctTapeItem = new ItemDuctTape(BaseItemID + 458, MyDuctTapeBlock).setMaxStackSize(1)
        ...
        (MyUltimateShovel = new UltimateShovel(BaseItemID + 306, toolULTIMATE).setUnlocalizedName("ultimateshovel"))
            .setHarvestLevel("shovel", ultimate_stats.harvestlevel);
        ...
        (MyUltimateAxe = new UltimateAxe(BaseItemID + 308, toolULTIMATE).setUnlocalizedName("ultimateaxe"))
            .setHarvestLevel("axe", ultimate_stats.harvestlevel);
        ...
        (MyRubyPickaxe = new RubyPickaxe(BaseItemID + 272, toolRUBY).setUnlocalizedName("rubypickaxe"))
            .setHarvestLevel("pickaxe", ruby_stats.harvestlevel);
        (MyRubyShovel = new RubyShovel(BaseItemID + 273, toolRUBY).setUnlocalizedName("rubyshovel"))
            .setHarvestLevel("shovel", ruby_stats.harvestlevel);
        ...
        (MyRubyAxe = new RubyAxe(BaseItemID + 275, toolRUBY).setUnlocalizedName("rubyaxe"))
            .setHarvestLevel("axe", ruby_stats.harvestlevel);
        ...
        (MyAmethystShovel = new AmethystShovel(BaseItemID + 263, toolAMETHYST).setUnlocalizedName("amethystshovel"))
            .setHarvestLevel("shovel", amethyst_stats.harvestlevel);
        ...
        (MyAmethystAxe = new AmethystAxe(BaseItemID + 265, toolAMETHYST).setUnlocalizedName("amethystaxe"))
            .setHarvestLevel("axe", amethyst_stats.harvestlevel);
        MyCrystalWoodSword = new CrystalSword(BaseItemID + 329, toolCRYSTALWOOD).setUnlocalizedName("crystalwoodsword");
        MyCrystalWoodPickaxe = new CrystalPickaxe(BaseItemID + 330, toolCRYSTALWOOD)
            .setUnlocalizedName("crystalwoodpickaxe");
        MyCrystalWoodShovel = new CrystalShovel(BaseItemID + 331, toolCRYSTALWOOD)
            .setUnlocalizedName("crystalwoodshovel");
        ...
        MyCrystalPinkPickaxe = new CrystalPickaxe(BaseItemID + 335, toolCRYSTALPINK)
            .setUnlocalizedName("crystalpinkpickaxe");
        MyCrystalPinkShovel = new CrystalShovel(BaseItemID + 336, toolCRYSTALPINK)
            .setUnlocalizedName("crystalpinkshovel");
        ...
        MyCrystalStoneSword = new CrystalSword(BaseItemID + 339, toolCRYSTALSTONE)
            .setUnlocalizedName("crystalstonesword");
        MyCrystalStonePickaxe = new CrystalPickaxe(BaseItemID + 340, toolCRYSTALSTONE)
            .setUnlocalizedName("crystalstonepickaxe");
        MyCrystalStoneShovel = new CrystalShovel(BaseItemID + 341, toolCRYSTALSTONE)
            .setUnlocalizedName("crystalstoneshovel");
        ...
        MySunspotUrchin = new ItemSunspotUrchin().setUnlocalizedName("sunspoturchin2")
            .setTextureName(Tags.MODID + ":sunspoturchin");
        ...
        MyIrukandji = new fr.iamacat.dangerzone_iamacatfr.items.DeadIrukandji(OreSpawnMain.BaseItemID + 258)
            .setUnlocalizedName("deadirukandji");
        ...
        armorULTIMATE = EnumHelper.addArmorMaterial(
            ...
            new int[] { Ultimate_armorstats.head_protection, Ultimate_armorstats.chest_protection,
                Ultimate_armorstats.leg_protection, Ultimate_armorstats.boot_protection },
            Ultimate_armorstats.enchantability);
        armorMOBZILLA = EnumHelper.addArmorMaterial(
            "MOBZILLA",
            Mobzilla_armorstats.durability,
            new int[] { Mobzilla_armorstats.head_protection, Mobzilla_armorstats.chest_protection,
                Mobzilla_armorstats.leg_protection, Mobzilla_armorstats.boot_protection },
            Mobzilla_armorstats.enchantability);
        armorLAVAEEL = EnumHelper.addArmorMaterial(
            "LAVAEEL",
            LavaEel_armorstats.durability,
            new int[] { LavaEel_armorstats.head_protection, LavaEel_armorstats.chest_protection,
                LavaEel_armorstats.leg_protection, LavaEel_armorstats.boot_protection },
            LavaEel_armorstats.enchantability);
        armorMOTHSCALE = EnumHelper.addArmorMaterial(
            "MOTHSCALE",
            MothScale_armorstats.durability,
            new int[] { MothScale_armorstats.head_protection, MothScale_armorstats.chest_protection,
                MothScale_armorstats.leg_protection, MothScale_armorstats.boot_protection },
            MothScale_armorstats.enchantability);
        armorEMERALD = EnumHelper.addArmorMaterial(
            "EMERALD",
            Emerald_armorstats.durability,
            new int[] { Emerald_armorstats.head_protection, Emerald_armorstats.chest_protection,
                Emerald_armorstats.leg_protection, Emerald_armorstats.boot_protection },
            Emerald_armorstats.enchantability);
        armorEXPERIENCE = EnumHelper.addArmorMaterial(
            "EXPERIENCE",
            Experience_armorstats.durability,
            new int[] { Experience_armorstats.head_protection, Experience_armorstats.chest_protection,
                Experience_armorstats.leg_protection, Experience_armorstats.boot_protection },
        ...
        armorAMETHYST = EnumHelper.addArmorMaterial(
            ...
            new int[] { Amethyst_armorstats.head_protection, Amethyst_armorstats.chest_protection,
                Amethyst_armorstats.leg_protection, Amethyst_armorstats.boot_protection },
        ...
        armorTIGERSEYE = EnumHelper.addArmorMaterial(
            ...
            new int[] { TigersEye_armorstats.head_protection, TigersEye_armorstats.chest_protection,
                TigersEye_armorstats.leg_protection, TigersEye_armorstats.boot_protection },
            TigersEye_armorstats.enchantability);
        armorPEACOCK = EnumHelper.addArmorMaterial(
            "PEACOCK",
            Peacock_armorstats.durability,
            new int[] { Peacock_armorstats.head_protection, Peacock_armorstats.chest_protection,
                Peacock_armorstats.leg_protection, Peacock_armorstats.boot_protection },
        ...
        CrystalFurnaceBlock = (CrystalFurnace) new CrystalFurnace(BaseBlockID + 212, false, 2.0f, 10.0f)
        ...
        MyStrawberrySeed = new ItemStrawberrySeed(BaseItemID + 210, MyStrawberryPlant, Blocks.farmland)
            .setUnlocalizedName("strawberry_seed");
        MyButterflyPlant = new BlockButterflyPlant(BaseBlockID + 155);
        MyButterflySeed = new ItemButterflySeed(BaseItemID + 212, MyButterflyPlant, Blocks.farmland)
            .setUnlocalizedName("butterfly_seed");
        ...
        MyMosquitoSeed = new ItemMosquitoSeed(BaseItemID + 214, MyMosquitoPlant, Blocks.farmland)
            .setUnlocalizedName("mosquito_seed");
        MyFireflyPlant = new BlockFireflyPlant(BaseBlockID + 154);
        MyFireflySeed = new ItemFireflySeed(BaseItemID + 215, MyFireflyPlant, Blocks.farmland)
            .setUnlocalizedName("firefly_seed");
        MyRadishPlant = new BlockRadish(BaseBlockID + 175);
        MyRadish = new ItemRadish(BaseItemID + 199, 2, 0.45f, MyRadishPlant, Blocks.farmland)
        ...
        MyCornCob = new ItemCornCob(BaseItemID + 185, 6, 0.75f, MyCornPlant1, Blocks.farmland)
        ...
        MyQuinoa = new ItemCornCob(BaseItemID + 224, 7, 0.85f, MyQuinoaPlant1, CrystalGrass)
            .setUnlocalizedName("quinoa");
        ...
        MyTomato = new ItemTomato(BaseItemID + 197, 4, 0.55f, MyTomatoPlant1, Blocks.farmland)
            .setUnlocalizedName("tomato_seed");
        ...
        MyLettuce = new ItemLettuce(BaseItemID + 198, 3, 0.45f, MyLettucePlant1, Blocks.farmland)
            .setUnlocalizedName("lettuce_seed");
    ...
    private void make_some_more_things() {
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(SnowGolemEgg), new ItemStack(Items.water_bucket), OreSnowGolemEggStack);
        final ItemStack OreIronGolemEggStack = new ItemStack(MyIronGolemSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(IronGolemEgg), new ItemStack(Items.water_bucket), OreIronGolemEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(GirlfriendEgg), new ItemStack(Items.water_bucket), OreGirlfriendEggStack);
        final ItemStack OreBoyfriendEggStack = new ItemStack(MyBoyfriendSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(BoyfriendEgg), new ItemStack(Items.water_bucket), OreBoyfriendEggStack);
        final ItemStack OreRedCowEggStack = new ItemStack(MyRedCowSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(RedCowEgg), new ItemStack(Items.water_bucket), OreRedCowEggStack);
        final ItemStack OreCrystalCowEggStack = new ItemStack(MyCrystalCowSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(CrystalCowEgg), new ItemStack(Items.water_bucket), OreCrystalCowEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(GoldCowEgg), new ItemStack(Items.water_bucket), OreGoldCowEggStack);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(MOTHRAEgg), new ItemStack(Items.water_bucket), OreMOTHRAEggStack);
        final ItemStack OreAloEggStack = new ItemStack(MyAloSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(AloEgg), new ItemStack(Items.water_bucket), OreAloEggStack);
        final ItemStack OreCryoEggStack = new ItemStack(MyCryoSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(CryoEgg), new ItemStack(Items.water_bucket), OreCryoEggStack);
        final ItemStack OreCamaEggStack = new ItemStack(MyCamaSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(CamaEgg), new ItemStack(Items.water_bucket), OreCamaEggStack);
        final ItemStack OreVeloEggStack = new ItemStack(MyVeloSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(VeloEgg), new ItemStack(Items.water_bucket), OreVeloEggStack);
        final ItemStack OreHydroEggStack = new ItemStack(MyHydroSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(HydroEgg), new ItemStack(Items.water_bucket), OreHydroEggStack);
        final ItemStack OreBasilEggStack = new ItemStack(MyBasilSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(BasilEgg), new ItemStack(Items.water_bucket), OreBasilEggStack);
        final ItemStack OreDragonflyEggStack = new ItemStack(MyDragonflySpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(DragonflyEgg), new ItemStack(Items.water_bucket), OreDragonflyEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(ScorpionEgg), new ItemStack(Items.water_bucket), OreScorpionEggStack);
        final ItemStack OreCaveFisherEggStack = new ItemStack(MyCaveFisherSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(CaveFisherEgg), new ItemStack(Items.water_bucket), OreCaveFisherEggStack);
        final ItemStack OreSpyroEggStack = new ItemStack(MySpyroSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(SpyroEgg), new ItemStack(Items.water_bucket), OreSpyroEggStack);
        final ItemStack OreBaryonyxEggStack = new ItemStack(MyBaryonyxSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(BaryonyxEgg), new ItemStack(Items.water_bucket), OreBaryonyxEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(CockateilEgg), new ItemStack(Items.water_bucket), OreCockateilEggStack);
        final ItemStack OreKyuubiEggStack = new ItemStack(MyKyuubiSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(KyuubiEgg), new ItemStack(Items.water_bucket), OreKyuubiEggStack);
        final ItemStack OreAlienEggStack = new ItemStack(MyAlienSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(AlienEgg), new ItemStack(Items.water_bucket), OreAlienEggStack);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(KrakenEgg), new ItemStack(Items.water_bucket), OreKrakenEggStack);
        final ItemStack OreLizardEggStack = new ItemStack(MyLizardSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(LizardEgg), new ItemStack(Items.water_bucket), OreLizardEggStack);
        final ItemStack OreCephadromeEggStack = new ItemStack(MyCephadromeSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(CephadromeEgg), new ItemStack(Items.water_bucket), OreCephadromeEggStack);
        final ItemStack OreDragonEggStack = new ItemStack(MyDragonSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(DragonEgg), new ItemStack(Items.water_bucket), OreDragonEggStack);
        final ItemStack OreBeeEggStack = new ItemStack(MyBeeSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(BeeEgg), new ItemStack(Items.water_bucket), OreBeeEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(TrooperBugEgg), new ItemStack(Items.water_bucket), OreTrooperBugEggStack);
        final ItemStack OreSpitBugEggStack = new ItemStack(MySpitBugSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(SpitBugEgg), new ItemStack(Items.water_bucket), OreSpitBugEggStack);
        final ItemStack OreStinkBugEggStack = new ItemStack(MyStinkBugSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(StinkBugEgg), new ItemStack(Items.water_bucket), OreStinkBugEggStack);
        final ItemStack OreOstrichEggStack = new ItemStack(MyOstrichSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(OstrichEgg), new ItemStack(Items.water_bucket), OreOstrichEggStack);
        final ItemStack OreGazelleEggStack = new ItemStack(MyGazelleSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(GazelleEgg), new ItemStack(Items.water_bucket), OreGazelleEggStack);
        final ItemStack OreChipmunkEggStack = new ItemStack(MyChipmunkSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(ChipmunkEgg), new ItemStack(Items.water_bucket), OreChipmunkEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(CliffRacerEgg), new ItemStack(Items.water_bucket), OreCliffRacerEggStack);
        final ItemStack OreTriffidEggStack = new ItemStack(MyTriffidSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(TriffidEgg), new ItemStack(Items.water_bucket), OreTriffidEggStack);
        final ItemStack OrePitchBlackEggStack = new ItemStack(MyPitchBlackSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(PitchBlackEgg), new ItemStack(Items.water_bucket), OrePitchBlackEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(GodzillaEgg), new ItemStack(Items.water_bucket), OreGodzillaEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(TheKingEgg), new ItemStack(Items.water_bucket), OreTheKingEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(TheQueenEgg), new ItemStack(Items.water_bucket), OreTheQueenEggStack);
        final ItemStack OreSmallWormEggStack = new ItemStack(MySmallWormSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(SmallWormEgg), new ItemStack(Items.water_bucket), OreSmallWormEggStack);
        final ItemStack OreMediumWormEggStack = new ItemStack(MyMediumWormSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(MediumWormEgg), new ItemStack(Items.water_bucket), OreMediumWormEggStack);
        final ItemStack OreLargeWormEggStack = new ItemStack(MyLargeWormSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(LargeWormEgg), new ItemStack(Items.water_bucket), OreLargeWormEggStack);
        final ItemStack OreCassowaryEggStack = new ItemStack(MyCassowarySpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(CassowaryEgg), new ItemStack(Items.water_bucket), OreCassowaryEggStack);
        final ItemStack OreCloudSharkEggStack = new ItemStack(MyCloudSharkSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(CloudSharkEgg), new ItemStack(Items.water_bucket), OreCloudSharkEggStack);
        final ItemStack OreGoldFishEggStack = new ItemStack(MyGoldFishSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(GoldFishEgg), new ItemStack(Items.water_bucket), OreGoldFishEggStack);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(TshirtEgg), new ItemStack(Items.water_bucket), OreTshirtEggStack);

        final ItemStack OreBeaverEggStack = new ItemStack(MyBeaverSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(BeaverEgg), new ItemStack(Items.water_bucket), OreBeaverEggStack);

        final ItemStack OreUrchinEggStack = new ItemStack(MyUrchinSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(UrchinEgg), new ItemStack(Items.water_bucket), OreUrchinEggStack);

        final ItemStack OreFlounderEggStack = new ItemStack(MyFlounderSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(FlounderEgg), new ItemStack(Items.water_bucket), OreFlounderEggStack);

        final ItemStack OreSkateEggStack = new ItemStack(MySkateSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(SkateEgg), new ItemStack(Items.water_bucket), OreSkateEggStack);

        final ItemStack OreRotatorEggStack = new ItemStack(MyRotatorSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(RotatorEgg), new ItemStack(Items.water_bucket), OreRotatorEggStack);

        final ItemStack OrePeacockEggStack = new ItemStack(MyPeacockSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(PeacockEgg), new ItemStack(Items.water_bucket), OrePeacockEggStack);

        final ItemStack OreFairyEggStack = new ItemStack(MyFairySpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(FairyEgg), new ItemStack(Items.water_bucket), OreFairyEggStack);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(VortexEgg), new ItemStack(Items.water_bucket), OreVortexEggStack);

        final ItemStack OreRatEggStack = new ItemStack(MyRatSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(RatEgg), new ItemStack(Items.water_bucket), OreRatEggStack);

        final ItemStack OreWhaleEggStack = new ItemStack(MyWhaleSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(WhaleEgg), new ItemStack(Items.water_bucket), OreWhaleEggStack);

        final ItemStack OreIrukandjiEggStack = new ItemStack(MyIrukandjiSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(IrukandjiEgg), new ItemStack(Items.water_bucket), OreIrukandjiEggStack);

        final ItemStack OreTRexEggStack = new ItemStack(MyTRexSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(TRexEgg), new ItemStack(Items.water_bucket), OreTRexEggStack);

        final ItemStack OreHerculesEggStack = new ItemStack(MyHerculesSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(HerculesEgg), new ItemStack(Items.water_bucket), OreHerculesEggStack);

        final ItemStack OreMantisEggStack = new ItemStack(MyMantisSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(MantisEgg), new ItemStack(Items.water_bucket), OreMantisEggStack);

        final ItemStack OreStinkyEggStack = new ItemStack(MyStinkySpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(StinkyEgg), new ItemStack(Items.water_bucket), OreStinkyEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(CriminalEgg), new ItemStack(Items.water_bucket), OreCriminalEggStack);

        final ItemStack OreBrutalflyEggStack = new ItemStack(MyBrutalflySpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(BrutalflyEgg), new ItemStack(Items.water_bucket), OreBrutalflyEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(CricketEgg), new ItemStack(Items.water_bucket), OreCricketEggStack);

        final ItemStack OreFrogEggStack = new ItemStack(MyFrogSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(FrogEgg), new ItemStack(Items.water_bucket), OreFrogEggStack);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(CrabEgg), new ItemStack(Items.water_bucket), OreCrabEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(MolenoidEgg), new ItemStack(Items.water_bucket), OreMolenoidEggStack);

        final ItemStack OreSeaMonsterEggStack = new ItemStack(MySeaMonsterSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(SeaMonsterEgg), new ItemStack(Items.water_bucket), OreSeaMonsterEggStack);

        final ItemStack OreSeaViperEggStack = new ItemStack(MySeaViperSpawnBlock);
        GameRegistry
            .addShapelessRecipe(new ItemStack(SeaViperEgg), new ItemStack(Items.water_bucket), OreSeaViperEggStack);
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(HammerheadEgg), new ItemStack(Items.water_bucket), OreHammerheadEggStack);

        final ItemStack OreLeonEggStack = new ItemStack(MyLeonSpawnBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(LeonEgg), new ItemStack(Items.water_bucket), OreLeonEggStack);

        GameRegistry.addShapelessRecipe(new ItemStack(CrystalPlanksBlock, 4), MyCrystalTreeLog);
        GameRegistry.addShapelessRecipe(
            ...
            CrystalPlanksBlock,
            CrystalPlanksBlock);
        GameRegistry.addRecipe(new ItemStack(CrystalFurnaceBlock), "FFF", "F F", "FFF", 'F', CrystalStone);
        GameRegistry.addRecipe(new ItemStack(Blocks.chest), "FFF", "F F", "FFF", 'F', CrystalPlanksBlock);
        GameRegistry.addRecipe(new ItemStack(Items.wooden_door), "FF ", "FF ", "FF ", 'F', CrystalPlanksBlock);
        GameRegistry.addRecipe(new ItemStack(Items.wooden_door), " FF", " FF", " FF", 'F', CrystalPlanksBlock);
        ...
        GameRegistry.addRecipe(
            ...
            'T',
            MyIngotTitanium);
        GameRegistry.addRecipe(new ItemStack(MySkateBow), " TS", "T S", " TS", 'S', Items.string, 'T', CrystalSticks);
        GameRegistry.addRecipe(
        ...
        GameRegistry.addRecipe(
            ...
            MyIngotTitanium);
        GameRegistry
            .addRecipe(new ItemStack(MyEmeraldSword), " E ", " E ", " I ", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry
            .addRecipe(new ItemStack(MyEmeraldSword), "E  ", "E  ", "I  ", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry
            .addRecipe(new ItemStack(MyEmeraldSword), "  E", "  E", "  I", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry
            .addRecipe(new ItemStack(MyRoseSword), " E ", " E ", " I ", 'I', Items.stick, 'E', Blocks.red_flower);
        GameRegistry
            .addRecipe(new ItemStack(MyRoseSword), "E  ", "E  ", "I  ", 'I', Items.stick, 'E', Blocks.red_flower);
        GameRegistry
            .addRecipe(new ItemStack(MyRoseSword), "  E", "  E", "  I", 'I', Items.stick, 'E', Blocks.red_flower);
        GameRegistry
            .addRecipe(new ItemStack(MyEmeraldPickaxe), "EEE", " I ", " I ", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry
            .addRecipe(new ItemStack(MyEmeraldShovel), " E ", " I ", " I ", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry
            .addRecipe(new ItemStack(MyEmeraldShovel), "E  ", "I  ", "I  ", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry
            .addRecipe(new ItemStack(MyEmeraldShovel), "  E", "  I", "  I", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry.addRecipe(new ItemStack(MyEmeraldHoe), "EE ", " I ", " I ", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry.addRecipe(new ItemStack(MyEmeraldAxe), "EE ", "EI ", " I ", 'I', Items.stick, 'E', Items.emerald);
        GameRegistry.addRecipe(
        ...
        GameRegistry
            .addRecipe(new ItemStack(MyPoisonSword), "EEE", "EIE", "EEE", 'I', MyEmeraldSword, 'E', MyDeadStinkBug);
        GameRegistry.addRecipe(new ItemStack(MyRatSword), " E ", " E ", " I ", 'I', CrystalSticks, 'E', CrystalRat);
        GameRegistry.addRecipe(new ItemStack(MyRatSword), "E  ", "E  ", "I  ", 'I', CrystalSticks, 'E', CrystalRat);
        GameRegistry.addRecipe(new ItemStack(MyRatSword), "  E", "  E", "  I", 'I', CrystalSticks, 'E', CrystalRat);
        GameRegistry.addRecipe(new ItemStack(MyFairySword), " E ", " E ", " I ", 'I', CrystalSticks, 'E', CrystalFairy);
        GameRegistry.addRecipe(new ItemStack(MyFairySword), "E  ", "E  ", "I  ", 'I', CrystalSticks, 'E', CrystalFairy);
        GameRegistry.addRecipe(new ItemStack(MyFairySword), "  E", "  E", "  I", 'I', CrystalSticks, 'E', CrystalFairy);
        GameRegistry.addRecipe(
        ...
        GameRegistry
            .addRecipe(new ItemStack(MyTigersEyeSword), " E ", " E ", " I ", 'I', CrystalSticks, 'E', MyTigersEyeIngot);
        GameRegistry
            .addRecipe(new ItemStack(MyTigersEyeSword), "E  ", "E  ", "I  ", 'I', CrystalSticks, 'E', MyTigersEyeIngot);
        GameRegistry
            .addRecipe(new ItemStack(MyTigersEyeSword), "  E", "  E", "  I", 'I', CrystalSticks, 'E', MyTigersEyeIngot);
        ...
        GameRegistry.addRecipe(
            ...
            MyTigersEyeIngot);
        GameRegistry
            .addRecipe(new ItemStack(MyTigersEyeHoe), "EE ", " I ", " I ", 'I', CrystalSticks, 'E', MyTigersEyeIngot);
        GameRegistry
            .addRecipe(new ItemStack(MyTigersEyeAxe), "EE ", "EI ", " I ", 'I', CrystalSticks, 'E', MyTigersEyeIngot);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneSword), " E ", " E ", " I ", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneSword), "E  ", "E  ", "I  ", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneSword), "  E", "  E", "  I", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry.addRecipe(
            ...
            CrystalStone);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneShovel), " E ", " I ", " I ", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneShovel), "E  ", "I  ", "I  ", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneShovel), "  E", "  I", "  I", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneHoe), "EE ", " I ", " I ", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry
            .addRecipe(new ItemStack(MyCrystalStoneAxe), "EE ", "EI ", " I ", 'I', CrystalSticks, 'E', CrystalStone);
        GameRegistry.addRecipe(new ItemStack(MyRubySword), " E ", " E ", " I ", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubySword), "E  ", "E  ", "I  ", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubySword), "  E", "  E", "  I", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubyPickaxe), "EEE", " I ", " I ", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubyShovel), " E ", " I ", " I ", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubyShovel), "E  ", "I  ", "I  ", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubyShovel), "  E", "  I", "  I", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubyHoe), "EE ", " I ", " I ", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyRubyAxe), "EE ", "EI ", " I ", 'I', Items.stick, 'E', MyRuby);
        GameRegistry.addRecipe(new ItemStack(MyAmethystSword), " E ", " E ", " I ", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyAmethystSword), "E  ", "E  ", "I  ", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyAmethystSword), "  E", "  E", "  I", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry
            .addRecipe(new ItemStack(MyAmethystPickaxe), "EEE", " I ", " I ", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyAmethystShovel), " E ", " I ", " I ", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyAmethystShovel), "E  ", "I  ", "I  ", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyAmethystShovel), "  E", "  I", "  I", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyAmethystHoe), "EE ", " I ", " I ", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyAmethystAxe), "EE ", "EI ", " I ", 'I', Items.stick, 'E', MyAmethyst);
        GameRegistry
            .addShapelessRecipe(new ItemStack(MyHammy), MyUltimateSword, MyUltimateSword, MyBigHammer, GreenGoo);
        GameRegistry.addShapelessRecipe(new ItemStack(MyBattleAxe), MyUltimateSword, MyUltimateAxe, GreenGoo);
        GameRegistry
            .addRecipe(new ItemStack(MyChainsaw), "EEE", "EIE", "EEE", 'I', MyUltimateAxe, 'E', Blocks.redstone_block);
        GameRegistry
            .addRecipe(new ItemStack(MyQueenBattleAxe), "EIE", "EIE", " I ", 'I', Items.iron_ingot, 'E', MyQueenScale);
        GameRegistry.addShapelessRecipe(new ItemStack(MyBertha), BerthaHandle, BerthaGuard, BerthaBlade);
        GameRegistry.addShapelessRecipe(
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(MyIrukandjiArrow), MyPeacockFeather, MyIrukandji, CrystalSticks);
        GameRegistry.addShapelessRecipe(
        ...
        GameRegistry.addShapelessRecipe(
            ...
            Items.iron_ingot,
            Items.iron_ingot);
        GameRegistry.addRecipe(new ItemStack(MyIngotUranium), "UUU", "UUU", "UUU", 'U', UraniumNugget);
        GameRegistry.addShapelessRecipe(new ItemStack(UraniumNugget, 9), new ItemStack(MyIngotUranium));
        GameRegistry.addRecipe(new ItemStack(MyIngotTitanium), "UUU", "UUU", "UUU", 'U', TitaniumNugget);
        GameRegistry.addShapelessRecipe(new ItemStack(TitaniumNugget, 9), new ItemStack(MyIngotTitanium));
        GameRegistry.addRecipe(new ItemStack(MyBlockUraniumBlock), "UUU", "UUU", "UUU", 'U', MyIngotUranium);
        GameRegistry.addShapelessRecipe(new ItemStack(MyIngotUranium, 9), new ItemStack(MyBlockUraniumBlock));
        GameRegistry.addRecipe(new ItemStack(MyBlockTitaniumBlock), "TTT", "TTT", "TTT", 'T', MyIngotTitanium);
        GameRegistry.addShapelessRecipe(new ItemStack(MyIngotTitanium, 9), new ItemStack(MyBlockTitaniumBlock));
        GameRegistry.addRecipe(new ItemStack(MyBlockMobzillaScaleBlock), "TTT", "TTT", "TTT", 'T', MyGodzillaScale);
        GameRegistry.addShapelessRecipe(new ItemStack(MyGodzillaScale, 9), new ItemStack(MyBlockMobzillaScaleBlock));
        GameRegistry.addRecipe(new ItemStack(MyBlockRubyBlock), "TTT", "TTT", "TTT", 'T', MyRuby);
        GameRegistry.addShapelessRecipe(new ItemStack(MyRuby, 9), new ItemStack(MyBlockRubyBlock));
        GameRegistry.addRecipe(new ItemStack(MyBlockAmethystBlock), "TTT", "TTT", "TTT", 'T', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(MyCrystalPinkBlock), "TTT", "TTT", "TTT", 'T', MyCrystalPinkIngot);
        GameRegistry.addRecipe(new ItemStack(MyTigersEyeBlock), "TTT", "TTT", "TTT", 'T', MyTigersEyeIngot);
        GameRegistry.addShapelessRecipe(new ItemStack(MyAmethyst, 9), new ItemStack(MyBlockAmethystBlock));
        GameRegistry.addShapelessRecipe(new ItemStack(MyCrystalPinkIngot, 9), new ItemStack(MyCrystalPinkBlock));
        GameRegistry.addShapelessRecipe(new ItemStack(MyTigersEyeIngot, 9), new ItemStack(MyTigersEyeBlock));
        GameRegistry.addRecipe(new ItemStack(MyEnderPearlBlock), "TTT", "TTT", "TTT", 'T', Items.ender_pearl);
        GameRegistry.addShapelessRecipe(new ItemStack(Items.ender_pearl, 9), new ItemStack(MyEnderPearlBlock));
        GameRegistry.addRecipe(new ItemStack(MyEyeOfEnderBlock), "TTT", "TTT", "TTT", 'T', Items.ender_eye);
        GameRegistry.addShapelessRecipe(new ItemStack(Items.ender_eye, 9), new ItemStack(MyEyeOfEnderBlock));
        GameRegistry.addRecipe(new ItemStack(MyThunderStaff), "DR ", "RR ", "  R", 'D', Items.diamond, 'R', MyRuby);
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(MyCheese, 2), MilkBucket, MilkBucket, MilkBucket, MilkBucket);
        ...
        GameRegistry.addShapelessRecipe(
            ...
            SomePaper);
        GameRegistry
            .addShapelessRecipe(new ItemStack(MyRawCornDog, 4), MyCornCob, Items.chicken, Items.porkchop, Items.stick);
        GameRegistry.addShapelessRecipe(new ItemStack(MyRawBacon, 2), MySalt, Items.porkchop);
        GameRegistry.addShapelessRecipe(new ItemStack(MyButterCandy, 4), MyButter, Items.sugar);
        GameRegistry
            .addShapelessRecipe(new ItemStack(MySalad, 1), MyLettuce, MyTomato, MyRadish, Items.carrot, Items.bowl);
        GameRegistry.addShapelessRecipe(new ItemStack(MyBLT, 1), MyBacon, MyLettuce, MyTomato, MyButter, Items.bread);
        GameRegistry.addShapelessRecipe(new ItemStack(MyPizzaItem, 1), MyTomato, MyCheese, MyBacon, Items.bread);
        GameRegistry
            .addRecipe(new ItemStack(MyDuctTapeItem), "   ", "AAA", "RRR", 'R', Items.string, 'A', Items.slime_ball);
        GameRegistry.addShapelessRecipe(new ItemStack(MyCrabbyPatty, 1), MyCrabMeat, MyLettuce, MyTomato, Items.bread);
        GameRegistry.addShapelessRecipe(new ItemStack(ZooCage2), Blocks.iron_block, Blocks.glass, Blocks.quartz_block);
        GameRegistry.addShapelessRecipe(
        ...
        GameRegistry.addShapelessRecipe(
            ...
            Blocks.quartz_block);
        GameRegistry
            .addShapelessRecipe(new ItemStack(InstantShelter), Blocks.redstone_block, Items.stick, Blocks.cobblestone);
        GameRegistry
            .addShapelessRecipe(new ItemStack(InstantGarden), Blocks.redstone_block, Items.wheat, Items.gunpowder);
        GameRegistry.addShapelessRecipe(new ItemStack(CreeperLauncher, 4), Items.paper, Items.redstone, Items.stick);
        GameRegistry.addShapelessRecipe(new ItemStack(NetherLost, 1), Items.nether_star, Blocks.netherrack);
        GameRegistry.addRecipe(new ItemStack(Sifter), "RRR", "RAR", "RRR", 'R', Items.stick, 'A', Items.string);
        GameRegistry
            .addRecipe(new ItemStack(MagicApple), "RRR", "RAR", "RRR", 'R', Blocks.redstone_block, 'A', Items.apple);
        GameRegistry
            .addRecipe(new ItemStack(RandomDungeon), "RRR", "RAR", "RRR", 'R', Blocks.redstone_block, 'A', Items.coal);
        ...
        GameRegistry
            .addRecipe(new ItemStack(MyStepUp, 8), "GC ", " C ", " C ", 'C', Blocks.cobblestone, 'G', Items.gunpowder);
        GameRegistry.addRecipe(
        ...
        GameRegistry.addRecipe(
            ...
            'G',
            Items.gunpowder);
        GameRegistry.addShapelessRecipe(new ItemStack(ExtremeTorch, 4), Items.redstone, Items.stick, Items.coal);
        GameRegistry.addShapelessRecipe(new ItemStack(ExtremeTorch, 1), Items.redstone, Blocks.torch);
        GameRegistry.addShapelessRecipe(new ItemStack(CrystalSticks, 6), CrystalPlanksBlock, CrystalPlanksBlock);
        GameRegistry.addShapelessRecipe(new ItemStack(CrystalTorch, 6), CrystalCoal, CrystalSticks);
        GameRegistry.addRecipe(
        ...
        GameRegistry
            .addShapelessRecipe(new ItemStack(MyExperienceCatcher, 1), Items.glass_bottle, Items.stick, Items.string);
        GameRegistry.addRecipe(
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(MyRayGun), new ItemStack(Blocks.redstone_block), RayStack);
        ...
        EntityRegistry
            .registerModEntity(EnchantedCow.class, "Enchanted Golden Apple Cow", EnchantedCowID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(EntityButterfly.class, "Butterfly", ButterflyID, this, 32, 1, false);
        ...
        EntityRegistry.registerModEntity(EntityRainbowAnt.class, "Rainbow Ant", RainbowAntID, this, 16, 1, false);
        ...
        EntityRegistry.registerModEntity(EntityUnstableAnt.class, "Unstable Ant", UnstableAntID, this, 16, 1, false);
        ...
        EntityRegistry
            .registerModEntity(Cryolophosaurus.class, "Cryolophosaurus", CryolophosaurusID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(Camarasaurus.class, "Camarasaurus", CamarasaurusID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(VelocityRaptor.class, "Velocity Raptor", VelocityRaptorID, this, 64, 1, false);
        ...
        EntityRegistry
            .registerModEntity(EmperorScorpion.class, "Emperor Scorpion", EmperorScorpionID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(WaterDragon.class, "Water Dragon", WaterDragonID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(AttackSquid.class, "Attack Squid", AttackSquidID, this, 32, 1, false);
        ...
        EntityRegistry.registerModEntity(CreepingHorror.class, "Creeping Horror", CreepingHorrorID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(TerribleTerror.class, "Terrible Terror", TerribleTerrorID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(CliffRacer.class, "Cliff Racer", CliffRacerID, this, 32, 1, false);
        ...
        EntityRegistry.registerModEntity(GhostSkelly.class, "Ghost Pumpkin Skelly", GhostSkellyID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(WormMedium.class, "Medium Worm", WormMediumID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(CloudShark.class, "Cloud Shark", CloudSharkID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(LeafMonster.class, "Leaf Monster", LeafMonsterID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(GodzillaHead.class, "MobzillaHead", GodzillaHeadID, this, 128, 10, true);
        ...
        EntityRegistry.registerModEntity(EnderKnight.class, "Ender Knight", EnderKnightID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(EnderReaper.class, "Ender Reaper", EnderReaperID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(DungeonBeast.class, "Dungeon Beast", DungeonBeastID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(HerculesBeetle.class, "Hercules Beetle", HerculesBeetleID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(SeaMonster.class, "Sea Monster", SeaMonsterID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(EasterBunny.class, "EasterBunny", EasterBunnyID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(CaterKiller.class, "CaterKiller", CaterKillerID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(CrystalCow.class, "Crystal Apple Cow", CrystalCowID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(RubberDucky.class, "Rubber Ducky", RubberDuckyID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(ThePrinceTeen.class, "The Young Prince", ThePrinceTeenID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(Nastysaurus.class, "Nastysaurus", NastysaurusID, this, 128, 1, false);
        ...
        EntityRegistry.registerModEntity(Pointysaurus.class, "Pointysaurus", PointysaurusID, this, 64, 1, false);
        ...
        EntityRegistry.registerModEntity(ThePrincess.class, "The Princess", ThePrincessID, this, 64, 1, false);
        ...
        EntityRegistry
            .registerModEntity(ThePrinceAdult.class, "The Young Adult Prince", ThePrinceAdultID, this, 128, 1, false);
        ...
        EntityRegistry.registerModEntity(SpiderRobot.class, "Robot Spider", SpiderRobotID, this, 128, 1, false);
        ...
        EntityRegistry.registerModEntity(SpiderDriver.class, "Spider Driver", SpiderDriverID, this, 64, 1, false);
        ...
        EntityRegistry.addSpawn(AJInstance.class, 15, 3, 6, EnumCreatureType.creature, BiomeGenBase.beach);
        ...
        GameRegistry.addRecipe(
            ...
            MyIngotTitanium);
        GameRegistry
            .addRecipe(new ItemStack(UltimateBoots), "   ", "T T", "U U", 'U', MyIngotUranium, 'T', MyIngotTitanium);
        GameRegistry
            .addRecipe(new ItemStack(UltimateBoots), "T T", "U U", "   ", 'U', MyIngotUranium, 'T', MyIngotTitanium);
        GameRegistry.addRecipe(new ItemStack(LavaEelHelmet), "   ", "***", "* *", '*', MyLavaEel);
        GameRegistry.addRecipe(new ItemStack(LavaEelHelmet), "***", "* *", "   ", '*', MyLavaEel);
        GameRegistry.addRecipe(new ItemStack(LavaEelBody), "* *", "***", "***", '*', MyLavaEel);
        GameRegistry.addRecipe(new ItemStack(LavaEelLegs), "***", "* *", "* *", '*', MyLavaEel);
        GameRegistry.addRecipe(new ItemStack(LavaEelBoots), "   ", "* *", "* *", '*', MyLavaEel);
        GameRegistry.addRecipe(new ItemStack(MothScaleHelmet), "   ", "***", "* *", '*', MyMothScale);
        GameRegistry.addRecipe(new ItemStack(MothScaleHelmet), "***", "* *", "   ", '*', MyMothScale);
        GameRegistry.addRecipe(new ItemStack(MothScaleBody), "* *", "***", "***", '*', MyMothScale);
        GameRegistry.addRecipe(new ItemStack(MothScaleLegs), "***", "* *", "* *", '*', MyMothScale);
        GameRegistry.addRecipe(new ItemStack(MothScaleBoots), "   ", "* *", "* *", '*', MyMothScale);
        ...
        GameRegistry.addRecipe(new ItemStack(AmethystHelmet), "   ", "***", "* *", '*', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(AmethystHelmet), "***", "* *", "   ", '*', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(AmethystBody), "* *", "***", "***", '*', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(AmethystLegs), "***", "* *", "* *", '*', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(AmethystBoots), "   ", "* *", "* *", '*', MyAmethyst);
        GameRegistry.addRecipe(new ItemStack(CrystalPinkHelmet), "   ", "***", "* *", '*', MyCrystalPinkIngot);
        GameRegistry.addRecipe(new ItemStack(CrystalPinkHelmet), "***", "* *", "   ", '*', MyCrystalPinkIngot);
        GameRegistry.addRecipe(new ItemStack(CrystalPinkBody), "* *", "***", "***", '*', MyCrystalPinkIngot);
        GameRegistry.addRecipe(new ItemStack(CrystalPinkLegs), "***", "* *", "* *", '*', MyCrystalPinkIngot);
        GameRegistry.addRecipe(new ItemStack(CrystalPinkBoots), "   ", "* *", "* *", '*', MyCrystalPinkIngot);
        GameRegistry.addRecipe(new ItemStack(MobzillaHelmet), "   ", "***", "* *", '*', MyGodzillaScale);
        GameRegistry.addRecipe(new ItemStack(MobzillaHelmet), "***", "* *", "   ", '*', MyGodzillaScale);
        GameRegistry.addRecipe(new ItemStack(MobzillaBody), "* *", "***", "***", '*', MyGodzillaScale);
        GameRegistry.addRecipe(new ItemStack(MobzillaLegs), "***", "* *", "* *", '*', MyGodzillaScale);
        GameRegistry.addRecipe(new ItemStack(MobzillaBoots), "   ", "* *", "* *", '*', MyGodzillaScale);
        ...
        GameRegistry.addRecipe(new ItemStack(QueenHelmet), "   ", "***", "* *", '*', MyQueenScale);
        GameRegistry.addRecipe(new ItemStack(QueenHelmet), "***", "* *", "   ", '*', MyQueenScale);
        GameRegistry.addRecipe(new ItemStack(QueenBody), "* *", "***", "***", '*', MyQueenScale);
        GameRegistry.addRecipe(new ItemStack(QueenLegs), "***", "* *", "* *", '*', MyQueenScale);
        GameRegistry.addRecipe(new ItemStack(QueenBoots), "   ", "* *", "* *", '*', MyQueenScale);
        GameRegistry.addRecipe(new ItemStack(PeacockFeatherHelmet), "   ", "***", "* *", '*', MyPeacockFeather);
        GameRegistry.addRecipe(new ItemStack(PeacockFeatherHelmet), "***", "* *", "   ", '*', MyPeacockFeather);
        GameRegistry.addRecipe(new ItemStack(PeacockFeatherBody), "* *", "***", "***", '*', MyPeacockFeather);
        GameRegistry.addRecipe(new ItemStack(PeacockFeatherLegs), "***", "* *", "* *", '*', MyPeacockFeather);
        GameRegistry.addRecipe(new ItemStack(PeacockFeatherBoots), "   ", "* *", "* *", '*', MyPeacockFeather);
        GameRegistry.addRecipe(new ItemStack(TigersEyeHelmet), "   ", "***", "* *", '*', MyTigersEyeIngot);
        GameRegistry.addRecipe(new ItemStack(TigersEyeHelmet), "***", "* *", "   ", '*', MyTigersEyeIngot);
        GameRegistry.addRecipe(new ItemStack(TigersEyeBody), "* *", "***", "***", '*', MyTigersEyeIngot);
        GameRegistry.addRecipe(new ItemStack(TigersEyeLegs), "***", "* *", "* *", '*', MyTigersEyeIngot);
        GameRegistry.addRecipe(new ItemStack(TigersEyeBoots), "   ", "* *", "* *", '*', MyTigersEyeIngot);
        GameRegistry.addRecipe(
        ...
        GameRegistry
            .addRecipe(new ItemStack(CageEmpty, 2), "IWI", "W W", "IWI", 'W', Items.stick, 'I', Items.iron_ingot);
        GameRegistry
            .addRecipe(new ItemStack(CageEmpty, 2), "IWI", "W W", "IWI", 'W', CrystalSticks, 'I', MyCrystalPinkIngot);
    ...
    private void laySomeEggs() {
        MySpiderSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID).setBlockName("orespider");
        MyBatSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 1).setBlockName("orebat");
        MyCowSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 2).setBlockName("orecow");
        MyPigSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 3).setBlockName("orepig");
        MySquidSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 4).setBlockName("oresquid");
        MyChickenSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 5).setBlockName("orechicken");
        MyCreeperSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 6).setBlockName("orecreeper");
        MySkeletonSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 7).setBlockName("oreskeleton");
        MyZombieSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 8).setBlockName("orezombie");
        MySlimeSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 9).setBlockName("oreslime");
        MyGhastSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 10).setBlockName("oreghast");
        MyZombiePigmanSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 11).setBlockName("orezombiepigman");
        MyEndermanSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 12).setBlockName("oreenderman");
        MyCaveSpiderSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 13).setBlockName("orecavespider");
        MySilverfishSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 14).setBlockName("oresilverfish");
        MyMagmaCubeSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 15).setBlockName("oremagmacube");
        MyWitchSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 16).setBlockName("orewitch");
        MySheepSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 17).setBlockName("oresheep");
        MyWolfSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 18).setBlockName("orewolf");
        MyMooshroomSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 19).setBlockName("oremooshroom");
        MyOcelotSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 20).setBlockName("oreocelot");
        MyBlazeSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 21).setBlockName("oreblaze");
        MyWitherSkeletonSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 22)
            .setBlockName("orewitherskeleton");
        MyEnderDragonSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 23).setBlockName("oreenderdragon");
        MySnowGolemSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 24).setBlockName("oresnowgolem");
        MyIronGolemSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 25).setBlockName("oreirongolem");
        MyWitherBossSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 26).setBlockName("orewitherboss");
        MyGirlfriendSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 27).setBlockName("oregirlfriend");
        MyBoyfriendSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 84).setBlockName("oreboyfriend");
        MyRedCowSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 28).setBlockName("oreredcow");
        MyCrystalCowSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 261).setBlockName("orecrystalcow");
        MyVillagerSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 94).setBlockName("orevillager");
        MyGoldCowSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 29).setBlockName("oregoldcow");
        MyEnchantedCowSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 30).setBlockName("oreenchantedcow");
        MyMOTHRASpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 31).setBlockName("oreMOTHRA");
        ...
        MyAloSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 32).setBlockName("orealosaurus");
        MyCryoSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 33).setBlockName("orecryolophosaurus");
        MyCamaSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 34).setBlockName("orecamarasaurus");
        MyVeloSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 35).setBlockName("orevelocityraptor");
        MyHydroSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 36).setBlockName("orehydrolisc");
        MyBasilSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 37).setBlockName("orebasilisc");
        MyDragonflySpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 38).setBlockName("oredragonfly");
        MyEmperorScorpionSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 39)
            .setBlockName("oreemperorscorpion");
        MyScorpionSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 40).setBlockName("orescorpion");
        MyCaveFisherSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 41).setBlockName("orecavefisher");
        MySpyroSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 42).setBlockName("orespyro");
        MyBaryonyxSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 43).setBlockName("orebaryonyx");
        MyGammaMetroidSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 44).setBlockName("oregammametroid");
        MyCockateilSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 45).setBlockName("orecockateil");
        MyKyuubiSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 46).setBlockName("orekyuubi");
        MyAlienSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 47).setBlockName("orealien");
        MyAttackSquidSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 48).setBlockName("oreattacksquid");
        MyWaterDragonSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 49).setBlockName("orewaterdragon");
        MyCephadromeSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 52).setBlockName("orecephadrome");
        MyDragonSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 53).setBlockName("oredragon");
        MyKrakenSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 50).setBlockName("orekraken");
        MyLizardSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 51).setBlockName("orelizard");
        MyBeeSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 54).setBlockName("orebee");
        MyHorseSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 55).setBlockName("orehorse");
        MyTrooperBugSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 56).setBlockName("oretrooper");
        MySpitBugSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 57).setBlockName("orespit");
        MyStinkBugSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 58).setBlockName("orestink");
        MyOstrichSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 59).setBlockName("oreostrich");
        MyGazelleSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 60).setBlockName("oregazelle");
        MyChipmunkSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 61).setBlockName("orechipmunk");
        ...
        MyCliffRacerSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 64).setBlockName("orecliffracer");
        MyTriffidSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 65).setBlockName("oretriffid");
        MyPitchBlackSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 66).setBlockName("orenightmare");
        MyLurkingTerrorSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 67)
            .setBlockName("orelurkingterror");
        MyGodzillaPartSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 68).setBlockName("oregodzillapart");
        MyGodzillaSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 119).setBlockName("oregodzilla");
        MySmallWormSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 69).setBlockName("oresmallworm");
        MyMediumWormSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 70).setBlockName("oremediumworm");
        MyLargeWormSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 71).setBlockName("orelargeworm");
        MyCassowarySpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 72).setBlockName("orecassowary");
        MyCloudSharkSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 73).setBlockName("orecloudshark");
        MyGoldFishSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 74).setBlockName("oregoldfish");
        MyLeafMonsterSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 75).setBlockName("oreleafmonster");
        MyTshirtSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 76).setBlockName("oretshirt");
        MyEnderKnightSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 77).setBlockName("oreenderknight");
        MyEnderReaperSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 78).setBlockName("oreenderreaper");
        MyBeaverSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 79).setBlockName("orebeaver");
        MyUrchinSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 250).setBlockName("oreurchin");
        MyFlounderSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 251).setBlockName("oreflounder");
        MySkateSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 252).setBlockName("oreskate");
        MyRotatorSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 253).setBlockName("orerotator");
        MyPeacockSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 254).setBlockName("orepeacock");
        MyFairySpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 255).setBlockName("orefairy");
        MyDungeonBeastSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 256).setBlockName("oredungeonbeast");
        MyVortexSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 257).setBlockName("orevortex");
        MyRatSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 258).setBlockName("orerat");
        MyWhaleSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 259).setBlockName("orewhale");
        MyIrukandjiSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 260).setBlockName("oreirukandji");
        MyTRexSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 80).setBlockName("oretrex");
        MyHerculesSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 81).setBlockName("orehercules");
        MyMantisSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 82).setBlockName("oremantis");
        MyStinkySpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 83).setBlockName("orestinky");
        MyTheKingPartSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 85).setBlockName("orethekingpart");
        MyTheKingSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 122).setBlockName("oretheking");
        MyTheQueenPartSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 96).setBlockName("orethequeenpart");
        MyTheQueenSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 125).setBlockName("orethequeen");
        MyEasterBunnySpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 86).setBlockName("oreeasterbunny");
        MyCaterKillerSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 87).setBlockName("orecaterkiller");
        MyMolenoidSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 88).setBlockName("oremolenoid");
        MySeaMonsterSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 89).setBlockName("oreseamonster");
        MySeaViperSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 90).setBlockName("oreseaviper");
        MyLeonSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 91).setBlockName("oreleon");
        MyHammerheadSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 92).setBlockName("orehammerhead");
        MyRubberDuckySpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 93).setBlockName("orerubberducky");
        MyCriminalSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 95).setBlockName("orecriminal");
        MyBrutalflySpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 300).setBlockName("orebrutalfly");
        MyNastysaurusSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 301).setBlockName("orenastysaurus");
        MyPointysaurusSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 302).setBlockName("orepointysaurus");
        MyCricketSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 303).setBlockName("orecricket");
        MyFrogSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 304).setBlockName("orefrog");
        MySpiderDriverSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 305).setBlockName("orespiderdriver");
        MyCrabSpawnBlock = (OreGenericEgg) new OreGenericEgg(BaseBlockID + 306).setBlockName("orecrab");
    }
