...
public class TrevorP extends ModelBase {
    ...
    public TrevorP(final float p_i1148_1_) {
        this(p_i1148_1_, 0.0f, 64, 32);
    }

    public TrevorP(final float p_i1149_1_, final float p_i1149_2_, final int p_i1149_3_, final int p_i1149_4_) {
