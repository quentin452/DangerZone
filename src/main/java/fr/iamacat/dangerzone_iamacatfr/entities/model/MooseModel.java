...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.MooseInstance;

public class MooseModel extends ModelBase {
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3,
        ...
        final MooseInstance e = (MooseInstance) entity;
