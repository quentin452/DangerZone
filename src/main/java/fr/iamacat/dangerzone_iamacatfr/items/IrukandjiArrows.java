...
public class IrukandjiArrows  extends EntityArrow {
    ...
    public IrukandjiArrows(final World par1World) {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public IrukandjiArrows(final World par1World, final double par2, final double par4, final double par6) {
    ...
    public IrukandjiArrows(final World par1World, final EntityLiving par2EntityLiving,
    ...
    public IrukandjiArrows(final World par1World, final EntityPlayer par3EntityPlayer, final float par3) {
        ...
        if (this.inGround) {
            ...
            for (int var12 = 0; var12 < var10.size(); ++var12) {
                ...
                if (var13.canBeCollidedWith() && (var13 != this.shootingEntity || this.ticksInAir >= 5)
                    && !(var13 instanceof HoverboardInstance)) {
                    if (var13 instanceof CephadromeInstance) {
                        final CephadromeInstance c = (CephadromeInstance) var13;
                        if (c.riddenByEntity != null) {
                            continue;
                        }
                    }
                    if (var13 instanceof DragonInstance) {
                        final DragonInstance c2 = (DragonInstance) var13;
            ...
            if (var8 != null) {
                if (var8.entityHit != null) {
                    float var18 = 100.0f;
                        if (var8.entityHit instanceof EntityPlayer || var8.entityHit instanceof GirlfriendInstance
                            || var8.entityHit instanceof BoyfriendInstance) {
                    ...
                    if (this.shootingEntity == null) {
                        var19 = DamageSource.causeArrowDamage((EntityArrow) this, this);
                    } else {
                    ...
                    if (var8.entityHit.attackEntityFrom(var19, var18)) {
                        if (var8.entityHit instanceof EntityLiving) {
                            ...
                            if (this.knockbackStrength > 0) {
                                final float var21 = MathHelper
                                    .sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
                                if (var21 > 0.0f) {
                                    var8.entityHit.addVelocity(
                                        this.motionX * this.knockbackStrength * 0.6000000238418579 / var21,
                                        0.1,
                                        this.motionZ * this.knockbackStrength * 0.6000000238418579 / var21);
                                }
                            }
            ...
            if (this.isInWater()) {
                for (int var24 = 0; var24 < 4; ++var24) {
                    ...
                    this.worldObj.spawnParticle(
                        "bubble",
                        this.posX - this.motionX * var21,
                        this.posY - this.motionY * var21,
                        this.posZ - this.motionZ * var21,
                        this.motionX,
                        this.motionY,
                        this.motionZ);
                }
