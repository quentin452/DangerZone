...
public class ModelBertha extends ModelBase {
    ...
    public ModelBertha() {
        ...
        (this.Blade = new ModelRenderer((ModelBase) this, 6, 0)).addBox(0.0f, -41.0f, -1.0f, 1, 34, 3);
        ...
        (this.hg2 = new ModelRenderer((ModelBase) this, 0, 15)).addBox(0.0f, -8.0f, -5.0f, 1, 1, 1);
        ...
        (this.hg4 = new ModelRenderer((ModelBase) this, 0, 18)).addBox(0.0f, -8.0f, 5.0f, 1, 1, 1);
        ...
        (this.hg3 = new ModelRenderer((ModelBase) this, 0, 21)).addBox(-4.0f, -8.0f, 0.0f, 1, 1, 1);
        ...
        (this.hg1 = new ModelRenderer((ModelBase) this, 0, 24)).addBox(4.0f, -8.0f, 0.0f, 1, 1, 1);
        ...
        (this.Tip1 = new ModelRenderer((ModelBase) this, 21, 16)).addBox(0.0f, -42.0f, -0.5f, 1, 1, 2);
        ...
        (this.Tip2 = new ModelRenderer((ModelBase) this, 22, 20)).addBox(0.0f, -43.0f, 0.0f, 1, 1, 1);
