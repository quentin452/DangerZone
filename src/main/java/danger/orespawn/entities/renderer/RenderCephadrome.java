...
import danger.orespawn.entities.entityinstance.Cephadrome;
import danger.orespawn.entities.model.ModelCephadrome;
...
public class RenderCephadrome extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "Cephadrome.png");
    }
}
