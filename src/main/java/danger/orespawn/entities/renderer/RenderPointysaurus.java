...
import danger.orespawn.entities.entityinstance.Pointysaurus;
import danger.orespawn.entities.model.ModelPointysaurus;
...
public class RenderPointysaurus extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "Pointysaurustexture.png");
    }
}
