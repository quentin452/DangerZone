...
public class NetworkHelper {
    ...
    public NetworkHelper(String channelName, Class<? extends IPacket>... handledPacketClasses) {
        ...
        // EnumMap channelPair = NetworkRegistry.INSTANCE.newChannel(channelName, new ChannelHandler[] { new
        // ChannelCodec(handledPacketClasses), new ChannelHandler() });
    ...
    public void sendPacketToServer(IPacket packet) {
        ...
        this.clientOutboundChannel.attr(FMLOutboundHandler.FML_MESSAGETARGET)
    ...
    public void sendPacketToPlayer(IPacket packet, EntityPlayerMP player) {
        checkClassAndSync(packet.getClass());
        this.serverOutboundChannel.attr(FMLOutboundHandler.FML_MESSAGETARGET)
            .set(OutboundTarget.PLAYER);
        this.serverOutboundChannel.attr(FMLOutboundHandler.FML_MESSAGETARGETARGS)
            .set(player);
