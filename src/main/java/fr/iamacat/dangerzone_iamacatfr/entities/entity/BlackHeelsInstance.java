...
public class BlackHeelsInstance extends EntityThrowable {
    ...
    public BlackHeelsInstance(final World world, final EntityLivingBase entityLivingBase) {
    ...
    public BlackHeelsInstance(final World world) {
        super(world);
        this.my_rotation = 0.0f;
        this.my_index = 81;
        this.is_special = 0;
    ...
    public BlackHeelsInstance(final World world, final EntityLivingBase entityLivingBase, final int par3) {
        super(world, entityLivingBase);
        this.my_rotation = 0.0f;
        this.my_index = 81;
        this.is_special = 0;
    ...
    public BlackHeelsInstance(final World world, final double par2, final double par4, final double par6) {
