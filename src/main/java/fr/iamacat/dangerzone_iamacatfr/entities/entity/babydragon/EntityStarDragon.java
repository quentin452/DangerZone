...
public class EntityStarDragon extends EntityTameable
{
    ...
    public EntityStarDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(8, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.2, ItemInitDangerZone.rainbowOpalChunk, false));
        this.tasks.addTask(9, (EntityAIBase)new EntityAITempt((EntityCreature)this, 1.2, ItemInitDangerZone.rainbowOpalChunk, false));
        ...
        this.targetTasks.addTask(4, (EntityAIBase)new EntityAITargetNonTamed((EntityTameable)this, (Class)EntitySheep.class, 200, false));
        this.setTamed(false);
    }
    ...
    protected void applyEntityAttributes() {
        ...
        if (this.isTamed()) {
            this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(999.0);
        }
        else {
    ...
    protected String getLivingSound() {
        return this.isAngry() ?   Tags.MODID + ":mob.tinydragon.tinydragon" : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f) ?   Tags.MODID + ":mob.tinydragon.tinydragon" :   Tags.MODID + ":mob.tinydragon.tinydragon") :   Tags.MODID + ":mob.tinydragon.tinydragon");
    }
    ...
    public boolean attackEntityAsMob(final Entity p_70652_1_) {
        ...
        return p_70652_1_.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (float)i);
    }
    ...
    public boolean interact(final EntityPlayer p_70085_1_) {
        ...
        if (this.isTamed()) {
            ...
            if (this.func_152114_e((EntityLivingBase)p_70085_1_) && !this.worldObj.isRemote && !this.isBreedingItem(itemstack)) {
    ...
    public EntityStarDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityStarDragon entitybirchdragon = new EntityStarDragon(this.worldObj);
        final String s = this.func_152113_b();
        if (s != null && s.trim().length() > 0) {
            entitybirchdragon.func_152115_b(s);
            entitybirchdragon.setTamed(true);
        }
        return entitybirchdragon;
    }
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityStarDragon)) {
            return false;
        }
        final EntityStarDragon entitybirchdragon = (EntityStarDragon)p_70878_1_;
        return entitybirchdragon.isTamed() && !entitybirchdragon.isSitting() && (this.isInLove() && entitybirchdragon.isInLove());
    }
    ...
    public boolean getCanSpawnHere() {
        return this.posY > 90.0 && this.posY < 256.0 && super.getCanSpawnHere();
    }
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityStarDragon) {
                final EntityStarDragon entitybirchdragon = (EntityStarDragon)p_142018_1_;
                if (entitybirchdragon.isTamed() && entitybirchdragon.getOwner() == p_142018_2_) {
                    return false;
                }
            }
