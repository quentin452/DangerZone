...
public class EntityKleurloos extends EntityTameable {
    ...
    public EntityKleurloos(final World p_i1696_1_) {
        ...
        this.tasks.addTask(
            8,
            (EntityAIBase) new EntityAITempt((EntityCreature) this, 1.2, ItemInitDangerZone.pureRainbowOpalGem, false));
        this.tasks.addTask(
            9,
            (EntityAIBase) new EntityAITempt((EntityCreature) this, 1.2, ItemInitDangerZone.pureRainbowOpalGem, false));
        this.tasks.addTask(
    ...
    protected String getLivingSound() {
        return this.isAngry() ? Tags.MODID + ":mob.kleurloos.kleurloos"
            : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f)
                ? Tags.MODID + ":mob.kleurloos.kleurloos"
                : Tags.MODID + ":mob.kleurloos.kleurloos") : Tags.MODID + ":mob.kleurloos.kleurloos");
    }
    ...
    public boolean interact(final EntityPlayer p_70085_1_) {
        ...
        if (this.isTamed()) {
            ...
            if (itemstack != null && itemstack.getItem() == ItemInitDangerZone.pureRainbowOpalGem && !this.isAngry()) {
                if (!p_70085_1_.capabilities.isCreativeMode) {
