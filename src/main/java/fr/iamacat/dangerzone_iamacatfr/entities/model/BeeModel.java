...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.BeeInstance;
...
public class BeeModel extends ModelBase {
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
        ...
        GL11.glPushMatrix();
        BeeInstance beeinstance = (BeeInstance) p_78088_1_;
        float f6 = beeinstance.prevAnimTime + (beeinstance.animTime - beeinstance.prevAnimTime) * this.partialTicks;
        ...
        float f10 = 0.0F;
        float f11 = 1.5F;
        double[] adouble = beeinstance.getMovementOffsets(6, this.partialTicks);
        float f12 = this.updateRotations(
            beeinstance.getMovementOffsets(5, this.partialTicks)[0]
                - beeinstance.getMovementOffsets(10, this.partialTicks)[0]);
        float f13 = this
            .updateRotations(beeinstance.getMovementOffsets(5, this.partialTicks)[0] + (double) (f12 / 2.0F));
        f8 += 2.0F;
        ...
        for (int i = 0; i < 5; ++i) {
            double[] adouble1 = beeinstance.getMovementOffsets(5 - i, this.partialTicks);
            ...
            this.spine.rotateAngleZ = -this.updateRotations(adouble1[0] - (double) f13) * (float) Math.PI
                / 180.0F
                * f11;
        ...
        double[] adouble2 = beeinstance.getMovementOffsets(0, this.partialTicks);
        ...
        f9 = 60.0F;
        f10 = 0.0F;
        adouble = beeinstance.getMovementOffsets(11, this.partialTicks);

        for (int k = 0; k < 12; ++k) {
            adouble2 = beeinstance.getMovementOffsets(12 + k, this.partialTicks);
            f16 = (float) ((double) f16 + Math.sin((float) k * 0.45F + f14) * 0.05000000074505806D);
            this.spine.rotateAngleY = (this.updateRotations(adouble2[0] - adouble[0]) * f11 + 180.0F) * (float) Math.PI
                / 180.0F;
