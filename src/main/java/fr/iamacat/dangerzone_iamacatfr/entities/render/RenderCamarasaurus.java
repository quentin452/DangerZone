...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.CamarasaurusInstance;
...
public class RenderCamarasaurus extends RenderLiving {
    ...
    public void renderCamarasaurus(final CamarasaurusInstance par1EntityCamarasaurus, final double par2, final double par4,
    ...
    public void doRender(final EntityLiving par1EntityLiving, final double par2, final double par4, final double par6,
        ...
        this.renderCamarasaurus((CamarasaurusInstance) par1EntityLiving, par2, par4, par6, par8, par9);
    }

    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6,
        final float par8, final float par9) {
        this.renderCamarasaurus((CamarasaurusInstance) par1Entity, par2, par4, par6, par8, par9);
    }

    protected void preRenderScale(final CamarasaurusInstance par1Entity, final float par2) {
    ...
    protected void preRenderCallback(final EntityLivingBase par1EntityLiving, final float par2) {
        this.preRenderScale((CamarasaurusInstance) par1EntityLiving, par2);
    }
