...
public class MagicRenderer extends Render {

    public int spinItemIconIndex;
    private static final ResourceLocation texturess;
    ...
    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6,
        ...
        this.bindTexture(MagicRenderer.texturess);
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return MagicRenderer.texturess;
    }

    static {
        texturess = new ResourceLocation(Tags.MODID + ":" + "projectiles.png");
    }
}
