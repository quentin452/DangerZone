...
public class CassowaryInstance extends EntityAnimal {

    private float moveSpeed;

    public CassowaryInstance(final World par1World) {
        super(par1World);
    ...
    public CassowaryInstance spawnBabyAnimal(final EntityAgeable par1EntityAgeable) {
        return new CassowaryInstance(this.worldObj);
    }
