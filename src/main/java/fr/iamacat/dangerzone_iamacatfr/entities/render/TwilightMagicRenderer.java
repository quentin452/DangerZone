...
public class TwilightMagicRenderer extends Render {

    private static final ResourceLocation texturetwistar;
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        final TwilicornArrowInstance r = (TwilicornArrowInstance) entity;
        return TwilightMagicRenderer.texturetwistar;
    }

    static {
        texturetwistar = new ResourceLocation(Tags.MODID + ":" + "textures/items/twilightstar.png");
    }
}
