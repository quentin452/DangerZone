...
public class CreepingHorrorInstance extends EntityMob {

    private GenericTargetSorter TargetSorter;
    private float moveSpeed;

    public CreepingHorrorInstance(final World par1World) {
        super(par1World);
    ...
    public boolean getCanSpawnHere() {
        return this.isValidLightLevel() && !this.worldObj.isDaytime()
            && (this.worldObj.provider.dimensionId == DimensionInitDangerZone.ChaosDimensionId || this.posY <= 15.0);
    }
