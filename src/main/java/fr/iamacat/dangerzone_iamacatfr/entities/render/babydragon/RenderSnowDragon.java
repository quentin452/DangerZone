...
public class RenderSnowDragon extends RenderLiving
{
    private static final ResourceLocation texture;
    private ModelBase scaleAmount;

    public RenderSnowDragon() {
        super((ModelBase)new ModelTinyDragon(), 0.55f);
    }

    public RenderSnowDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderSnowDragon.texture;
    }
