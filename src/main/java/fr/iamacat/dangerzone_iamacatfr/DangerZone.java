    ...
    public static FairyInstance getFairy(int fairyID) {
        ...
        public void preInit(final FMLPreInitializationEvent event) {
            ...
            MySunspotUrchin = new ItemSunspotUrchin(BaseItemID + 246)
                .setUnlocalizedName("sunspoturchin");
            ...
            MyBlueFish = new ItemGenericFish(BaseItemID + 192, 4, 0.4f, false)
                .setUnlocalizedNamItemRocke("bluefish");
            ...
            MothScaleHelmet = (ItemOreSpawnArmor) new ItemOreSpawnArmor(
                BaseItemID + 294,
                armorMOTHSCALE,
                proxy.setArmorPrefix("mothscale"),
            ...
            ExperienceHelmet = (ItemOreSpawnArmor) new ItemOreSpawnArmor(
                BaseItemID + 290,
                armorEXPERIENCE,
                proxy.setArmorPrefix("experience"),
            ...
            TigersEyeHelmet = (ItemOreSpawnArmor) new ItemOreSpawnArmor(
                BaseItemID + 354,
                armorTIGERSEYE,
                proxy.setArmorPrefix("tigerseye"),
        ...
        public void initializeCagesAndEggs() {
            ...
            WitherSkeletonEgg = new ItemSpawnEgg(BaseItemID + 100, 192)
                .setUnlocalizedName("eggwitherskeleton");
            EnderDragonEgg = new ItemSpawnEgg(BaseItemID + 101, 193)
                .setUnlocalizedName("eggenderdragon");
            SnowGolemEgg = new ItemSpawnEgg(BaseItemID + 102, 194)
                .setUnlocalizedName("eggsnowgolem");
            IronGolemEgg = new ItemSpawnEgg(BaseItemID + 103, 195)
                .setUnlocalizedName("eggirongolem");
            WitherBossEgg = new ItemSpawnEgg(BaseItemID + 104, 196)
                .setUnlocalizedName("eggwitherboss");
            GirlfriendEgg = new ItemSpawnEgg(BaseItemID + 105, 197)
                .setUnlocalizedName("egggirlfriend");
            RedCowEgg = new ItemSpawnEgg(BaseItemID + 106, 198).setUnlocalizedName("eggredcow");
            CrystalCowEgg = new ItemSpawnEgg(BaseItemID + 431, 363)
                .setUnlocalizedName("eggcrystalcow");
            GoldCowEgg = new ItemSpawnEgg(BaseItemID + 107, 199).setUnlocalizedName("egggoldcow");
            EnchantedCowEgg = new ItemSpawnEgg(BaseItemID + 108, 200)
                .setUnlocalizedName("eggenchantedcow");
            ...
            CryoEgg = new ItemSpawnEgg(BaseItemID + 111, 203)
                .setUnlocalizedName("eggcryolophosaurus");
            CamaEgg = new ItemSpawnEgg(BaseItemID + 112, 204)
                .setUnlocalizedName("eggcamarasaurus");
            VeloEgg = new ItemSpawnEgg(BaseItemID + 113, 205)
                .setUnlocalizedName("eggvelocityraptor");
            ...
            DragonflyEgg = new ItemSpawnEgg(BaseItemID + 116, 221)
                .setUnlocalizedName("eggdragonfly");
            EmperorScorpionEgg = new ItemSpawnEgg(BaseItemID + 117, 223)
                .setUnlocalizedName("eggemperorscorpion");
            ScorpionEgg = new ItemSpawnEgg(BaseItemID + 118, 225)
                .setUnlocalizedName("eggscorpion");
            CaveFisherEgg = new ItemSpawnEgg(BaseItemID + 119, 227)
                .setUnlocalizedName("eggcavefisher");
            SpyroEgg = new ItemSpawnEgg(BaseItemID + 120, 229).setUnlocalizedName("eggspyro");
            BaryonyxEgg = new ItemSpawnEgg(BaseItemID + 121, 231)
                .setUnlocalizedName("eggbaryonyx");
            GammaMetroidEgg = new ItemSpawnEgg(BaseItemID + 122, 233)
                .setUnlocalizedName("egggammametroid");
            CockateilEgg = new ItemSpawnEgg(BaseItemID + 123, 235)
                .setUnlocalizedName("eggcockateil");
            ...
            AttackSquidEgg = new ItemSpawnEgg(BaseItemID + 126, 241)
                .setUnlocalizedName("eggattacksquid");
            WaterDragonEgg = new ItemSpawnEgg(BaseItemID + 127, 243)
                .setUnlocalizedName("eggwaterdragon");
            CephadromeEgg = new ItemSpawnEgg(BaseItemID + 130, 249)
                .setUnlocalizedName("eggcephadrome");
            ...
            TrooperBugEgg = new ItemSpawnEgg(BaseItemID + 133, 262)
                .setUnlocalizedName("eggtrooper");
            ...
            ChipmunkEgg = new ItemSpawnEgg(BaseItemID + 138, 267)
                .setUnlocalizedName("eggchipmunk");
            CreepingHorrorEgg = new ItemSpawnEgg(BaseItemID + 139, 274)
                .setUnlocalizedName("eggcreepinghorror");
            TerribleTerrorEgg = new ItemSpawnEgg(BaseItemID + 140, 275)
                .setUnlocalizedName("eggterribleterror");
            CliffRacerEgg = new ItemSpawnEgg(BaseItemID + 141, 276)
                .setUnlocalizedName("eggcliffracer");
            TriffidEgg = new ItemSpawnEgg(BaseItemID + 142, 277).setUnlocalizedName("eggtriffid");
            PitchBlackEgg = new ItemSpawnEgg(BaseItemID + 143, 278)
                .setUnlocalizedName("eggnightmare");
            LurkingTerrorEgg = new ItemSpawnEgg(BaseItemID + 144, 279)
                .setUnlocalizedName("egglurkingterror");
            GodzillaEgg = new ItemSpawnEgg(BaseItemID + 145, 280)
                .setUnlocalizedName("egggodzilla");
            SmallWormEgg = new ItemSpawnEgg(BaseItemID + 146, 288)
                .setUnlocalizedName("eggsmallworm");
            MediumWormEgg = new ItemSpawnEgg(BaseItemID + 147, 289)
                .setUnlocalizedName("eggmediumworm");
            LargeWormEgg = new ItemSpawnEgg(BaseItemID + 148, 290)
                .setUnlocalizedName("egglargeworm");
            CassowaryEgg = new ItemSpawnEgg(BaseItemID + 149, 291)
                .setUnlocalizedName("eggcassowary");
            CloudSharkEgg = new ItemSpawnEgg(BaseItemID + 165, 292)
                .setUnlocalizedName("eggcloudshark");
            GoldFishEgg = new ItemSpawnEgg(BaseItemID + 166, 293)
                .setUnlocalizedName("egggoldfish");
            LeafMonsterEgg = new ItemSpawnEgg(BaseItemID + 167, 294)
                .setUnlocalizedName("eggleafmonster");
            TshirtEgg = new ItemSpawnEgg(BaseItemID + 168, 295).setUnlocalizedName("eggtshirt");
            EnderKnightEgg = new ItemSpawnEgg(BaseItemID + 169, 298)
                .setUnlocalizedName("eggenderknight");
            EnderReaperEgg = new ItemSpawnEgg(BaseItemID + 170, 299)
                .setUnlocalizedName("eggenderreaper");
            ...
            DungeonBeastEgg = new ItemSpawnEgg(BaseItemID + 222, 306)
                .setUnlocalizedName("eggdungeonbeast");
            RatEgg = new ItemSpawnEgg(BaseItemID + 374, 307).setUnlocalizedName("eggrat");
            FlounderEgg = new ItemSpawnEgg(BaseItemID + 375, 308)
                .setUnlocalizedName("eggflounder");
            WhaleEgg = new ItemSpawnEgg(BaseItemID + 376, 309).setUnlocalizedName("eggwhale");
            IrukandjiEgg = new ItemSpawnEgg(BaseItemID + 377, 310)
                .setUnlocalizedName("eggirukandji");
            ...
            GhostSkellyEgg = new ItemSpawnEgg(BaseItemID + 385, 329)
                .setUnlocalizedName("eggghostskelly");
            BrownAntEgg = new ItemSpawnEgg(BaseItemID + 386, 330)
                .setUnlocalizedName("eggbrownant");
            RedAntEgg = new ItemSpawnEgg(BaseItemID + 387, 331).setUnlocalizedName("eggredant");
            RainbowAntEgg = new ItemSpawnEgg(BaseItemID + 388, 332)
                .setUnlocalizedName("eggrainbowant");
            UnstableAntEgg = new ItemSpawnEgg(BaseItemID + 389, 333)
                .setUnlocalizedName("eggunstableant");
            TermiteEgg = new ItemSpawnEgg(BaseItemID + 390, 334).setUnlocalizedName("eggtermite");
            ButterflyEgg = new ItemSpawnEgg(BaseItemID + 391, 335)
                .setUnlocalizedName("eggbutterfly");
            MothEgg = new ItemSpawnEgg(BaseItemID + 392, 336).setUnlocalizedName("eggmoth");
            MosquitoEgg = new ItemSpawnEgg(BaseItemID + 393, 337)
                .setUnlocalizedName("eggmosquito");
            ...
            HerculesEgg = new ItemSpawnEgg(BaseItemID + 226, 340)
                .setUnlocalizedName("egghercules");
            ...
            BoyfriendEgg = new ItemSpawnEgg(BaseItemID + 399, 349)
                .setUnlocalizedName("eggboyfriend");
            TheKingEgg = new ItemSpawnEgg(BaseItemID + 400, 350).setUnlocalizedName("eggtheking");
            TheQueenEgg = new ItemSpawnEgg(BaseItemID + 448, 366)
                .setUnlocalizedName("eggthequeen");
            ThePrinceEgg = new ItemSpawnEgg(BaseItemID + 401, 351)
                .setUnlocalizedName("eggtheprince");
            EasterBunnyEgg = new ItemSpawnEgg(BaseItemID + 416, 352)
                .setUnlocalizedName("eggeasterbunny");
            MolenoidEgg = new ItemSpawnEgg(BaseItemID + 417, 353)
                .setUnlocalizedName("eggmolenoid");
            SeaMonsterEgg = new ItemSpawnEgg(BaseItemID + 418, 354)
                .setUnlocalizedName("eggseamonster");
            SeaViperEgg = new ItemSpawnEgg(BaseItemID + 419, 355)
                .setUnlocalizedName("eggseaviper");
            CaterKillerEgg = new ItemSpawnEgg(BaseItemID + 420, 356)
                .setUnlocalizedName("eggcaterkiller");
            RubberDuckyEgg = new ItemSpawnEgg(BaseItemID + 428, 362)
                .setUnlocalizedName("eggrubberducky");
            HammerheadEgg = new ItemSpawnEgg(BaseItemID + 426, 360)
                .setUnlocalizedName("egghammerhead");
            LeonEgg = new ItemSpawnEgg(BaseItemID + 424, 358).setUnlocalizedName("eggleon");
            CriminalEgg = new ItemSpawnEgg(BaseItemID + 434, 365)
                .setUnlocalizedName("eggcriminal");
            BrutalflyEgg = new ItemSpawnEgg(BaseItemID + 459, 367)
                .setUnlocalizedName("eggbrutalfly");
            NastysaurusEgg = new ItemSpawnEgg(BaseItemID + 460, 368)
                .setUnlocalizedName("eggnastysaurus");
            PointysaurusEgg = new ItemSpawnEgg(BaseItemID + 461, 369)
                .setUnlocalizedName("eggpointysaurus");
            CricketEgg = new ItemSpawnEgg(BaseItemID + 462, 370).setUnlocalizedName("eggcricket");
            ThePrincessEgg = new ItemSpawnEgg(BaseItemID + 463, 371)
                .setUnlocalizedName("eggtheprincess");
            ...
            AntRobotEgg = new ItemSpawnEgg(BaseItemID + 475, 379)
                .setUnlocalizedName("eggantrobot");
            SpiderRobotEgg = new ItemSpawnEgg(BaseItemID + 476, 380)
                .setUnlocalizedName("eggspiderrobot");
            SpiderDriverEgg = new ItemSpawnEgg(BaseItemID + 477, 381)
                .setUnlocalizedName("eggspiderdriver");
