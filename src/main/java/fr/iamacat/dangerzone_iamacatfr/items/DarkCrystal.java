...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.DarkCrystalCannon;
...
public class DarkCrystal extends Item {
    ...
    public ItemStack onItemRightClick(final ItemStack par1ItemStack, final World par2World,
        ...
        final DarkCrystalCannon lb = new DarkCrystalCannon(par2World, (EntityLivingBase) par3EntityPlayer);
        ...
        final DarkCrystalCannon darkCrystalCannon = lb;
        darkCrystalCannon.motionX *= 1.8;
        final DarkCrystalCannon darkCrystalCannon2 = lb;
        darkCrystalCannon2.motionY *= 1.8;
        final DarkCrystalCannon darkCrystalCannon3 = lb;
