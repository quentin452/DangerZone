...
public class EntityAIFollowOwner extends EntityAIBase
{
    ...
    public EntityAIFollowOwner(final EntityGenericAnimal par1EntityTameable, final float par2, final float par3, final float par4) {
    ...
    public void updateTask() {
        ...
        if (!this.thePet.isSitting() && --this.field_75343_h <= 0) {
            ...
            if (!this.petPathfinder.tryMoveToEntityLiving((Entity)this.theOwner, (double)this.moveSpeed) && this.thePet.getDistanceSqToEntity((Entity)this.theOwner) >= 144.0) {
