...
public class EyeRayInstance extends EntityLiving
{
	...
	*/
	...
	public EyeRayInstance(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        super(par1World);
        this.setSize(1.0F, 1.0F);
	...
	public void onUpdate()
    {
        ...
        else
        {
            ...
            for (int var8 = 0; var8 < var5.size(); ++var8)
            {
                ...
                if (var9.canBeCollidedWith() && (!var9.isEntityEqual(this.shootingEntity) || this.ticksInAir >= 25) && !(var9 instanceof EyeRayInstance) && !(var9 instanceof EntityArrow) && !(var9 instanceof EntityThrowable))
                {
                    float var10 = 0.3F;
