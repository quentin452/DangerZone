...
import fr.iamacat.dangerzone_iamacatfr.entities.ai.unfinished.RandomPositionGenerator;
...
public class EntityAIAvoidEntity extends EntityAIBase
{
    ...
    public EntityAIAvoidEntity(final EntityGenericCreature par1, final Class par2, final float par3, final double par4, final double par5) {
    ...
    public EntityAIAvoidEntity(final EntityGenericCreature par1, final Class par2, final float par3, final double par4, final double par5, final boolean shouldHop) {
    ...
    public void tryToHop() {
        if (this.theEntity.onGround && this.slimeJumpDelay-- <= 0) {
            ...
            this.theEntity.getNavigator().setSpeed(0.0);
        }
    }

    protected int getJumpDelay() {
        if (this.theEntity.getEntityState() == EntityStates.fleeing) {
            return this.theEntity.getRNG().nextInt(3);
        }
        return this.theEntity.getRNG().nextInt(5) + 2;
    }
}
