...
public class Alien extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage)
            .setBaseValue(OreSpawnMain.Alien_stats.attack);
    }
        ...
        if (super.attackEntityAsMob(par1Entity)) {
            if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
                ...
                if (par1Entity instanceof EntityLivingBase && this.worldObj.rand.nextInt(5) == 1) {
                    ((EntityLiving) par1Entity).addPotionEffect(new PotionEffect(Potion.poison.id, var2 * 5, 0));
                }
                final double ks = 1.1;
                double inair = 0.1;
    ...
    protected void updateAITasks() {
        ...
        if (this.worldObj.rand.nextInt(8) == 0) {
            ...
            if (this.closest < 99999) {
                ...
                if (this.closest < 27 && this.worldObj.getGameRules()
