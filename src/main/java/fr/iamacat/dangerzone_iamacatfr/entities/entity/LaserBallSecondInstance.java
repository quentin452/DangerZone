...
public class LaserBallSecondInstance extends EntityThrowable {
    ...
    public LaserBallSecondInstance(final World par1World) {
        super(par1World);
    ...
    public LaserBallSecondInstance(final World par1World, final int par2) {
        super(par1World);
        this.my_rotation = 0.0f;
        this.my_index = 81;
        this.is_special = 0;
    ...
    public LaserBallSecondInstance(final World par1World, final EntityLivingBase par2EntityLiving) {
    ...
    public LaserBallSecondInstance(final World par1World, final EntityLivingBase par2EntityLiving, final int par3) {
        super(par1World, par2EntityLiving);
        this.my_rotation = 0.0f;
        this.my_index = 81;
        this.is_special = 0;
    ...
    public LaserBallSecondInstance(final World par1World, final double par2, final double par4, final double par6) {
