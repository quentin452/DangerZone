...
public class EntityCaveDragon extends DecoyCaveDragonTameable
{
    ...
    public EntityCaveDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    public EntityCaveDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityCaveDragon entityalpsdragon = new EntityCaveDragon(this.worldObj);
    ...
    public boolean getCanSpawnHere() {
        return this.posY < 50.0 && super.getCanSpawnHere();
    }
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityCaveDragon)) {
            return false;
        }
        final EntityCaveDragon entityalpsdragon = (EntityCaveDragon)p_70878_1_;
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityCaveDragon) {
                final EntityCaveDragon entityalpsdragon = (EntityCaveDragon)p_142018_1_;
