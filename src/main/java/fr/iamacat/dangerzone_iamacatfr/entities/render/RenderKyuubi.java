...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.Kyuubi;
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelKyuubi;
...
public class RenderKyuubi extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation(Tags.MODID+":Kyuubi.png");
    }
}
