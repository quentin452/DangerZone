...
public class BlockExperiencePlant extends BlockReed {
    ...
    public void updateTick(final World par1World, final int par2, final int par3, final int par4,
        ...
        DangerZone.OreSpawnTrees.ExperienceTree(par1World, par2, par3 - 1, par4);
    }

    public Item getItemDropped(final int p_149650_1_, final Random p_149650_2_, final int p_149650_3_) {
        return Item.getItemFromBlock(BlockInitDangerZone.BlockExperiencePlant);
    }
    ...
    protected Item getSeedItem() {
        return ItemInitDangerZone.ItemExperienceTreeSeed;
    }
