...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.SpitBug;
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelSpitBug;
...
public class RenderSpitBug extends RenderLiving {
    ...
    public void renderSpitBug(final SpitBug par1EntitySpitBug, final double par2, final double par4, final double par6,
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":BlisterBug.png");
    }
}
