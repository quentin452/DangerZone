...
public class DemonSpiderInstance extends EntityMob {
    ...
    public DemonSpiderInstance(final World par1World) {
        super(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof DemonSpiderInstance) {
            return false;
        }
    ...
    public boolean getCanSpawnHere() {
        ...
        DemonSpiderInstance target = null;
        target = (DemonSpiderInstance) this.worldObj.findNearestEntityWithinAABB(
            (Class<DemonSpiderInstance>) DemonSpiderInstance.class,
