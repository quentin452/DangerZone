...
public class MassoRenderer extends RenderLiving
{
    ...
    public void func_177_a(final MassoInstance entityMasso, final double d, final double d1, final double d2, final float f, final float f1) {
        super.doRender((EntityLiving)entityMasso, d, d1, d2, f, f1);
    }

    public void doRenderLiving(final EntityLivingBase entityliving, final double d, final double d1, final double d2, final float f, final float f1) {
