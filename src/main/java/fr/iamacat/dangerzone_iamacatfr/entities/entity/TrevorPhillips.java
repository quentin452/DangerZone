...
public class TrevorPhillips extends EntityMob {
    ...
    public TrevorPhillips(final World par1World) {
        super(par1World);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        return !(par1EntityLiving instanceof TrevorPhillips);
    }
            ...
            for (int j = -3; j < 3; ++j) {
                for (int i = 0; i < 5; ++i) {
                    ...
                    if (bid == Blocks.mob_spawner) {
                        ...
                        if (s != null && s.equals("TrevorPhillips")) {
                            return true;
                        }
                    }
                }
