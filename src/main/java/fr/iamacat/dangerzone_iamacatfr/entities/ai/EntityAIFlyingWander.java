...
public class EntityAIFlyingWander extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        final Vec3 var1 = RandomPositionGenerator
            .flyRandomlyTowardHeightLevel(this.entity, 10, 7, this.entity.getMaxFlightHeight());
        if (var1 == null) {
            return false;
        }
    ...
    public boolean continueExecuting() {
        return this.entity.getRNG()
            .nextInt(100) != 0 && !this.entity.atTargetPosition() && this.entity.isTargetPositionValid();
    }

    public void startExecuting() {
        this.entity
            .setTargetPosition(new ChunkCoordinates((int) this.xPosition, (int) this.yPosition, (int) this.zPosition));
    }
}
