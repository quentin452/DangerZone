...
public class MeteorRenderer extends Render {
    ...
    private static final ResourceLocation texturemeteor;
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        ...
        return MeteorRenderer.texturemeteor;
    }

    static {
        texturemeteor = new ResourceLocation(Tags.MODID + ":" + "textures/items/meteoritem.png");
    }
}
