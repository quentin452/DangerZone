...
public class RenderEndDragon extends RenderLiving {

    private static final ResourceLocation texture;
    private ModelBase scaleAmount;

    public RenderEndDragon() {
        super((ModelBase) new ModelTinyDragon(), 0.55f);
    }

    public RenderEndDragon(final ModelBase p_i1267_1_, final ModelBase p_i1267_2_, final float p_i1267_3_) {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return RenderEndDragon.texture;
    }
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":textures/entity/babydragon/end.png");
    }
}
