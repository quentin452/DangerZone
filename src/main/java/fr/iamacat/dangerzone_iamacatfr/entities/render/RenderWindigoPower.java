...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.WindigoPower;
import fr.iamacat.dangerzone_iamacatfr.util.Tags;

@SideOnly(Side.CLIENT)
public class RenderWindigoPower extends Render {
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        final WindigoPower r = (WindigoPower) entity;
        return RenderWindigoPower.texturepowa;
    }
