...
public class GirlfriendOverlayGui extends Gui {
    ...
    public void onRenderOverlay(final RenderGameOverlayEvent event) {
        ...
        DangerZone.current_dimension = player.worldObj.provider.dimensionId;
        if (this.mc.gameSettings.fancyGraphics) {
            DangerZone.FastGraphicsLeaves = 0;
        } else {
            DangerZone.FastGraphicsLeaves = 1;
        }
        entity = this.mc.pointedEntity;
        if (entity == null) {
            entity = DangerZone.getPointedAtEntity((World) this.mc.theWorld, player, 16.0);
            if (entity == null) {
                return;
            }
        ...
        if (entity instanceof GirlfriendInstance) {
            GirlfriendInstance gf = null;
            gf = (GirlfriendInstance) entity;
        ...
        if (entity instanceof BoyfriendInstance) {
            BoyfriendInstance gf2 = null;
            gf2 = (BoyfriendInstance) entity;
        ...
        if (entity instanceof DragonInstance) {
            DragonInstance df = null;
            df = (DragonInstance) entity;
        ...
        if (entity instanceof BasiliskInstance) {
            final BasiliskInstance e2 = (BasiliskInstance) entity;
            outstring = "Basilisk";
        ...
        if (entity instanceof CephadromeInstance) {
            final CephadromeInstance e9 = (CephadromeInstance) entity;
        ...
        if (entity instanceof AlosaurusInstance) {
            final AlosaurusInstance e13 = (AlosaurusInstance) entity;
            outstring = "Alosaurus";
        ...
        if (entity instanceof CaterKillerInstance) {
            final CaterKillerInstance e30 = (CaterKillerInstance) entity;
        ...
        if (entity instanceof BandPInstance) {
            final BandPInstance e33 = (BandPInstance) entity;
            if (e33.getWhat() == 0) {
                outstring = "Banker";
            } else {
        ...
        if (entity instanceof RedAntRobotInstance) {
            final RedAntRobotInstance e36 = (RedAntRobotInstance) entity;
            outstring = "Giant Robot Red Ant";
            gfHealth = e36.getHealth() / e36.getMaxHealth();
        }
        if (entity instanceof CrabInstance) {
            final CrabInstance e37 = (CrabInstance) entity;
