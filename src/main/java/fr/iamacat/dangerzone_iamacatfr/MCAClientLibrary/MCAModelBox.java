...
public class MCAModelBox extends ModelBox
{
    ...
    public MCAModelBox(final ModelRenderer par1ModelRenderer, final int textureX, final int textureY, float posX, float posY, float posZ, final int sizeX, final int sizeY, final int sizeZ, final float scaleFactor) {
