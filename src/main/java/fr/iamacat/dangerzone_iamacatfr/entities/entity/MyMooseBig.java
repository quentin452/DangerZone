...
public class MyMooseBig extends EntityMob {
    ...
    public MyMooseBig(final World par1World) {
        super(par1World);
    ...
    private EntityLivingBase Rampage(final double X, final double Y, final double Z, final double dist,
        ...
        while (var6.hasNext()) {
            ...
            if (this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && var8 != null
                && var8 != this
                && var8.isEntityAlive()
                && !(var8 instanceof MyMooseBig)
                && !(var8 instanceof MyMoose)) {
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyMoose) {
            return false;
        }
    ...
    private EntityLivingBase findSomethingToAttack() {
        ...
        final List var5 = this.worldObj
            .getEntitiesWithinAABB((Class) EntityLivingBase.class, this.boundingBox.expand(32.0, 8.0, 32.0));
        Collections.sort((List<Object>) var5, (Comparator<? super Object>) this.TargetSorter);
        final Iterator var6 = var5.iterator();
        Entity var7 = null;
        EntityLivingBase var8 = null;
    ...
    public boolean getCanSpawnHere() {
        ...
        MyMooseBig target = null;
        target = (MyMooseBig) this.worldObj.findNearestEntityWithinAABB(
            (Class) MyMooseBig.class,
