...
public abstract class GenericRideableInstance extends GenericBreedableInstance {

    public GenericRideableInstance(final World par1World) {
        super(par1World);
    }
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (this.isRideable()) {
            if (this.getSaddled() && !this.worldObj.isRemote
                && (this.riddenByEntity == null || this.riddenByEntity == par1EntityPlayer)) {
                par1EntityPlayer.mountEntity(this);
                return true;
            }
            if (!this.getSaddled() && par1EntityPlayer.inventory.getCurrentItem() != null
