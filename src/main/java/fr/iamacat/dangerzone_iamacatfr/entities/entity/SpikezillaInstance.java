...
public class SpikezillaInstance extends EntityMob {
    ...
    public SpikezillaInstance(final World par1World) {
        super(par1World);
        ...
        if (this.worldObj.rand.nextInt(5 - this.largemob) == 1) {
            ...
            if (e != null) {
                if (!e.isEntityAlive()) {
                    this.setAttackTarget(null);
                    e = null;
                } else if (e instanceof SpikezillaInstance) {
                    this.setAttackTarget(null);
                    e = null;
                }
            }
            ...
            if (e != null) {
                ...
                if (this.worldObj.rand.nextInt(6) == 1) {
                    ...
                    if (this.worldObj.rand.nextInt(4 - this.largemob) == 0
                        ...
                        if (s > 50.0f && !(e instanceof SpikezillaInstance)
                            && !(e instanceof HydraInstance)
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof SpikezillaInstance) {
            return true;
        }
    ...
    private void MagicCannon(final EntityLivingBase e) {
        ...
        for (int i = 0; i < 30; ++i) {
            final MavisBallInstance var3 = new MavisBallInstance(
                this.worldObj,
                e.posX - this.posX,
                e.posY + 0.75 - (this.posY + yoff),
                e.posZ - this.posZ);
    ...
    private void PhoenixFlame(final EntityLivingBase e) {
        ...
        if (this.rand.nextInt(10) == 1) {
            final PhoenixArrowInstance var2 = new PhoenixArrowInstance(
                this.worldObj,
                e.posX - this.posX,
                e.posY + 0.75 - (this.posY + yoff),
                e.posZ - this.posZ);
        ...
        for (int i = 0; i < 10; ++i) {
            final PhoenixArrowInstance var3 = new PhoenixArrowInstance(
                this.worldObj,
                e.posX - this.posX,
                e.posY + 0.75 - (this.posY + yoff),
                e.posZ - this.posZ);
    ...
    private void WindyMagic(final EntityLivingBase e) {
        ...
        for (int i = 0; i < 1; ++i) {
            final WindigoPowerInstance var3 = new WindigoPowerInstance(
                this.worldObj,
                e.posX - this.posX,
                e.posY + 0.75 - (this.posY + yoff),
                e.posZ - this.posZ);
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        if (par1Entity instanceof EntityLivingBase) {
            ...
            if (s > 50.0f && !(par1Entity instanceof SpikezillaInstance)
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (!par1DamageSource.getDamageType()
            ...
            if (e != null && e instanceof EntityLivingBase && !(e instanceof SpikezillaInstance)) {
