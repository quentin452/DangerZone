...
public class EntityDirectedLightning extends EntityWeatherEffect
{
	...
	public void onUpdate()
	{
		...
		{
			if (this.user != null) this.worldObj.playSoundAtEntity(this.user, Tags.MODID +  ":random.directedlightning", 0.3F, rand.nextFloat() * 0.5F);
			this.worldObj.playSoundAtEntity(this, Tags.MODID +  ":random.directedlightning", 0.4F, rand.nextFloat() * 0.3F);
