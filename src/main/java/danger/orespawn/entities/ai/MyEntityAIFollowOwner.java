...
public class MyEntityAIFollowOwner extends EntityAIBase {
    ...
    public MyEntityAIFollowOwner(final EntityTameable par1EntityTameable, final float par2, final float par3,
        final float par4) {
    ...
    public boolean shouldExecute() {
        ...
        this.theOwner = var1;
        return !this.thePet.isSitting() && (!(this.thePet instanceof Girlfriend) || OreSpawnMain.valentines_day == 0)
            && ((this.thePet != null && (this.thePet.posY < 60.0 || !this.thePet.worldObj.isDaytime())
                && this.thePet.getDistanceSqToEntity(var1) > this.maxDist / 2.0f * (this.maxDist / 2.0f))
                || this.thePet.getDistanceSqToEntity(var1) >= this.maxDist * this.maxDist);
    }
    ...
    public boolean continueExecuting() {
        ...
        if (this.thePet != null && this.thePet instanceof EntityTameable) {
            ...
            if (var1 != null && (int) gf.posZ == (int) var1.posZ
