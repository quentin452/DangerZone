...
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelRobot5;
...
public class RenderRobot5 extends RenderLiving {
    ...
    public void renderRobot5(final Robot5 par1EntityRobot5, final double par2, final double par4, final double par6,
    ...
    protected void preRenderScale(final Robot5 par1Entity, final float par2) {
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":Robot5texture.png");
    }
}
