...
public class LunaMothInstance extends ButterflyInstance {
    ...
    public LunaMothInstance(final World par1World) {
        super(par1World);
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth)
            .setBaseValue(this.getMaxHealth());
    ...
    private boolean scan_it(final int x, final int y, final int z, final int dx, final int dy, final int dz) {
        ...
        for (int i = -dy; i <= dy; ++i) {
            for (int j = -dz; j <= dz; ++j) {
                ...
                if (bid == Blocks.torch || bid == BlockInitDangerZone.blocktorch) {
