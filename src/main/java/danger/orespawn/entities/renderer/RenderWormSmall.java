...
import danger.orespawn.entities.entityinstance.WormSmall;
import danger.orespawn.entities.model.ModelWormSmall;
...
public class RenderWormSmall extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "WormSmalltexture.png");
    }
}
