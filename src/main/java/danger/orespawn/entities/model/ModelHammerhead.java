...
public class ModelHammerhead extends ModelBase {
    ...
    public ModelHammerhead(final float f1) {
        ...
        (this.chest = new ModelRenderer((ModelBase) this, 0, 0)).addBox(-9.0f, -1.0f, 0.0f, 19, 16, 17);
        ...
        (this.abdomen = new ModelRenderer((ModelBase) this, 0, 34)).addBox(-7.5f, 0.0f, 0.0f, 16, 14, 16);
        ...
        (this.neck = new ModelRenderer((ModelBase) this, 146, 59)).addBox(-6.5f, -0.5f, -12.0f, 14, 13, 13);
        ...
        (this.head = new ModelRenderer((ModelBase) this, 101, 59)).addBox(-6.0f, -0.5f, -21.0f, 13, 11, 9);
        ...
        (this.snout = new ModelRenderer((ModelBase) this, 166, 86)).addBox(-4.0f, -6.0f, -27.0f, 9, 8, 8);
        ...
        (this.neck_armour = new ModelRenderer((ModelBase) this, 73, 0)).addBox(-7.0f, -1.5f, -18.0f, 15, 4, 18);
        ...
        (this.horn_base = new ModelRenderer((ModelBase) this, 49, 35)).addBox(-7.0f, -1.5f, -27.0f, 15, 5, 9);
        ...
        (this.horn_1 = new ModelRenderer((ModelBase) this, 122, 23)).addBox(-12.0f, -4.5f, -40.0f, 25, 6, 14);
        ...
        (this.horn_2 = new ModelRenderer((ModelBase) this, 106, 44)).addBox(-18.0f, -3.5f, -37.0f, 37, 4, 10);
        ...
        (this.horn_R = new ModelRenderer((ModelBase) this, 158, 0)).addBox(-26.0f, -5.5f, -38.5f, 8, 7, 13);
        ...
        (this.horn_L = new ModelRenderer((ModelBase) this, 158, 0)).addBox(19.0f, -5.5f, -38.5f, 8, 7, 13);
        ...
        (this.back_armour1 = new ModelRenderer((ModelBase) this, 0, 98)).addBox(-5.0f, -2.5f, -6.0f, 9, 3, 7);
        ...
        (this.back_armour_2 = new ModelRenderer((ModelBase) this, 0, 65)).addBox(-8.0f, -4.5f, -13.0f, 17, 4, 28);
        ...
        (this.back_armour_3 = new ModelRenderer((ModelBase) this, 15, 104)).addBox(0.5f, -3.5f, -13.0f, 4, 4, 20);
        ...
        (this.back_armour_3R = new ModelRenderer((ModelBase) this, 15, 104)).addBox(-3.5f, -3.5f, -13.0f, 4, 4, 20);
        ...
        (this.back_armour_4 = new ModelRenderer((ModelBase) this, 0, 65)).addBox(1.5f, -1.5f, -3.0f, 3, 4, 10);
        ...
        (this.back_armour_4R = new ModelRenderer((ModelBase) this, 0, 65)).addBox(-1.5f, -1.5f, -3.0f, 3, 4, 10);
        ...
        (this.tail = new ModelRenderer((ModelBase) this, 66, 52)).addBox(-2.0f, 0.0f, -3.0f, 5, 5, 3);
        ...
        (this.leg_1R = new ModelRenderer((ModelBase) this, 71, 102)).addBox(-2.5f, -2.5f, -3.0f, 5, 10, 6);
        ...
        (this.leg_1 = new ModelRenderer((ModelBase) this, 64, 76)).addBox(-1.5f, -2.5f, -3.0f, 5, 10, 6);
        ...
        (this.leg_2 = new ModelRenderer((ModelBase) this, 98, 28)).addBox(-1.5f, -2.5f, -3.0f, 5, 9, 6);
        ...
        (this.leg_2R = new ModelRenderer((ModelBase) this, 98, 80)).addBox(-1.5f, -2.5f, -3.0f, 5, 9, 6);
        ...
        (this.leg_3R = new ModelRenderer((ModelBase) this, 44, 129)).addBox(-3.5f, -2.5f, -3.0f, 5, 11, 8);
        ...
        (this.leg_3 = new ModelRenderer((ModelBase) this, 44, 99)).addBox(-3.5f, -2.5f, -3.0f, 5, 11, 8);
        ...
        (this.leg_1Rb = new ModelRenderer((ModelBase) this, 15, 129)).addBox(-2.0f, 5.5f, -3.0f, 4, 8, 5);
        ...
        (this.leg_1b = new ModelRenderer((ModelBase) this, 15, 110)).addBox(-1.0f, 5.5f, -3.0f, 4, 8, 5);
        ...
        (this.leg_2b = new ModelRenderer((ModelBase) this, 57, 1)).addBox(-1.0f, 5.5f, -3.0f, 4, 7, 5);
        ...
        (this.leg_2Rb = new ModelRenderer((ModelBase) this, 94, 106)).addBox(-2.0f, 5.5f, -3.0f, 4, 7, 5);
        ...
        (this.leg_3Rb = new ModelRenderer((ModelBase) this, 122, 81)).addBox(-2.0f, 6.5f, -5.0f, 4, 9, 5);
        ...
        (this.leg_3b = new ModelRenderer((ModelBase) this, 122, 0)).addBox(-3.0f, 6.5f, -5.0f, 4, 9, 5);
        ...
        (this.fan1 = new ModelRenderer((ModelBase) this, 0, 109)).addBox(-1.0f, -7.0f, -34.0f, 4, 15, 1);
        ...
        (this.Lfan2 = new ModelRenderer((ModelBase) this, 0, 109)).addBox(-1.0f, -3.0f, -31.5f, 4, 12, 1);
        ...
        (this.Rfan2 = new ModelRenderer((ModelBase) this, 0, 109)).addBox(-1.0f, -3.0f, -33.5f, 4, 12, 1);
        ...
        (this.Lfan3 = new ModelRenderer((ModelBase) this, 0, 109)).addBox(-1.0f, 4.0f, -32.0f, 4, 9, 1);
        ...
        (this.Rfan3 = new ModelRenderer((ModelBase) this, 0, 109)).addBox(-1.0f, 4.0f, -32.0f, 4, 9, 1);
        ...
        (this.Lear = new ModelRenderer((ModelBase) this, 0, 80)).addBox(8.5f, 2.5f, -10.0f, 1, 1, 10);
        ...
        (this.Rear = new ModelRenderer((ModelBase) this, 0, 80)).addBox(-8.5f, 2.5f, -11.0f, 1, 1, 10);
    ...
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3,
        ...
        if (f1 > 0.1) {
            ...
            newangle2 = MathHelper.cos((float) (f2 * 1.3f * this.wingspeed + 0.7853981633974483)) * 3.1415927f
                * 0.1f
                * f1;
        } else {
            newangle = 0.0f;
