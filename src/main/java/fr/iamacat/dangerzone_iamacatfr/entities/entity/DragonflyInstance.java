...
public class DragonflyInstance extends EntityAnimal {

    private ChunkCoordinates currentFlightTarget;
    private GenericTargetSorter TargetSorter;

    public DragonflyInstance(final World par1World) {
        super(par1World);
        ...
        if (this.rand.nextInt(300) == 0
            ...
            for (Block bid = Blocks.stone; bid != Blocks.air && keep_trying != 0; --keep_trying) {
                ...
                this.currentFlightTarget
                    .set((int) this.posX + xdir, (int) this.posY + this.rand.nextInt(5) - 2, (int) this.posZ + zdir);
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        return this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && par1EntityLiving != null
            ...
            && (par1EntityLiving instanceof BrownAntInstance || par1EntityLiving instanceof RedAntInstance
            ...
            || par1EntityLiving instanceof UnstableAntInstance
                ...
                || (par1EntityLiving instanceof EntityHorse));
    }

    private EntityLivingBase findSomethingToAttack() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(10.0, 6.0, 10.0));
