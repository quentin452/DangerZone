...
public class GiantRobot extends EntityMob {
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int i = 10 + this.worldObj.rand.nextInt(10), var6 = 0; var6 < i; ++var6) {
            ...
            switch (var7) {
                case 0: {
                    is = this.dropItemRand(ItemInitDangerZone.SpiderRobotKit, 1);
                    break;
                }
                case 1: {
                    is = this.dropItemRand(ItemInitDangerZone.RedAntRobotKit, 1);
                    break;
                }
                case 2: {
                    is = this.dropItemRand(ItemInitDangerZone.ItemRayGun, 1);
                    break;
                }
                case 3: {
    ...
    private EntityLivingBase findSomethingToAttack() {
        final List var5 = this.worldObj
            .getEntitiesWithinAABB(EntityLivingBase.class, this.boundingBox.expand(16.0, 12.0, 16.0));
