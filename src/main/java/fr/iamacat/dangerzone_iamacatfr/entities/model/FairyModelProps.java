...
public class FairyModelProps extends ModelBiped {

    public FairyModelProps() {
        this(0.0F);
    }

    public FairyModelProps(final float f) {
        this(f, 0.0F);
    }

    public FairyModelProps(final float f, final float f1) {
        heldItemLeft = 0;
        heldItemRight = 0;
        isSneak = false;
        flymode = false;
        ...
        bipedBody.setTextureOffset(8, 8)
            .addBox(-2F, 0.0F, -1F, 4, 5, 2, f + 0.25F);
        bipedBody.setTextureOffset(0, 16)
            .addBox(-2F, 1.0F, -2F, 4, 2, 1, f + 0.25F);
        ...
        scoutHead.setTextureOffset(0, 0)
            .addBox(0, 0, 0, 1, 1, 1, f + 0.2F);
        scoutHead.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
        scoutBody = new ModelRenderer(this);
        scoutBody.setTextureOffset(28, 7)
            .addBox(-2F, 0.0F, -1F, 4, 6, 2, f + 0.125F);
        scoutBody.setTextureOffset(28, 15)
            .addBox(-2F, 1.0F, -2F, 4, 2, 1, f + 0.125F);
        ...
        medicHead.setTextureOffset(0, 19)
            .addBox(-3F, -5.5F, -3F, 6, 1, 6, f + 0.2F);
        medicHead.setTextureOffset(10, 15)
            .addBox(-1.5F, -7.0F, -3.125F, 3, 3, 1, f + 0.2F);
        medicHead.setTextureOffset(24, 0)
            .addBox(-3F, -3.5F, -3F, 6, 1, 6, f + 0.2F);
        medicHead.setTextureOffset(42, 3)
            .addBox(-2.5F, -4F, -3.5F, 2, 2, 1, f + 0.2F);
        medicHead.setTextureOffset(42, 3)
            .addBox(0.5F, -4F, -3.5F, 2, 2, 1, f + 0.2F);
        medicHead.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
        medicBody = new ModelRenderer(this);
        medicBody.setTextureOffset(28, 18)
            .addBox(-2F, 0.0F, -1F, 4, 6, 2, f + 0.125F);
        medicBody.setTextureOffset(18, 18)
            .addBox(-2F, 1.0F, -2F, 4, 2, 1, f + 0.125F);
    ...
    public void setScoutRotationAngles(final float f, final float f1, final float f2, final float f3, final float f4,
        final float f5) {
    ...
    public void setMedicRotationAngles(final float f, final float f1, final float f2, final float f3, final float f4,
        final float f5) {
