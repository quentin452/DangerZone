...
public class EntityEnthralledDragon extends DecoyCaveDragonTameable
{
    ...
    public EntityEnthralledDragon(final World p_i1696_1_) {
        super(p_i1696_1_);
    ...
    protected String getLivingSound() {
        return this.isAngry() ? Tags.MODID + ":mob.tinydragon.enthralled" : ((this.rand.nextInt(3) == 0) ? ((this.isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0f) ? Tags.MODID + ":mob.tinydragon.enthralled" : Tags.MODID + ":mob.tinydragon.enthralled") : Tags.MODID + ":mob.tinydragon.enthralled");
    }
    ...
    public EntityEnthralledDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityEnthralledDragon entityalpsdragon = new EntityEnthralledDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityEnthralledDragon)) {
            return false;
        }
        final EntityEnthralledDragon entityalpsdragon = (EntityEnthralledDragon)p_70878_1_;
        return entityalpsdragon.isTamed() && !entityalpsdragon.isSitting() && (this.isInLove() && entityalpsdragon.isInLove());
    }

    public String mobName() {
        return "EnthralledDragon";
    }
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityEnthralledDragon) {
                final EntityEnthralledDragon entityalpsdragon = (EntityEnthralledDragon)p_142018_1_;
