...
import fr.iamacat.dangerzone_iamacatfr.entities.model.ModelWaterDragon;
...
public class RenderWaterDragon extends RenderLiving {
    ...
    public void renderWaterDragon(final WaterDragon par1EntityWaterDragon, final double par2, final double par4,
    ...
    static {
        texture = new ResourceLocation(Tags.MODID + ":WaterDragon.png");
    }
}
