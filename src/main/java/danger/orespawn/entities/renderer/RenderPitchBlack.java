...
import danger.orespawn.entities.entityinstance.PitchBlack;
import danger.orespawn.entities.model.ModelPitchBlack;
...
public class RenderPitchBlack extends RenderLiving {
    ...
    static {
        texture = new ResourceLocation("orespawn", "PitchBlacktexture.png");
    }
}
