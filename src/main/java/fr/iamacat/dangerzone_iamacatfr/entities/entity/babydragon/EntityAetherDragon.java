...
public class EntityAetherDragon extends DecoySkyDragonTameable
{
    ...
    public EntityAetherDragon(final World world) {
        super(world);
        this.setSize(0.6f, 0.8f);
        this.getNavigator().setAvoidsWater(true);
        this.tasks.addTask(1, new EntityAISwimming((EntityLiving)this));
        this.tasks.addTask(2, this.aiSit);
        this.tasks.addTask(3, new EntityAILeapAtTarget((EntityLiving)this, 0.4f));
    ...
    public EntityAetherDragon createChild(final EntityAgeable p_90011_1_) {
        final EntityAetherDragon entityalpsdragon = new EntityAetherDragon(this.worldObj);
    ...
    public boolean canMateWith(final EntityAnimal p_70878_1_) {
        ...
        if (!(p_70878_1_ instanceof EntityAetherDragon)) {
            return false;
        }
        final EntityAetherDragon entityalpsdragon = (EntityAetherDragon)p_70878_1_;
        return entityalpsdragon.isTamed() && !entityalpsdragon.isSitting() && (this.isInLove() && entityalpsdragon.isInLove());
    }
    ...
    public boolean getCanSpawnHere() {
        return this.posY >= 114.0 && super.getCanSpawnHere();
    }
    ...
    public boolean func_142018_a(final EntityLivingBase p_142018_1_, final EntityLivingBase p_142018_2_) {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast)) {
            if (p_142018_1_ instanceof EntityAetherDragon) {
                final EntityAetherDragon entityalpsdragon = (EntityAetherDragon)p_142018_1_;
