...
public class PZPacketStreamSound implements IMessage, IMessageHandler<PZPacketStreamSound, IMessage> {
    ...
    public PZPacketStreamSound setPacketData(final int xPos, final int yPos, final int zPos, final String sound) {
        this.posX = xPos;
        this.posY = yPos;
        this.posZ = zPos;
        this.sound = sound;
    ...
    public IMessage onMessage(final PZPacketStreamSound message, final MessageContext ctx) {
