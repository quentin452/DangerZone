...
public class BlockMosquitoPlant extends BlockCrops {
    ...
    public void updateTick(final World par1World, final int par2, final int par3, final int par4,
        ...
        if (bid == Blocks.air) {
            for (int howmany = 2 + rand.nextInt(5), i = 0; i < howmany; ++i) {
    ...
    protected Item func_149866_i() {
        return ItemInitDangerZone.ItemMosquitoSeed;
    }
    ...
    public void registerBlockIcons(final IIconRegister par1IIconRegister) {
        ...
        for (int i = 0; i < this.field_94364_a.length; ++i) {
            this.field_94364_a[i] = par1IIconRegister.registerIcon(Tags.MODID + ":mosquito_" + i);
        }
    }
}
