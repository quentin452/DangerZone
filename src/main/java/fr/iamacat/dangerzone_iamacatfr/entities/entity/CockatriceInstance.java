...
public class CockatriceInstance extends EntityTameable {
    ...
    public CockatriceInstance(final World par1World) {
        super(par1World);
    ...
    public CockatriceInstance(final World par1World, final double par2, final double par4, final double par6) {
        this(par1World);
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        for (int i = 16 + this.worldObj.rand.nextInt(6), var4 = 0; var4 < i; ++var4) {
            this.dropItemRand(Items.potato, 1);
        }
        int i = 2 + this.worldObj.rand.nextInt(6);
        ...
        for (int var4 = 0; var4 < i; ++var4) {
            ...
            switch (var5) {
                case 1: {
                    // final ItemStack is = this.dropItemRand(Basic.digger, 1);
                    break;
                }
                case 2: {
                    // final ItemStack is = this.dropItemRand(Basic.dagger, 1);
                    break;
                }
            }
        }
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        ...
        if (par1Entity != null && par1Entity instanceof EntityDragon) {
            ...
            var21.setExplosion();
            dr.attackEntityFromPart(dr.dragonPartHead, var21, 24.0f);
            dr.attackEntityFromPart(dr.dragonPartBody, var21, 24.0f);
        } else if (par1Entity != null && par1Entity instanceof EntityLivingBase) {
            par1Entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase) this), 24.0f);
            ((EntityLivingBase) par1Entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 127));
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (e != null && e instanceof CockatriceInstance) {
            return false;
        }
    ...
    public void onDeathUpdate() {
        super.onDeathUpdate();
        for (int i = 0; i < 30; ++i) {
            final float var1 = (this.rand.nextFloat() - 0.5f) * 4.0f;
            final float var2 = (this.rand.nextFloat() - 0.5f) * 2.0f;
            final float var3 = (this.rand.nextFloat() - 0.5f) * 4.0f;
            this.worldObj
    ...
    public void updateAITasks() {
        ...
        super.updateAITasks();
        if (this.worldObj.rand.nextInt(400) == 1) {
            this.setAttackTarget((EntityLivingBase) null);
        }
        if (e instanceof EntityLivingBase) {
            e.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 200, 127));
        }
        if (e == null) {
    ...
    public void AILoved() {
        ...
        if (this.worldObj.rand.nextInt(freq) == 1 && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
            ...
            if (e != null) {
                this.setAttacking(1);
                if (this.getDistanceSqToEntity((Entity) e) < (9.0f + e.width / 2.0f) * (9.0f + e.width / 2.0f)) {
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        return this.isTamed() || !MobUtils.isAttackableNonMob(par1EntityLiving) || true;
    }
    ...
    public boolean getCanSpawnHere() {
            ...
            for (int j = -3; j < 3; ++j) {
                for (int i = 0; i < 5; ++i) {
                    ...
                    if (bid == Blocks.mob_spawner) {
                        ...
                        if (s != null && s.equals("MyCockatrice")) {
                            return true;
                        }
                    }
                }
        ...
        CockatriceInstance target = null;
        if (this.worldObj.isDaytime()) {
            return false;
        }
        target = (CockatriceInstance) this.worldObj.findNearestEntityWithinAABB(
    ...
    public void onUpdate() {
        ...
        if (this.getActivity() == 1) {
            ...
            if (this.wing_sound > 20) {
                if (!this.worldObj.isRemote) {
                    this.worldObj.playSoundAtEntity((Entity) this, Tags.MODID + ":flap_a1", 0.5f, 1.0f);
                }
                this.wing_sound = 0;
            }
        }
    ...
    private void AINormal() {
        ...
        if (this.worldObj.rand.nextInt(3) == 1) {
            this.Splash(this.posX, this.posY, this.posZ, 3.8, 24.0, 1);
        }
                ...
                if (this.riddenByEntity != null) {
                    ...
                    if (!this.worldObj.isRemote) {
                        list = this.worldObj.getEntitiesWithinAABBExcludingEntity(
                            (Entity) this,
                            this.boundingBox.expand(1.25, 1.0, 1.25));
    ...
    private EntityLivingBase Splash(final double X, final double Y, final double Z, final double dist,
        ...
        while (var6.hasNext()) {
            ...
            if (this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL && var8 != null
                && var8 != this
                && var8.isEntityAlive()
                && !(var8 instanceof CockatriceInstance)) {
