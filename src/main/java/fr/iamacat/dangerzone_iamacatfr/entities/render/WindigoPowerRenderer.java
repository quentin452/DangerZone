...
import fr.iamacat.dangerzone_iamacatfr.entities.entity.WindigoPowerInstance;
import fr.iamacat.dangerzone_iamacatfr.util.Tags;

@SideOnly(Side.CLIENT)
public class WindigoPowerRenderer extends Render {

    private static final ResourceLocation texturepowa;
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        final WindigoPowerInstance r = (WindigoPowerInstance) entity;
        return WindigoPowerRenderer.texturepowa;
    }

    static {
        texturepowa = new ResourceLocation(Tags.MODID + ":" + "textures/items/windigoitem.png");
    }
}
