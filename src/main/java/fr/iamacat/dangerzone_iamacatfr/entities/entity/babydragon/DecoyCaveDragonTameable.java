...
public abstract class DecoyCaveDragonTameable extends EntityTameable {
    ...
    protected void addBasicAI() {
        ...
        this.tasks.addTask(4, new EntityAIAttackOnCollide(this, this.getMoveSpeed() * 5.0, true));
        this.tasks.addTask(5, new EntityAIFollowOwner((EntityTameable) this, this.getMoveSpeed() * 5.0, 4.0f, 16.0f));
    ...
    protected void addAttackingAI() {
        this.tasks.addTask(5, new EntityAIAttackOnCollide(this, EntityPlayer.class, this.getMoveSpeed(), false));
    ...
    public boolean getCanSpawnHere() {
        ...
        return this.worldObj.getBlock(i, j - 40, k) == Blocks.stone && this.worldObj.getFullBlockLightValue(i, j, k) > 1
