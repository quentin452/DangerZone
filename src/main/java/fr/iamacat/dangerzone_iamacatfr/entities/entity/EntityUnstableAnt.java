...
public class EntityUnstableAnt extends EntityAnt {
    ...
    public boolean interact(final EntityPlayer par1EntityPlayer) {
        ...
        if (par1EntityPlayer.dimension != DimensionInitDangerZone.DimensionID4) {
            MinecraftServer.getServer()
                .getConfigurationManager()
                .transferPlayerToDimension(
                    (EntityPlayerMP) par1EntityPlayer,
                    DimensionInitDangerZone.DimensionID4,
                    new OreSpawnTeleporter(
                        MinecraftServer.getServer()
                            .worldServerForDimension(DimensionInitDangerZone.DimensionID4),
                        DimensionInitDangerZone.DimensionID4,
                        this.worldObj));
        } else {
            MinecraftServer.getServer()
