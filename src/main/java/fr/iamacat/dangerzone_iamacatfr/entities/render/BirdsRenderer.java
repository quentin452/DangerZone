...
public class BirdsRenderer extends RenderLiving {
    ...
    protected float getWingRotation(BirdsInstance par1EntityTFBird, float time) {
    ...
    protected float handleRotationFloat(EntityLivingBase par1EntityLiving, float par2) {
        return this.getWingRotation((BirdsInstance) par1EntityLiving, par2);
    }
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
        this.renderTFBird((BirdsInstance) par1Entity, par2, par4, par6, par8, par9);
    }
