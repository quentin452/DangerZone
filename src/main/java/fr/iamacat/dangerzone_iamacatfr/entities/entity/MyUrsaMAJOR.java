...
public class MyUrsaMAJOR extends EntityMob {
    ...
    public MyUrsaMAJOR(final World par1World) {
        super(par1World);
        ...
        if (this.worldObj.rand.nextInt(5) == 1) {
            ...
            if (e != null) {
                if (!e.isEntityAlive()) {
                    ...
                    e = null;
                } else if (e instanceof MyUrsaMAJOR) {
                    this.setAttackTarget(null);
                    e = null;
                }
            }
    ...
    private boolean isSuitableTarget(final EntityLivingBase par1EntityLiving, final boolean par2) {
        ...
        if (par1EntityLiving instanceof MyUrsaMAJOR) {
            return false;
        }
    ...
    public boolean attackEntityFrom(final DamageSource par1DamageSource, final float par2) {
        ...
        if (!par1DamageSource.getDamageType()
            ...
            if (e != null && e instanceof EntityLivingBase && !(e instanceof MyUrsaMAJOR)) {
