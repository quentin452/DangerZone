...
public class CamarasaurusInstance extends EntityTameable {
    ...
    public CamarasaurusInstance(final World par1World) {
        super(par1World);
        this.moveSpeed = 0.2f;
        this.closest = 99999;
        this.tx = 0;
    ...
    protected void updateAITick() {
        ...
        super.updateAITick();
        if (!this.isSitting()
            && ((this.worldObj.rand.nextInt(20) == 0 && this.getCamarasaurusHealth() < this.mygetMaxHealth())
                || this.worldObj.rand.nextInt(250) == 0)) {
            this.closest = 99999;
            final int tx = 0;
            this.tz = tx;
            this.ty = tx;
    ...
    public CamarasaurusInstance spawnBabyAnimal(final EntityAgeable par1EntityAgeable) {
        return new CamarasaurusInstance(this.worldObj);
    }
